...
exports.load = function (modulePaths, resultCallback, options) {
	...
	// Load the loader
	const amdLoader = require(configuration.appRoot + '/dist/loader.js');
	...
	const loaderConfig = {
		baseUrl: bootstrap.uriFromPath(configuration.appRoot) + '/dist',
		'base/nls': nlsConfig,
	...
	if (nlsConfig.pseudo) {
		amdRequire(['base/nls'], function (nlsPlugin) {
