...
import { IWindowsService, IWindowService, IWindowSettings, IOpenFileRequest, IWindowsConfiguration, IAddFoldersRequest, IRunActionInWindowRequest, IPathData } from 'platform/windows/common/windows';
...
import { IWorkbenchThemeService, VS_HC_THEME } from 'workbench/services/themes/common/workbenchThemeService';
...
import { Themable } from 'workbench/common/theme';
import { ipcRenderer as ipc, webFrame } from 'electron';
import { IWorkspaceEditingService } from 'workbench/services/workspace/common/workspaceEditing';
import { IMenuService, MenuId, IMenu, MenuItemAction, ICommandAction } from 'platform/actions/common/actions';
import { IContextKeyService } from 'platform/contextkey/common/contextkey';
import { fillInActionBarActions } from 'platform/actions/browser/menuItemActionItem';
import { RunOnceScheduler } from 'base/common/async';
import { IDisposable, dispose } from 'base/common/lifecycle';
import { LifecyclePhase, ILifecycleService } from 'platform/lifecycle/common/lifecycle';
...
import { AccessibilitySupport, isRootUser, isWindows, isMacintosh } from 'base/common/platform';
import product from 'platform/node/product';
import { INotificationService } from 'platform/notification/common/notification';
import { EditorServiceImpl } from 'workbench/browser/parts/editor/editor';
