...
import { WorkbenchShell } from 'workbench/electron-browser/shell';
import * as browser from 'base/browser/browser';
import { domContentLoaded } from 'base/browser/dom';
import { onUnexpectedError } from 'base/common/errors';
import * as comparer from 'base/common/comparers';
import * as platform from 'base/common/platform';
import { URI as uri } from 'base/common/uri';
import { IWorkspaceContextService, Workspace, WorkbenchState } from 'platform/workspace/common/workspace';
import { WorkspaceService, ISingleFolderWorkspaceInitializationPayload, IMultiFolderWorkspaceInitializationPayload, IEmptyWorkspaceInitializationPayload, IWorkspaceInitializationPayload, isSingleFolderWorkspaceInitializationPayload } from 'workbench/services/configuration/node/configurationService';
import { SyncDescriptor } from 'platform/instantiation/common/descriptors';
import { ServiceCollection } from 'platform/instantiation/common/serviceCollection';
import { stat, exists, writeFile, readdir } from 'base/node/pfs';
import { EnvironmentService } from 'platform/environment/node/environmentService';
import * as gracefulFs from 'graceful-fs';
import { KeyboardMapperFactory } from 'workbench/services/keybinding/electron-browser/keybindingService';
import { IWindowConfiguration, IWindowsService } from 'platform/windows/common/windows';
import { WindowsChannelClient } from 'platform/windows/node/windowsIpc';
import { IStorageLegacyService, StorageLegacyService, inMemoryLocalStorageInstance, IStorageLegacy } from 'platform/storage/common/storageLegacyService';
import { IEnvironmentService } from 'platform/environment/common/environment';
import { Client as ElectronIPCClient } from 'base/parts/ipc/electron-browser/ipc.electron-browser';
import { webFrame } from 'electron';
import { UpdateChannelClient } from 'platform/update/node/updateIpc';
import { IUpdateService } from 'platform/update/common/update';
import { URLHandlerChannel, URLServiceChannelClient } from 'platform/url/node/urlIpc';
import { IURLService } from 'platform/url/common/url';
import { WorkspacesChannelClient } from 'platform/workspaces/node/workspacesIpc';
import { IWorkspacesService, ISingleFolderWorkspaceIdentifier, isWorkspaceIdentifier } from 'platform/workspaces/common/workspaces';
import { createSpdLogService } from 'platform/log/node/spdlogService';
import * as fs from 'fs';
import { ConsoleLogService, MultiplexLogService, ILogService } from 'platform/log/common/log';
import { StorageService, DelegatingStorageService } from 'platform/storage/node/storageService';
import { IssueChannelClient } from 'platform/issue/node/issueIpc';
import { IIssueService } from 'platform/issue/common/issue';
import { LogLevelSetterChannelClient, FollowerLogService } from 'platform/log/node/logIpc';
import { RelayURLService } from 'platform/url/common/urlService';
import { MenubarChannelClient } from 'platform/menubar/node/menubarIpc';
import { IMenubarService } from 'platform/menubar/common/menubar';
import { Schemas } from 'base/common/network';
import { sanitizeFilePath, mkdirp } from 'base/node/extfs';
import { basename, join } from 'path';
import { createHash } from 'crypto';
import { parseStorage, StorageObject } from 'platform/storage/common/storageLegacyMigration';
...
import { setGlobalLeakWarningThreshold } from 'base/common/event';
