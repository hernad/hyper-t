...
import { Workbench, IWorkbenchStartedInfo } from 'workbench/electron-browser/workbench';
import { ITelemetryService } from 'platform/telemetry/common/telemetry';
import { NullTelemetryService, configurationTelemetry, combinedAppender, LogAppender } from 'platform/telemetry/common/telemetryUtils';
...
import { ElectronWindow } from 'workbench/electron-browser/window';
import { resolveWorkbenchCommonProperties } from 'platform/telemetry/node/workbenchCommonProperties';
import { IWindowsService, IWindowService, IWindowConfiguration } from 'platform/windows/common/windows';
...
import { SearchService } from 'workbench/services/search/node/searchService';
...
import { ModelServiceImpl } from 'editor/common/services/modelServiceImpl';
...
import { IntegrityServiceImpl } from 'platform/integrity/node/integrityServiceImpl';
import { IIntegrityService } from 'platform/integrity/common/integrity';
import { EditorWorkerServiceImpl } from 'editor/common/services/editorWorkerServiceImpl';
import { IEditorWorkerService } from 'editor/common/services/editorWorkerService';
import { ExtensionService } from 'workbench/services/extensions/electron-browser/extensionService';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { ServiceCollection } from 'platform/instantiation/common/serviceCollection';
import { InstantiationService } from 'platform/instantiation/node/instantiationService';
import { ILifecycleService, LifecyclePhase, ShutdownReason, ShutdownEvent } from 'platform/lifecycle/common/lifecycle';
...
import { CommandService } from 'workbench/services/commands/common/commandService';
...
import { WorkbenchModeServiceImpl } from 'workbench/services/mode/common/workbenchModeService';
...
import { ICrashReporterService, NullCrashReporterService, CrashReporterService } from 'workbench/services/crashReporter/electron-browser/crashReporterService';
import { getDelayedChannel, IPCClient } from 'base/parts/ipc/node/ipc';
import { connect as connectNet } from 'base/parts/ipc/node/ipc.net';
import { ExtensionManagementChannelClient } from 'platform/extensionManagement/node/extensionManagementIpc';
import { IExtensionManagementService, IExtensionEnablementService, IExtensionManagementServerService, IExtensionGalleryService } from 'platform/extensionManagement/common/extensionManagement';
...
import { restoreFontInfo, readFontInfo, saveFontInfo } from 'editor/browser/config/configuration';
...
import { ITextResourceConfigurationService, ITextResourcePropertiesService } from 'editor/common/services/resourceConfiguration';
import { TextResourceConfigurationService } from 'editor/common/services/resourceConfigurationImpl';
import { registerThemingParticipant, ITheme, ICssStyleCollector, HIGH_CONTRAST } from 'platform/theme/common/themeService';
import { foreground, selectionBackground, focusBorder, scrollbarShadow, scrollbarSliderActiveBackground, scrollbarSliderBackground, scrollbarSliderHoverBackground, listHighlightForeground, inputPlaceholderForeground } from 'platform/theme/common/colorRegistry';
// import { TextMateService } from 'workbench/services/textMate/electron-browser/TMSyntax';
// import { ITextMateService } from 'workbench/services/textMate/electron-browser/textMateService';
import { IBroadcastService, BroadcastService } from 'platform/broadcast/electron-browser/broadcastService';
import { HashService } from 'workbench/services/hash/node/hashService';
...
import { DelegatingStorageService } from 'platform/storage/node/storageService';
import { Event, Emitter } from 'base/common/event';
import { WORKBENCH_BACKGROUND } from 'workbench/common/theme';
import { LocalizationsChannelClient } from 'platform/localizations/node/localizationsIpc';
import { ILocalizationsService } from 'platform/localizations/common/localizations';
import { IWorkbenchIssueService } from 'workbench/services/issue/common/issue';
import { WorkbenchIssueService } from 'workbench/services/issue/electron-browser/workbenchIssueService';
...
import { DialogService } from 'workbench/services/dialogs/electron-browser/dialogService';
import { DialogChannel } from 'platform/dialogs/node/dialogIpc';
import { EventType, addDisposableListener, addClass, scheduleAtNextAnimationFrame } from 'base/browser/dom';
import { IRemoteAgentService } from 'workbench/services/remote/node/remoteAgentService';
import { RemoteAgentService } from 'workbench/services/remote/electron-browser/remoteAgentServiceImpl';
...
import { ExtensionManagementServerService } from 'workbench/services/extensions/node/extensionManagementServerService';
...
import { DownloadServiceChannel } from 'platform/download/node/downloadIpc';
import { runWhenIdle } from 'base/common/async';
import { TextResourcePropertiesService } from 'workbench/services/textfile/electron-browser/textResourcePropertiesService';
import { MulitExtensionManagementService } from 'platform/extensionManagement/node/multiExtensionManagement';
