...
import { IWindowService, IWindowsService, MenuBarVisibility } from 'platform/windows/common/windows';
...
import { isMacintosh, isLinux, language } from 'base/common/platform';
import * as browser from 'base/browser/browser';
import { IEditorGroupsService, GroupDirection, GroupLocation, IFindGroupScope } from 'workbench/services/group/common/editorGroupsService';
import { IPanelService } from 'workbench/services/panel/common/panelService';
import { IPartService, Parts, Position as PartPosition } from 'workbench/services/part/common/partService';
...
import { IssueType } from 'platform/issue/common/issue';
...
import { getDomNodePagePosition, createStyleSheet, createCSSRule } from 'base/browser/dom';
...
import { IQuickInputService, IQuickPickItem, IQuickInputButton, IQuickPickSeparator, IKeyMods } from 'platform/quickinput/common/quickInput';
