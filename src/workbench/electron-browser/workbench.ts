...
import { Event, Emitter, once } from 'base/common/event';
...
import { BackupFileService, InMemoryBackupFileService } from 'workbench/services/backup/node/backupFileService';
...
import { SidebarPart } from 'workbench/browser/parts/sidebar/sidebarPart';
import { PanelPart } from 'workbench/browser/parts/panel/panelPart';
import { StatusbarPart } from 'workbench/browser/parts/statusbar/statusbarPart';
import { TitlebarPart } from 'workbench/browser/parts/titlebar/titlebarPart';
import { EditorPart } from 'workbench/browser/parts/editor/editorPart';
import { WorkbenchLayout } from 'workbench/browser/layout';
import { IActionBarRegistry, Extensions as ActionBarExtensions } from 'workbench/browser/actions';
import { PanelRegistry, Extensions as PanelExtensions } from 'workbench/browser/panel';
...
import { Position, Parts, IPartService, ILayoutOptions, IDimension, PositionToString } from 'workbench/services/part/common/partService';
...
import { ContextMenuService as NativeContextMenuService } from 'workbench/services/contextview/electron-browser/contextmenuService';
import { ContextMenuService as HTMLContextMenuService } from 'platform/contextview/browser/contextMenuService';
import { WorkbenchKeybindingService } from 'workbench/services/keybinding/electron-browser/keybindingService';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { WorkspaceService, DefaultConfigurationExportHelper } from 'workbench/services/configuration/node/configurationService';
...
import { RawContextKey, IContextKeyService, IContextKey } from 'platform/contextkey/common/contextkey';
...
import { RemoteFileService } from 'workbench/services/files/electron-browser/remoteFileService';
...
import { ConfigurationResolverService } from 'workbench/services/configurationResolver/electron-browser/configurationResolverService';
import { IPanelService } from 'workbench/services/panel/common/panelService';
import { ITitleService } from 'workbench/services/title/common/titleService';
...
import { ClipboardService } from 'platform/clipboard/electron-browser/clipboardService';
...
import { ISCMService } from 'workbench/services/scm/common/scm';
import { SCMService } from 'workbench/services/scm/common/scmService';
import { IProgressService2 } from 'platform/progress/common/progress';
...
import { ShutdownReason } from 'platform/lifecycle/common/lifecycle';
import { LifecycleService } from 'platform/lifecycle/electron-browser/lifecycleService';
import { IWindowService, IWindowConfiguration as IWindowSettings, IWindowConfiguration, IPath, MenuBarVisibility } from 'platform/windows/common/windows';
import { IStatusbarService } from 'platform/statusbar/common/statusbar';
import { IMenuService, SyncActionDescriptor } from 'platform/actions/common/actions';
...
import { OpenRecentAction, ToggleDevToolsAction, ReloadWindowAction, ShowPreviousWindowTab, MoveWindowTabToNewWindow, MergeAllWindowTabs, ShowNextWindowTab, ToggleWindowTabsBar, ReloadWindowWithExtensionsDisabledAction, NewWindowTab } from 'workbench/electron-browser/actions';
...
import { WorkspaceEditingService } from 'workbench/services/workspace/node/workspaceEditingService';
...
import { ActivityService } from 'workbench/services/activity/browser/activityService';
import { URI } from 'base/common/uri';
import { IListService, ListService } from 'platform/list/browser/listService';
import { InputFocusedContext, IsMacContext, IsLinuxContext, IsWindowsContext } from 'platform/workbench/common/contextkeys';
import { IViewsService } from 'workbench/common/views';
import { ViewsService } from 'workbench/browser/parts/views/views';
import { INotificationService } from 'platform/notification/common/notification';
import { NotificationService } from 'workbench/services/notification/common/notificationService';
import { NotificationsCenter } from 'workbench/browser/parts/notifications/notificationsCenter';
import { NotificationsAlerts } from 'workbench/browser/parts/notifications/notificationsAlerts';
import { NotificationsStatus } from 'workbench/browser/parts/notifications/notificationsStatus';
import { registerNotificationCommands } from 'workbench/browser/parts/notifications/notificationsCommands';
import { NotificationsToasts } from 'workbench/browser/parts/notifications/notificationsToasts';
import { IPCClient } from 'base/parts/ipc/node/ipc';
import { registerWindowDriver } from 'platform/driver/electron-browser/driver';
...
import { IEditorService, IResourceEditor } from 'workbench/services/editor/common/editorService';
import { IEditorGroupsService, GroupDirection, preferredSideBySideGroupDirection } from 'workbench/services/group/common/editorGroupsService';
import { EditorService } from 'workbench/services/editor/browser/editorService';
import { IExtensionUrlHandler, ExtensionUrlHandler } from 'workbench/services/extensions/electron-browser/inactiveExtensionUrlHandler';
import { ContextViewService } from 'platform/contextview/browser/contextViewService';
import { WorkbenchThemeService } from 'workbench/services/themes/electron-browser/workbenchThemeService';
import { IWorkbenchThemeService } from 'workbench/services/themes/common/workbenchThemeService';
import { IFileDialogService } from 'platform/dialogs/common/dialogs';
import { FileDialogService } from 'workbench/services/dialogs/electron-browser/dialogService';
import { LogStorageAction } from 'platform/storage/node/storageService';
