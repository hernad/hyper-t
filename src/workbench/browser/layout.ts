...
import { Sash, ISashEvent, IVerticalSashLayoutProvider, IHorizontalSashLayoutProvider, Orientation } from 'base/browser/ui/sash/sash';
import { IPartService, Position, ILayoutOptions, Parts } from 'workbench/services/part/common/partService';
...
import { Dimension, getClientArea, size, position, hide, show } from 'base/browser/dom';
