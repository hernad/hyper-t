...
import { Composite, CompositeDescriptor, CompositeRegistry } from 'workbench/browser/composite';
import { IConstructorSignature0 } from 'platform/instantiation/common/instantiation';
import { ToggleSidebarVisibilityAction } from 'workbench/browser/actions/toggleSidebarVisibility';
...
import { ToggleSidebarPositionAction } from 'workbench/browser/actions/toggleSidebarPosition';
