...
import { INotificationsModel, INotificationChangeEvent, NotificationChangeType, INotificationViewItem } from 'workbench/common/notifications';
import { IStatusbarService, StatusbarAlignment } from 'platform/statusbar/common/statusbar';
import { IDisposable, Disposable } from 'base/common/lifecycle';
import { HIDE_NOTIFICATIONS_CENTER, SHOW_NOTIFICATIONS_CENTER } from 'workbench/browser/parts/notifications/notificationsCommands';
