...
import 'css!./media/notificationsCenter';
import 'css!./media/notificationsActions';
import { Themable, NOTIFICATIONS_BORDER, NOTIFICATIONS_CENTER_HEADER_FOREGROUND, NOTIFICATIONS_CENTER_HEADER_BACKGROUND, NOTIFICATIONS_CENTER_BORDER } from 'workbench/common/theme';
import { IThemeService, registerThemingParticipant, ITheme, ICssStyleCollector } from 'platform/theme/common/themeService';
import { INotificationsModel, INotificationChangeEvent, NotificationChangeType } from 'workbench/common/notifications';
...
import { NotificationsCenterVisibleContext } from 'workbench/browser/parts/notifications/notificationsCommands';
import { NotificationsList } from 'workbench/browser/parts/notifications/notificationsList';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { addClass, removeClass, isAncestor, Dimension } from 'base/browser/dom';
...
import { ClearAllNotificationsAction, HideNotificationsCenterAction, NotificationActionRunner } from 'workbench/browser/parts/notifications/notificationsActions';
