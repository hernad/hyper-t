...
import { clearNode, addClass, removeClass, toggleClass, addDisposableListener, EventType, EventHelper } from 'base/browser/dom';
import { IOpenerService } from 'platform/opener/common/opener';
import { URI } from 'base/common/uri';
import { onUnexpectedError } from 'base/common/errors';
import { localize } from 'base/nls';
import { ButtonGroup } from 'base/browser/ui/button/button';
import { attachButtonStyler, attachProgressBarStyler } from 'platform/theme/common/styler';
...
import { INotificationViewItem, NotificationViewItem, NotificationViewItemLabelKind, INotificationMessage, ChoiceAction } from 'workbench/common/notifications';
import { ClearNotificationAction, ExpandNotificationAction, CollapseNotificationAction, ConfigureNotificationAction } from 'workbench/browser/parts/notifications/notificationsActions';
