...
import 'css!./media/notificationsList';
import { addClass, isAncestor, trackFocus } from 'base/browser/dom';
import { WorkbenchList } from 'platform/list/browser/listService';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { IListOptions } from 'base/browser/ui/list/listWidget';
import { Themable, NOTIFICATIONS_LINKS, NOTIFICATIONS_BACKGROUND, NOTIFICATIONS_FOREGROUND } from 'workbench/common/theme';
import { IThemeService, registerThemingParticipant, ITheme, ICssStyleCollector } from 'platform/theme/common/themeService';
import { contrastBorder, focusBorder } from 'platform/theme/common/colorRegistry';
import { INotificationViewItem } from 'workbench/common/notifications';
import { NotificationsListDelegate, NotificationRenderer } from 'workbench/browser/parts/notifications/notificationsViewer';
import { NotificationActionRunner, CopyNotificationMessageAction } from 'workbench/browser/parts/notifications/notificationsActions';
import { NotificationFocusedContext } from 'workbench/browser/parts/notifications/notificationsCommands';
