...
import { IIconLabelValueOptions } from 'base/browser/ui/iconLabel/iconLabel';
import { Mode, IEntryRunContext, IAutoFocus, IQuickNavigateConfiguration, IModel } from 'base/parts/quickopen/common/quickOpen';
import { QuickOpenEntry, QuickOpenModel, QuickOpenEntryGroup, QuickOpenItemAccessorClass } from 'base/parts/quickopen/browser/quickOpenModel';
import { QuickOpenWidget, HideReason } from 'base/parts/quickopen/browser/quickOpenWidget';
import { ContributableActionProvider } from 'workbench/browser/actions';
import { ITextFileService, AutoSaveMode } from 'workbench/services/textfile/common/textfiles';
...
import { EditorInput, IWorkbenchEditorConfiguration, IEditorInput } from 'workbench/common/editor';
...
import { QuickOpenHandler, QuickOpenHandlerDescriptor, IQuickOpenRegistry, Extensions, EditorQuickOpenEntry, CLOSE_ON_FOCUS_LOST_CONFIG, SEARCH_EDITOR_HISTORY, PRESERVE_INPUT_CONFIG } from 'workbench/browser/quickopen';
import * as errors from 'base/common/errors';
import { IQuickOpenService, IShowOptions } from 'platform/quickOpen/common/quickOpen';
...
import { SIDE_BAR_BACKGROUND, SIDE_BAR_FOREGROUND } from 'workbench/common/theme';
...
import { scoreItem, ScorerCache, compareItemsByScore, prepareQuery } from 'base/parts/quickopen/common/quickOpenScorer';
import { WorkbenchTree } from 'platform/list/browser/listService';
import { Schemas } from 'base/common/network';
import { INotificationService } from 'platform/notification/common/notification';
import { Dimension, addClass } from 'base/browser/dom';
import { IEditorService, ACTIVE_GROUP, SIDE_GROUP } from 'workbench/services/editor/common/editorService';
...
export class QuickOpenController extends Component implements IQuickOpenService {
	...
	private mergeResults(quickOpenModel: QuickOpenModel, handlerResults: QuickOpenEntry[], groupLabel: string): void {
		...
		if (additionalHandlerResults.length > 0) {
			const autoFocusFirstEntry = (quickOpenModel.getEntries().length === 0); // the user might have selected another entry meanwhile in local history (see https://github.com/hernad/hyper-t/issues/20828)
