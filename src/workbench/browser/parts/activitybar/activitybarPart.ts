...
import 'css!./media/activitybarpart';
...
import { GlobalActivityExtensions, IGlobalActivityRegistry } from 'workbench/common/activity';
import { Registry } from 'platform/registry/common/platform';
import { Part } from 'workbench/browser/part';
import { GlobalActivityActionItem, GlobalActivityAction, ViewletActivityAction, ToggleViewletAction, PlaceHolderToggleCompositePinnedAction, PlaceHolderViewletActivityAction } from 'workbench/browser/parts/activitybar/activitybarActions';
...
import { ToggleActivityBarVisibilityAction } from 'workbench/browser/actions/toggleActivityBarVisibility';
import { IThemeService, registerThemingParticipant, ITheme } from 'platform/theme/common/themeService';
import { ACTIVITY_BAR_BACKGROUND, ACTIVITY_BAR_BORDER, ACTIVITY_BAR_FOREGROUND, ACTIVITY_BAR_BADGE_BACKGROUND, ACTIVITY_BAR_BADGE_FOREGROUND, ACTIVITY_BAR_DRAG_AND_DROP_BACKGROUND, ACTIVITY_BAR_INACTIVE_FOREGROUND } from 'workbench/common/theme';
...
import { scheduleAtNextAnimationFrame, Dimension, addClass } from 'base/browser/dom';
...
import { ToggleCompositePinnedAction, ICompositeBarColors } from 'workbench/browser/parts/compositeBarActions';
import { ViewletDescriptor } from 'workbench/browser/viewlet';
import { IViewsService, IViewContainersRegistry, Extensions as ViewContainerExtensions } from 'workbench/common/views';
