...
import 'css!./media/activityaction';
...
import { activeContrastBorder, focusBorder } from 'platform/theme/common/colorRegistry';
import { ICssStyleCollector, ITheme, IThemeService, registerThemingParticipant } from 'platform/theme/common/themeService';
import { ActivityAction, ActivityActionItem, ICompositeBar, ICompositeBarColors, ToggleCompositePinnedAction } from 'workbench/browser/parts/compositeBarActions';
...
import { IActivity, IGlobalActivity } from 'workbench/common/activity';
import { ACTIVITY_BAR_FOREGROUND } from 'workbench/common/theme';
