...
import 'css!./media/compositepart';
...
import { Part, IPartOptions } from 'workbench/browser/part';
import { Composite, CompositeRegistry } from 'workbench/browser/composite';
import { IComposite } from 'workbench/common/composite';
import { ScopedProgressService } from 'workbench/services/progress/browser/progressService';
...
import { Dimension, append, $, addClass, hide, show, addClasses } from 'base/browser/dom';
