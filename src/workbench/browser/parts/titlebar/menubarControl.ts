...
import { IMenubarMenu, IMenubarMenuItemAction, IMenubarMenuItemSubmenu, IMenubarKeybinding, IMenubarService, IMenubarData } from 'platform/menubar/common/menubar';
import { IMenuService, MenuId, IMenu, SubmenuItemAction } from 'platform/actions/common/actions';
import { registerThemingParticipant, ITheme, ICssStyleCollector, IThemeService } from 'platform/theme/common/themeService';
import { IWindowService, MenuBarVisibility, IWindowsService } from 'platform/windows/common/windows';
import { IContextKeyService } from 'platform/contextkey/common/contextkey';
import { ActionRunner, IActionRunner, IAction, Action } from 'base/common/actions';
...
import { Menu, IMenuOptions, SubmenuAction, MENU_MNEMONIC_REGEX, cleanMnemonic, MENU_ESCAPED_MNEMONIC_REGEX } from 'base/browser/ui/menu/menu';
...
import { IRecentlyOpened } from 'platform/history/common/history';
...
import { MENUBAR_SELECTION_FOREGROUND, MENUBAR_SELECTION_BACKGROUND, MENUBAR_SELECTION_BORDER, TITLE_BAR_ACTIVE_FOREGROUND, TITLE_BAR_INACTIVE_FOREGROUND } from 'workbench/common/theme';
...
import { Gesture, EventType, GestureEvent } from 'base/browser/touch';
import { attachMenuStyler } from 'platform/theme/common/styler';
...
export class MenubarControl extends Disposable {
	...
	private topLevelTitles = {
		...
		// 'Debug': nls.localize({ key: 'mDebug', comment: ['&& denotes a mnemonic'] }, "&&Debug"), hernad out-debug
	...
	constructor(
		...
		this.topLevelMenus = {
			...
			// 'Debug': this._register(this.menuService.createMenu(MenuId.MenubarDebugMenu, this.contextKeyService)), hernad out-debug
