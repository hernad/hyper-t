...
import 'css!./media/titlebarpart';
import * as paths from 'base/common/paths';
import { Part } from 'workbench/browser/part';
import { ITitleService, ITitleProperties } from 'workbench/services/title/common/titleService';
...
import { EditorInput, toResource, Verbosity } from 'workbench/common/editor';
...
import { TITLE_BAR_ACTIVE_BACKGROUND, TITLE_BAR_ACTIVE_FOREGROUND, TITLE_BAR_INACTIVE_FOREGROUND, TITLE_BAR_INACTIVE_BACKGROUND, TITLE_BAR_BORDER } from 'workbench/common/theme';
import { isMacintosh, isWindows, isLinux } from 'base/common/platform';
import { URI } from 'base/common/uri';
import { Color } from 'base/common/color';
import { trim } from 'base/common/strings';
import { EventType, EventHelper, Dimension, isAncestor, hide, show, removeClass, addClass, append, $, addDisposableListener } from 'base/browser/dom';
import { MenubarControl } from 'workbench/browser/parts/titlebar/menubarControl';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { template, getBaseLabel } from 'base/common/labels';
