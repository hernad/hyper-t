...
import { IViewsService, ViewsRegistry, IViewsViewlet, ViewContainer, IViewDescriptor, IViewContainersRegistry, Extensions as ViewContainerExtensions, TEST_VIEW_CONTAINER_ID, IView, IViewDescriptorCollection } from 'workbench/common/views';
import { Registry } from 'platform/registry/common/platform';
import { ViewletRegistry, Extensions as ViewletExtensions } from 'workbench/browser/viewlet';
...
import { IContextKeyService, IContextKeyChangeEvent, IReadableSet, IContextKey, RawContextKey, ContextKeyExpr } from 'platform/contextkey/common/contextkey';
import { Event, chain, filterEvent, Emitter } from 'base/common/event';
import { sortedDiff, firstIndex, move } from 'base/common/arrays';
import { IWorkspaceContextService } from 'platform/workspace/common/workspace';
import { isUndefinedOrNull } from 'base/common/types';
import { MenuId, MenuRegistry, ICommandAction } from 'platform/actions/common/actions';
