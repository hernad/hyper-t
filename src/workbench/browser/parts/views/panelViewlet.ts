...
import 'css!./media/panelviewlet';
import * as nls from 'base/nls';
import { Event, Emitter, filterEvent } from 'base/common/event';
import { ColorIdentifier } from 'platform/theme/common/colorRegistry';
import { attachStyler, IColorMapping } from 'platform/theme/common/styler';
import { SIDE_BAR_DRAG_AND_DROP_BACKGROUND, SIDE_BAR_SECTION_HEADER_FOREGROUND, SIDE_BAR_SECTION_HEADER_BACKGROUND, SIDE_BAR_SECTION_HEADER_BORDER } from 'workbench/common/theme';
import { append, $, trackFocus, toggleClass, EventType, isAncestor, Dimension, addDisposableListener } from 'base/browser/dom';
...
import { IActionItem, ActionsOrientation } from 'base/browser/ui/actionbar/actionbar';
import { Registry } from 'platform/registry/common/platform';
import { prepareActions } from 'workbench/browser/actions';
import { Viewlet, ViewletRegistry, Extensions } from 'workbench/browser/viewlet';
...
import { PanelView, IPanelViewOptions, IPanelOptions, Panel } from 'base/browser/ui/splitview/panelview';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { IPartService } from 'workbench/services/part/common/partService';
import { StandardMouseEvent } from 'base/browser/mouseEvent';
import { IView } from 'workbench/common/views';
