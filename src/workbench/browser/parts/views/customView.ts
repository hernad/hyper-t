...
import { ContextAwareMenuItemActionItem, fillInActionBarActions, fillInContextMenuActions } from 'platform/actions/browser/menuItemActionItem';
import { IContextKeyService } from 'platform/contextkey/common/contextkey';
import { IViewsService, ITreeViewer, ITreeItem, TreeItemCollapsibleState, ITreeViewDataProvider, TreeViewItemHandleArg, ICustomViewDescriptor, ViewsRegistry, ViewContainer, ITreeItemLabel } from 'workbench/common/views';
import { IViewletViewOptions, FileIconThemableWorkbenchTree } from 'workbench/browser/parts/views/viewsViewlet';
...
import { IDataSource, ITree, IRenderer, ContextMenuEvent } from 'base/parts/tree/browser/tree';
import { ResourceLabel } from 'workbench/browser/labels';
import { ActionBar, IActionItemProvider, ActionItem } from 'base/browser/ui/actionbar/actionbar';
import { URI } from 'base/common/uri';
import { basename } from 'base/common/paths';
import { LIGHT, FileThemeIcon, FolderThemeIcon, registerThemingParticipant } from 'platform/theme/common/themeService';
...
import { CollapseAllAction } from 'base/parts/tree/browser/treeDefaults';
import { editorFindMatchHighlight, editorFindMatchHighlightBorder } from 'platform/theme/common/colorRegistry';
