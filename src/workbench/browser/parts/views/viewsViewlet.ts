...
import { dispose, IDisposable, combinedDisposable, toDisposable } from 'base/common/lifecycle';
...
import { IViewDescriptor, IViewsViewlet, IViewContainersRegistry, Extensions as ViewContainerExtensions, IView } from 'workbench/common/views';
...
import { IWorkbenchThemeService, IFileIconTheme } from 'workbench/services/themes/common/workbenchThemeService';
...
import { IAddedViewDescriptorRef, IViewDescriptorRef, PersistentContributableViewsModel } from 'workbench/browser/parts/views/views';
