...
import { IWorkbenchActionRegistry, Extensions as WorkbenchExtensions } from 'workbench/common/actions';
...
import { ActivityAction } from 'workbench/browser/parts/compositeBarActions';
