...
import { CompositePart, ICompositeTitleLabel } from 'workbench/browser/parts/compositePart';
import { Panel, PanelRegistry, Extensions as PanelExtensions, PanelDescriptor } from 'workbench/browser/panel';
import { IPanelService, IPanelIdentifier } from 'workbench/services/panel/common/panelService';
import { IPartService, Parts, Position } from 'workbench/services/part/common/partService';
...
import { ClosePanelAction, TogglePanelPositionAction, PanelActivityAction, ToggleMaximizedPanelAction, TogglePanelAction } from 'workbench/browser/parts/panel/panelActions';
import { IThemeService, registerThemingParticipant, ITheme, ICssStyleCollector } from 'platform/theme/common/themeService';
import { PANEL_BACKGROUND, PANEL_BORDER, PANEL_ACTIVE_TITLE_FOREGROUND, PANEL_INACTIVE_TITLE_FOREGROUND, PANEL_ACTIVE_TITLE_BORDER, PANEL_DRAG_AND_DROP_BACKGROUND } from 'workbench/common/theme';
import { activeContrastBorder, focusBorder, contrastBorder, editorBackground, badgeBackground, badgeForeground } from 'platform/theme/common/colorRegistry';
import { CompositeBar } from 'workbench/browser/parts/compositeBar';
import { ToggleCompositePinnedAction } from 'workbench/browser/parts/compositeBarActions';
import { IBadge } from 'workbench/services/activity/common/activity';
import { INotificationService } from 'platform/notification/common/notification';
import { Dimension, trackFocus } from 'base/browser/dom';
