...
import { IQuickPickItem, IQuickPickItemButtonEvent, IQuickPickSeparator } from 'platform/quickinput/common/quickInput';
...
import { Emitter, Event, mapEvent } from 'base/common/event';
