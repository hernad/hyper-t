...
import 'css!./quickInput';
import { Component } from 'workbench/common/component';
import { IQuickInputService, IQuickPickItem, IPickOptions, IInputOptions, IQuickNavigateConfiguration, IQuickPick, IQuickInput, IQuickInputButton, IInputBox, IQuickPickItemButtonEvent, QuickPickInput, IQuickPickSeparator, IKeyMods } from 'platform/quickinput/common/quickInput';
...
import { CLOSE_ON_FOCUS_LOST_CONFIG } from 'workbench/browser/quickopen';
...
import { ActionBar, ActionItem } from 'base/browser/ui/actionbar/actionbar';
import { Action } from 'base/common/actions';
import { URI } from 'base/common/uri';
import { IKeybindingService } from 'platform/keybinding/common/keybinding';
import { equals } from 'base/common/arrays';
import { TimeoutTimer } from 'base/common/async';
import { getIconClass } from 'workbench/browser/parts/quickinput/quickInputUtils';
...
const backButton = {
	iconPath: {
		dark: URI.parse(require.toUrl('workbench/browser/parts/quickinput/media/dark/arrow-left.svg')),
		light: URI.parse(require.toUrl('workbench/browser/parts/quickinput/media/light/arrow-left.svg'))
	},
