...
import { BaseActionItem, IBaseActionItemOptions, Separator } from 'base/browser/ui/actionbar/actionbar';
import { ICommandService } from 'platform/commands/common/commands';
import { dispose, IDisposable, Disposable, toDisposable } from 'base/common/lifecycle';
...
import { TextBadge, NumberBadge, IBadge, IconBadge, ProgressBadge } from 'workbench/services/activity/common/activity';
...
import { IActivity } from 'workbench/common/activity';
import { IKeybindingService } from 'platform/keybinding/common/keybinding';
import { Event, Emitter } from 'base/common/event';
import { DragAndDropObserver, LocalSelectionTransfer } from 'workbench/browser/dnd';
