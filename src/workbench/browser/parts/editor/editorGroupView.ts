...
import 'css!./media/editorgroupview';
import { TPromise } from 'base/common/winjs.base';
import { EditorGroup, IEditorOpenOptions, EditorCloseEvent, ISerializedEditorGroup, isSerializedEditorGroup } from 'workbench/common/editor/editorGroup';
import { EditorInput, EditorOptions, GroupIdentifier, ConfirmResult, SideBySideEditorInput, CloseDirection, IEditorCloseEvent, EditorGroupActiveEditorDirtyContext } from 'workbench/common/editor';
import { Event, Emitter, once, Relay } from 'base/common/event';
...
import { Themable, EDITOR_GROUP_HEADER_TABS_BORDER, EDITOR_GROUP_HEADER_TABS_BACKGROUND, EDITOR_GROUP_HEADER_NO_TABS_BACKGROUND, EDITOR_GROUP_EMPTY_BACKGROUND, EDITOR_GROUP_FOCUSED_EMPTY_BORDER } from 'workbench/common/theme';
import { IMoveEditorOptions, ICopyEditorOptions, ICloseEditorsFilter, IGroupChangeEvent, GroupChangeKind, EditorsOrder, GroupsOrder } from 'workbench/services/group/common/editorGroupsService';
import { TabsTitleControl } from 'workbench/browser/parts/editor/tabsTitleControl';
import { EditorControl } from 'workbench/browser/parts/editor/editorControl';
import { IProgressService } from 'platform/progress/common/progress';
import { ProgressService } from 'workbench/services/progress/browser/progressService';
...
import { Severity, INotificationService, INotificationActions } from 'platform/notification/common/notification';
...
import { TitleControl } from 'workbench/browser/parts/editor/titleControl';
import { IEditorGroupsAccessor, IEditorGroupView, IEditorPartOptionsChangeEvent, getActiveTextEditorOptions, IEditorOpeningEvent } from 'workbench/browser/parts/editor/editor';
...
import { ActionRunner, IAction, Action } from 'base/common/actions';
import { CLOSE_EDITOR_GROUP_COMMAND_ID } from 'workbench/browser/parts/editor/editorCommands';
import { NoTabsTitleControl } from 'workbench/browser/parts/editor/noTabsTitleControl';
...
import { isErrorWithActions, IErrorWithActions } from 'base/common/errorsWithActions';
