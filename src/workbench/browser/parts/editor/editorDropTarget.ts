...
import 'css!./media/editordroptarget';
import { LocalSelectionTransfer, DraggedEditorIdentifier, ResourcesDropHandler, DraggedEditorGroupIdentifier, DragAndDropObserver } from 'workbench/browser/dnd';
import { addDisposableListener, EventType, EventHelper, isAncestor, toggleClass, addClass, removeClass } from 'base/browser/dom';
import { IEditorGroupsAccessor, EDITOR_TITLE_HEIGHT, IEditorGroupView, getActiveTextEditorOptions } from 'workbench/browser/parts/editor/editor';
import { EDITOR_DRAG_AND_DROP_BACKGROUND, Themable } from 'workbench/common/theme';
import { IThemeService } from 'platform/theme/common/themeService';
import { activeContrastBorder } from 'platform/theme/common/colorRegistry';
import { IEditorIdentifier, EditorInput, EditorOptions } from 'workbench/common/editor';
import { isMacintosh } from 'base/common/platform';
import { GroupDirection, MergeGroupMode } from 'workbench/services/group/common/editorGroupsService';
