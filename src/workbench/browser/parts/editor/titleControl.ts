...
import { ActionsOrientation, IActionItem } from 'base/browser/ui/actionbar/actionbar';
import { ToolBar } from 'base/browser/ui/toolbar/toolbar';
import { Action, IAction, IRunEvent } from 'base/common/actions';
...
import { ExecuteCommandAction, IMenu, IMenuService, MenuId } from 'platform/actions/common/actions';
...
import { prepareActions } from 'workbench/browser/actions';
import { DraggedEditorGroupIdentifier, DraggedEditorIdentifier, fillResourceDataTransfers, LocalSelectionTransfer } from 'workbench/browser/dnd';
import { BaseEditor } from 'workbench/browser/parts/editor/baseEditor';
import { BreadcrumbsConfig } from 'workbench/browser/parts/editor/breadcrumbs';
import { BreadcrumbsControl, IBreadcrumbsControlOptions } from 'workbench/browser/parts/editor/breadcrumbsControl';
import { EDITOR_TITLE_HEIGHT, IEditorGroupsAccessor, IEditorGroupView, IEditorPartOptions } from 'workbench/browser/parts/editor/editor';
import { EditorCommandsContextActionRunner, IEditorCommandsContext, IEditorInput, toResource } from 'workbench/common/editor';
