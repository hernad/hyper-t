...
import 'css!./media/tabstitlecontrol';
import { isMacintosh } from 'base/common/platform';
import { shorten } from 'base/common/labels';
import { toResource, GroupIdentifier, IEditorInput, Verbosity, EditorCommandsContextActionRunner } from 'workbench/common/editor';
...
import { ResourcesDropHandler, fillResourceDataTransfers, DraggedEditorIdentifier, DraggedEditorGroupIdentifier, DragAndDropObserver } from 'workbench/browser/dnd';
import { Color } from 'base/common/color';
import { INotificationService } from 'platform/notification/common/notification';
import { IExtensionService } from 'workbench/services/extensions/common/extensions';
import { MergeGroupMode, IMergeGroupOptions } from 'workbench/services/group/common/editorGroupsService';
import { IUntitledEditorService } from 'workbench/services/untitled/common/untitledEditorService';
import { addClass, addDisposableListener, hasClass, EventType, EventHelper, removeClass, Dimension, scheduleAtNextAnimationFrame, findParentWithClass, clearNode } from 'base/browser/dom';
import { localize } from 'base/nls';
import { IEditorGroupsAccessor, IEditorPartOptions, IEditorGroupView } from 'workbench/browser/parts/editor/editor';
import { CloseOneEditorAction } from 'workbench/browser/parts/editor/editorActions';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { BreadcrumbsControl } from 'workbench/browser/parts/editor/breadcrumbsControl';
