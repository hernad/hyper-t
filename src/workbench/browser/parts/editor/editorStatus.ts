...
import { IStatusbarItem } from 'workbench/browser/parts/statusbar/statusbar';
import { Action } from 'base/common/actions';
import { language, LANGUAGE_DEFAULT, AccessibilitySupport } from 'base/common/platform';
import * as browser from 'base/browser/browser';
import { UntitledEditorInput } from 'workbench/common/editor/untitledEditorInput';
import { IFileEditorInput, EncodingMode, IEncodingSupport, toResource, SideBySideEditorInput, IEditor as IBaseEditor, IEditorInput } from 'workbench/common/editor';
import { IDisposable, combinedDisposable, dispose } from 'base/common/lifecycle';
import { IUntitledEditorService } from 'workbench/services/untitled/common/untitledEditorService';
import { IEditorAction } from 'editor/common/editorCommon';
import { EndOfLineSequence, ITextModel } from 'editor/common/model';
import { IModelLanguageChangedEvent, IModelOptionsChangedEvent } from 'editor/common/model/textModelEvents';
...
import { IModeService, ILanguageSelection } from 'editor/common/services/modeService';
...
import { ICursorPositionChangedEvent } from 'editor/common/controller/cursorEvents';
import { IConfigurationChangedEvent, IEditorOptions } from 'editor/common/config/editorOptions';
...
import { ICodeEditor, isCodeEditor, isDiffEditor, getCodeEditor } from 'editor/browser/editorBrowser';
...
import { INotificationHandle, INotificationService, Severity } from 'platform/notification/common/notification';
