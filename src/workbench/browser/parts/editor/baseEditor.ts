...
import { EditorInput, EditorOptions, IEditor, GroupIdentifier, IEditorMemento } from 'workbench/common/editor';
...
import { DEFAULT_EDITOR_MIN_DIMENSIONS, DEFAULT_EDITOR_MAX_DIMENSIONS } from 'workbench/browser/parts/editor/editor';
