...
import { EditorInput, EditorOptions, SideBySideEditorInput, IEditorControl, IEditor } from 'workbench/common/editor';
...
import { IEditorRegistry, Extensions as EditorExtensions } from 'workbench/browser/editor';
