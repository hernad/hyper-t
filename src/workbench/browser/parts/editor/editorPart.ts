...
import 'workbench/browser/parts/editor/editor.contribution';
...
import { GroupDirection, IAddGroupOptions, GroupsArrangement, GroupOrientation, IMergeGroupOptions, MergeGroupMode, ICopyEditorOptions, GroupsOrder, GroupChangeKind, GroupLocation, IFindGroupScope, EditorGroupLayout, GroupLayoutArgument } from 'workbench/services/group/common/editorGroupsService';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { Direction, SerializableGrid, Sizing, ISerializedGrid, Orientation, GridBranchNode, isGridBranchNode, GridNode, createSerializedGrid, Grid } from 'base/browser/ui/grid/grid';
import { GroupIdentifier, IWorkbenchEditorConfiguration } from 'workbench/common/editor';
import { values } from 'base/common/map';
import { EDITOR_GROUP_BORDER, EDITOR_PANE_BACKGROUND } from 'workbench/common/theme';
import { distinct } from 'base/common/arrays';
import { IEditorGroupsAccessor, IEditorGroupView, IEditorPartOptions, getEditorPartOptions, impactsEditorPartOptions, IEditorPartOptionsChangeEvent, EditorGroupsServiceImpl } from 'workbench/browser/parts/editor/editor';
import { EditorGroupView } from 'workbench/browser/parts/editor/editorGroupView';
...
import { ISerializedEditorGroup, isSerializedEditorGroup } from 'workbench/common/editor/editorGroup';
import { TValueCallback, TPromise } from 'base/common/winjs.base';
import { always } from 'base/common/async';
import { EditorDropTarget } from 'workbench/browser/parts/editor/editorDropTarget';
import { localize } from 'base/nls';
import { Color } from 'base/common/color';
import { CenteredViewLayout } from 'base/browser/ui/centered/centeredViewLayout';
import { IView, orthogonal } from 'base/browser/ui/grid/gridview';
		...
		const gridDescriptor = createSerializedGrid({
			orientation: this.toGridViewOrientation(
				...
				this.isTwoDimensionalGrid() ?
					...
					orthogonal(this.gridWidget.orientation) // otherwise flip (fix https://github.com/hernad/hyper-t/issues/52975)
			),
