...
import { createMatches, FuzzyScore, fuzzyScore } from 'base/common/filters';
...
import { IDataSource, IFilter, IRenderer, ISorter, ITree } from 'base/parts/tree/browser/tree';
import 'css!./media/breadcrumbscontrol';
import { OutlineElement, OutlineModel, TreeElement } from 'editor/contrib/documentSymbols/outlineModel';
import { OutlineDataSource, OutlineItemComparator, OutlineRenderer, OutlineItemCompareType } from 'editor/contrib/documentSymbols/outlineTree';
...
import { HighlightingWorkbenchTree, IHighlighter, IHighlightingTreeConfiguration, IHighlightingTreeOptions } from 'platform/list/browser/listService';
...
import { BreadcrumbElement, FileElement } from 'workbench/browser/parts/editor/breadcrumbsModel';
import { IFileIconTheme, IWorkbenchThemeService } from 'workbench/services/themes/common/workbenchThemeService';
