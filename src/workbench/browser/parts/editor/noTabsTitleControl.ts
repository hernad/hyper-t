...
import 'css!./media/notabstitlecontrol';
import { toResource, Verbosity, IEditorInput } from 'workbench/common/editor';
import { TitleControl, IToolbarActions } from 'workbench/browser/parts/editor/titleControl';
import { ResourceLabel } from 'workbench/browser/labels';
import { TAB_ACTIVE_FOREGROUND, TAB_UNFOCUSED_ACTIVE_FOREGROUND } from 'workbench/common/theme';
...
import { IEditorPartOptions, EDITOR_TITLE_HEIGHT } from 'workbench/browser/parts/editor/editor';
import { IAction } from 'base/common/actions';
import { CLOSE_EDITOR_COMMAND_ID } from 'workbench/browser/parts/editor/editorCommands';
...
export class NoTabsTitleControl extends TitleControl {
	...
	private onTitleClick(e: MouseEvent | GestureEvent): void {
		...
		if (e instanceof MouseEvent && e.button === 1 /* Middle Button */) {
			EventHelper.stop(e, true /* for https://github.com/hernad/hyper-t/issues/56715 */);
