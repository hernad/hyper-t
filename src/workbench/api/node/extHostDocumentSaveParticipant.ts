...
import { ExtHostDocumentSaveParticipantShape, MainThreadTextEditorsShape, ResourceTextEditDto } from 'workbench/api/node/extHost.protocol';
import { TextEdit } from 'workbench/api/node/extHostTypes';
