...
import { ExtHostTerminalServiceShape, MainContext, MainThreadTerminalServiceShape, IMainContext, ShellLaunchConfigDto } from 'workbench/api/node/extHost.protocol';
import { ExtHostConfiguration } from 'workbench/api/node/extHostConfiguration';
import { ILogService } from 'platform/log/common/log';
import { EXT_HOST_CREATION_DELAY } from 'workbench/parts/terminal/common/terminal';
