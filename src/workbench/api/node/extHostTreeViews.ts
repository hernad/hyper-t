...
import { ITreeItem, TreeViewItemHandleArg, ITreeItemLabel, IRevealOptions } from 'workbench/common/views';
import { ExtHostCommands, CommandsConverter } from 'workbench/api/node/extHostCommands';
import { asThenable } from 'base/common/async';
import { TreeItemCollapsibleState, ThemeIcon } from 'workbench/api/node/extHostTypes';
import { isUndefinedOrNull, isString } from 'base/common/types';
import { equals } from 'base/common/arrays';
import { ILogService } from 'platform/log/common/log';
import { IExtensionDescription, checkProposedApiEnabled } from 'workbench/services/extensions/common/extensions';
