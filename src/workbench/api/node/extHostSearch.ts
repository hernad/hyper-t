...
import { IFileQuery, IFolderQuery, IRawFileQuery, IRawQuery, IRawTextQuery, ISearchCompleteStats, ITextQuery } from 'platform/search/common/search';
import { ExtHostConfiguration } from 'workbench/api/node/extHostConfiguration';
import { FileIndexSearchManager } from 'workbench/api/node/extHostSearch.fileIndex';
import { FileSearchManager } from 'workbench/services/search/node/fileSearchManager';
import { SearchService } from 'workbench/services/search/node/rawSearchService';
import { RipgrepSearchProvider } from 'workbench/services/search/node/ripgrepSearchProvider';
