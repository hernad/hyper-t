...
import * as search from 'workbench/parts/search/common/search';
...
import * as languageSelector from 'editor/common/modes/languageSelector';
import { WorkspaceEditDto, ResourceTextEditDto, ResourceFileEditDto } from 'workbench/api/node/extHost.protocol';
import { MarkerSeverity, IRelatedInformation, IMarkerData, MarkerTag } from 'platform/markers/common/markers';
import { ACTIVE_GROUP, SIDE_GROUP } from 'workbench/services/editor/common/editorService';
