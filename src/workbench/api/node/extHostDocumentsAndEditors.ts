...
import { ExtHostDocumentsAndEditorsShape, IDocumentsAndEditorsDelta, IMainContext, MainContext } from 'workbench/api/node/extHost.protocol';
import { ExtHostDocumentData } from 'workbench/api/node/extHostDocumentData';
import { ExtHostTextEditor } from 'workbench/api/node/extHostTextEditor';
