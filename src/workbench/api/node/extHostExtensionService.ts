...
import { dirExists, mkdirp, realpath, writeFile } from 'base/node/pfs';
import { ILogService } from 'platform/log/common/log';
import { createApiFactory, initializeExtensionApi } from 'workbench/api/node/extHost.api.impl';
import { ExtHostExtensionServiceShape, IEnvironment, IInitData, IMainContext, IWorkspaceData, MainContext, MainThreadExtensionServiceShape, MainThreadTelemetryShape } from 'workbench/api/node/extHost.protocol';
import { ExtHostConfiguration } from 'workbench/api/node/extHostConfiguration';
import { ActivatedExtension, EmptyExtension, ExtensionActivatedByAPI, ExtensionActivatedByEvent, ExtensionActivationReason, ExtensionActivationTimes, ExtensionActivationTimesBuilder, ExtensionsActivator, IExtensionAPI, IExtensionContext, IExtensionMemento, IExtensionModule } from 'workbench/api/node/extHostExtensionActivator';
...
import { connectProxyResolver } from 'workbench/node/proxyResolver';
