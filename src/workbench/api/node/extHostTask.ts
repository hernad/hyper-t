...
import * as tasks from 'workbench/parts/tasks/common/tasks';

import { MainContext, MainThreadTaskShape, ExtHostTaskShape, IMainContext } from 'workbench/api/node/extHost.protocol';
...
// import { ExtHostVariableResolverService } from 'workbench/api/node/extHostDebugService'; hernad out-debug
