...
import { RenderLineNumbersType, TextEditorCursorStyle, cursorStyleToString } from 'editor/common/config/editorOptions';
...
import { EndOfLineSequence, IIdentifiedSingleEditOperation, ISingleEditOperation, ITextModel, ITextModelUpdateOptions } from 'editor/common/model';
...
import { IApplyEditsOptions, IEditorPropertiesChangeData, IResolvedTextEditorConfiguration, ITextEditorConfigurationUpdate, IUndoStopOptions, TextEditorRevealType } from 'workbench/api/node/extHost.protocol';
import { EndOfLine, TextEditorLineNumbersStyle } from 'workbench/api/node/extHostTypes';
