...
import { IDisposable, IReference, dispose } from 'base/common/lifecycle';
...
import { ExtHostContext, ExtHostDocumentsShape, IExtHostContext, MainThreadDocumentsShape } from 'workbench/api/node/extHost.protocol';
import { ITextEditorModel } from 'workbench/common/editor';
import { ITextFileService, TextFileModelChangeEvent } from 'workbench/services/textfile/common/textfiles';
