...
import { ISCMService, ISCMRepository, ISCMProvider, ISCMResource, ISCMResourceGroup, ISCMResourceDecorations, IInputValidation } from 'workbench/services/scm/common/scm';
...
import { ISplice, Sequence } from 'base/common/sequence';
