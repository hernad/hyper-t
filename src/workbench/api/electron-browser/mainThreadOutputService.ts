...
import { IOutputService, IOutputChannel, OUTPUT_PANEL_ID, Extensions, IOutputChannelRegistry } from 'workbench/parts/output/common/output';
...
import { anyEvent } from 'base/common/event';
