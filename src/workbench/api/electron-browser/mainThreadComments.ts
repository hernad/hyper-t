...
import { ICodeEditor, isCodeEditor, isDiffEditor, IDiffEditor } from 'editor/browser/editorBrowser';
...
import { COMMENTS_PANEL_ID } from 'workbench/parts/comments/electron-browser/commentsPanel';
