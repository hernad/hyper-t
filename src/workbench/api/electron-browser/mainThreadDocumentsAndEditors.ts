...
import { IModelService, shouldSynchronizeModel } from 'editor/common/services/modelService';
import { ITextModelService } from 'editor/common/services/resolverService';
import { IFileService } from 'platform/files/common/files';
import { extHostCustomer } from 'workbench/api/electron-browser/extHostCustomers';
import { MainThreadDocuments } from 'workbench/api/electron-browser/mainThreadDocuments';
import { MainThreadTextEditor } from 'workbench/api/electron-browser/mainThreadEditor';
import { MainThreadTextEditors } from 'workbench/api/electron-browser/mainThreadEditors';
import { ExtHostContext, ExtHostDocumentsAndEditorsShape, IDocumentsAndEditorsDelta, IExtHostContext, IModelAddedData, ITextEditorAddData, MainContext } from 'workbench/api/node/extHost.protocol';
import { EditorViewColumn, editorGroupToViewColumn } from 'workbench/api/shared/editor';
import { BaseTextEditor } from 'workbench/browser/parts/editor/textEditor';
import { IEditor as IWorkbenchEditor } from 'workbench/common/editor';
