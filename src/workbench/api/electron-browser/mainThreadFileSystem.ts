...
import { FileWriteOptions, FileSystemProviderCapabilities, IFileChange, IFileService, IFileSystemProvider, IStat, IWatchOptions, FileType, FileOverwriteOptions, FileDeleteOptions } from 'platform/files/common/files';
...
import { LabelRules, ILabelService } from 'platform/label/common/label';
