...
// import { ResolveSet, ResolvedVariables } from 'workbench/parts/tasks/common/taskSystem';
import { ITaskService, TaskFilter, ITaskProvider } from 'workbench/parts/tasks/common/taskService';

import { TaskDefinition } from 'workbench/parts/tasks/node/tasks';

import { extHostNamedCustomer } from 'workbench/api/electron-browser/extHostCustomers';
import { ExtHostContext, MainThreadTaskShape, ExtHostTaskShape, MainContext, IExtHostContext } from 'workbench/api/node/extHost.protocol';
import {
	TaskDefinitionDTO, TaskExecutionDTO, ProcessExecutionOptionsDTO, TaskPresentationOptionsDTO,
	ProcessExecutionDTO, ShellExecutionDTO, ShellExecutionOptionsDTO, TaskDTO, TaskSourceDTO, TaskHandleDTO, TaskFilterDTO, TaskProcessStartedDTO, TaskProcessEndedDTO /*, TaskSystemInfoDTO hernad out-debug*/
} from 'workbench/api/shared/tasks';
...
export class MainThreadTask implements MainThreadTaskShape {
	...
	//private _extHostContext: IExtHostContext; hernad out-debug
