...
import { ExtHostContext, IExtHostContext, MainContext, MainThreadUrlsShape, ExtHostUrlsShape } from 'workbench/api/node/extHost.protocol';
import { extHostNamedCustomer } from './extHostCustomers';
import { IURLService, IURLHandler } from 'platform/url/common/url';
import { URI } from 'base/common/uri';
import { IDisposable } from 'base/common/lifecycle';
import { IExtensionUrlHandler } from 'workbench/services/extensions/electron-browser/inactiveExtensionUrlHandler';
