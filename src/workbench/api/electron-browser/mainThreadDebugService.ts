...
import { IDebugService, IConfig, IDebugConfigurationProvider, IBreakpoint, IFunctionBreakpoint, IBreakpointData, ITerminalSettings, IDebugAdapter, IDebugAdapterProvider, IDebugSession, IDebugAdapterFactory } from 'workbench/parts/debug/common/debug';
import {
...
import { AbstractDebugAdapter } from 'workbench/parts/debug/node/debugAdapter';
import { IWorkspaceFolder } from 'platform/workspace/common/workspace';
import { convertToVSCPaths, convertToDAPaths, stringToUri, uriToString } from 'workbench/parts/debug/common/debugUtils';
