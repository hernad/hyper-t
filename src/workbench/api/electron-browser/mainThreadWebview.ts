...
import { ExtHostContext, ExtHostWebviewsShape, IExtHostContext, MainContext, MainThreadWebviewsShape, WebviewPanelHandle, WebviewPanelShowOptions } from 'workbench/api/node/extHost.protocol';
import { editorGroupToViewColumn, EditorViewColumn, viewColumnToEditorGroup } from 'workbench/api/shared/editor';
import { WebviewEditor } from 'workbench/parts/webview/electron-browser/webviewEditor';
import { WebviewEditorInput } from 'workbench/parts/webview/electron-browser/webviewEditorInput';
import { ICreateWebViewShowOptions, IWebviewEditorService, WebviewInputOptions, WebviewReviver } from 'workbench/parts/webview/electron-browser/webviewEditorService';
