...
import { ExtensionMessageCollector, ExtensionsRegistry, IExtensionPoint } from 'workbench/services/extensions/common/extensionsRegistry';
import { ViewContainer, ViewsRegistry, ICustomViewDescriptor, IViewContainersRegistry, Extensions as ViewContainerExtensions } from 'workbench/common/views';
import { CustomTreeViewPanel, CustomTreeViewer } from 'workbench/browser/parts/views/customView';
import { ContextKeyExpr } from 'platform/contextkey/common/contextkey';
import { coalesce, } from 'base/common/arrays';
import { viewsContainersExtensionPoint } from 'workbench/api/browser/viewsContainersExtensionPoint';
...
import { VIEWLET_ID as EXPLORER } from 'workbench/parts/files/common/files';
import { VIEWLET_ID as SCM } from 'workbench/parts/scm/common/scm';
// import { VIEWLET_ID as DEBUG } from 'workbench/parts/debug/common/debug';  hernad out-debug
...
class ViewsContainersExtensionHandler implements IWorkbenchContribution {
	...
	private getViewContainer(value: string): ViewContainer {
		switch (value) {
			...
			// case 'debug': return this.viewContainersRegistry.get(DEBUG); hernad out-debug
