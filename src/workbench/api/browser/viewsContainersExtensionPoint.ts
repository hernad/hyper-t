...
import { createCSSRule } from 'base/browser/dom';
import { Registry } from 'platform/registry/common/platform';
import { SyncActionDescriptor } from 'platform/actions/common/actions';
import { ViewletDescriptor, ViewletRegistry, Extensions as ViewletExtensions, ShowViewletAction } from 'workbench/browser/viewlet';
...
import { Extensions as ViewContainerExtensions, IViewContainersRegistry, TEST_VIEW_CONTAINER_ID } from 'workbench/common/views';
import { ViewContainerViewlet } from 'workbench/browser/parts/views/viewsViewlet';
