...
import { createKeybinding, ResolvedKeybinding } from 'base/common/keyCodes';
...
import { ISearchHistoryService, VIEW_ID, ISearchConfiguration } from 'platform/search/common/search';
...
import { FileMatch, FileMatchOrMatch, FolderMatch, Match, RenderableMatch, searchMatchComparer, SearchResult } from 'workbench/parts/search/common/searchModel';
