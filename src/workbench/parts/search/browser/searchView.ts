...
import { IPatternInfo, ISearchComplete, ISearchConfiguration, ISearchHistoryService, ISearchHistoryValues, ISearchProgressItem, ITextQuery, VIEW_ID, SearchErrorCode } from 'platform/search/common/search';
...
import { ICssStyleCollector, ITheme, IThemeService, registerThemingParticipant } from 'platform/theme/common/themeService';
import { IWorkspaceContextService, WorkbenchState } from 'platform/workspace/common/workspace';
import { OpenFileFolderAction, OpenFolderAction } from 'workbench/browser/actions/workspaceActions';
import { SimpleFileResourceDragAndDrop } from 'workbench/browser/dnd';
import { Viewlet } from 'workbench/browser/viewlet';
import { IEditor } from 'workbench/common/editor';
import { IPanel } from 'workbench/common/panel';
import { IViewlet } from 'workbench/common/viewlet';
import { ExcludePatternInputWidget, PatternInputWidget } from 'workbench/parts/search/browser/patternInputWidget';
import { CancelSearchAction, ClearSearchResultsAction, CollapseDeepestExpandedLevelAction, RefreshAction } from 'workbench/parts/search/browser/searchActions';
import { SearchAccessibilityProvider, SearchDataSource, SearchFilter, SearchRenderer, SearchSorter, SearchTreeController } from 'workbench/parts/search/browser/searchResultsView';
import { ISearchWidgetOptions, SearchWidget } from 'workbench/parts/search/browser/searchWidget';
import * as Constants from 'workbench/parts/search/common/constants';
import { ITextQueryBuilderOptions, QueryBuilder } from 'workbench/parts/search/common/queryBuilder';
import { IReplaceService } from 'workbench/parts/search/common/replace';
import { getOutOfWorkspaceEditorResources } from 'workbench/parts/search/common/search';
import { FileMatch, FileMatchOrMatch, FolderMatch, IChangeEvent, ISearchWorkbenchService, Match, SearchModel } from 'workbench/parts/search/common/searchModel';
import { ACTIVE_GROUP, IEditorService, SIDE_GROUP } from 'workbench/services/editor/common/editorService';
...
import { IPreferencesService, ISettingsEditorOptions } from 'workbench/services/preferences/common/preferences';
...
export class SearchView extends Viewlet implements IViewlet, IPanel {
	...
	public onQueryChanged(preserveFocus?: boolean): void {
		...
		// https://github.com/hernad/hyper-t/issues/58374
