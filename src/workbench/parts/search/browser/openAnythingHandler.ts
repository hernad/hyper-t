...
import { QuickOpenEntry, QuickOpenModel, QuickOpenItemAccessor } from 'base/parts/quickopen/browser/quickOpenModel';
import { QuickOpenHandler } from 'workbench/browser/quickopen';
import { FileEntry, OpenFileHandler, FileQuickOpenModel } from 'workbench/parts/search/browser/openFileHandler';
import * as openSymbolHandler from 'workbench/parts/search/browser/openSymbolHandler';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { IWorkbenchSearchConfiguration } from 'workbench/parts/search/common/search';
