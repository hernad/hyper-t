...
import { HistoryInputBox, IMessage } from 'base/browser/ui/inputbox/inputBox';
...
import { appendKeyBindingLabel, isSearchViewFocused } from 'workbench/parts/search/browser/searchActions';
