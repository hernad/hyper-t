...
import { anyEvent, Emitter, Event, fromPromise, stopwatch } from 'base/common/event';
...
import { FindMatch, IModelDeltaDecoration, ITextModel, OverviewRulerLane, TrackedRangeStickiness } from 'editor/common/model';
...
import { IFileMatch, IPatternInfo, ISearchComplete, ISearchProgressItem, ISearchService, ITextQuery, ITextSearchPreviewOptions, ITextSearchMatch, ITextSearchStats, resultIsMatch, ISearchRange, OneLineRange } from 'platform/search/common/search';
...
import { editorMatchesToTextSearchResults } from 'workbench/services/search/common/searchHelpers';
