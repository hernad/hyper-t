...
import { ISearchConfiguration, ISearchConfigurationProperties } from 'platform/search/common/search';
import { SymbolKind, Location, ProviderResult } from 'editor/common/modes';
