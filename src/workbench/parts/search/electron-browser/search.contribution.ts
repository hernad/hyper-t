...
import 'css!./media/search.contribution';
...
import { ExplorerFolderContext, ExplorerRootContext } from 'workbench/parts/files/common/files';
import { SyncActionDescriptor, MenuRegistry, MenuId, ICommandAction } from 'platform/actions/common/actions';
import { IWorkbenchActionRegistry, Extensions as ActionExtensions } from 'workbench/common/actions';
import { QuickOpenHandlerDescriptor, IQuickOpenRegistry, Extensions as QuickOpenExtensions } from 'workbench/browser/quickopen';
...
import { registerContributions as replaceContributions } from 'workbench/parts/search/browser/replaceContributions';
import { registerContributions as searchWidgetContributions } from 'workbench/parts/search/browser/searchWidget';
...
import { ISearchWorkbenchService, SearchWorkbenchService } from 'workbench/parts/search/common/searchModel';
import { CommandsRegistry } from 'platform/commands/common/commands';
import { SearchView } from 'workbench/parts/search/browser/searchView';
import { defaultQuickOpenContextKey } from 'workbench/browser/parts/quickopen/quickopen';
import { OpenSymbolHandler } from 'workbench/parts/search/browser/openSymbolHandler';
import { OpenAnythingHandler } from 'workbench/parts/search/browser/openAnythingHandler';
import { registerLanguageCommand } from 'editor/browser/editorExtensions';
import { getWorkspaceSymbols } from 'workbench/parts/search/common/search';
...
import { SearchViewLocationUpdater } from 'workbench/parts/search/browser/searchViewLocationUpdater';
