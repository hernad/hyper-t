...
import { Event, Emitter, chain, mapEvent, anyEvent, filterEvent, latch } from 'base/common/event';
import { domEvent, stop } from 'base/browser/event';
import { basename } from 'base/common/paths';
import { IDisposable, dispose, combinedDisposable, Disposable, toDisposable } from 'base/common/lifecycle';
import { PanelViewlet, ViewletPanel, IViewletPanelOptions } from 'workbench/browser/parts/views/panelViewlet';
import { append, $, addClass, toggleClass, trackFocus, Dimension, addDisposableListener, removeClass } from 'base/browser/dom';
import { ITelemetryService } from 'platform/telemetry/common/telemetry';
import { List } from 'base/browser/ui/list/listWidget';
import { IListVirtualDelegate, IListRenderer, IListContextMenuEvent, IListEvent } from 'base/browser/ui/list/list';
import { VIEWLET_ID, VIEW_CONTAINER } from 'workbench/parts/scm/common/scm';
import { FileLabel } from 'workbench/browser/labels';
import { CountBadge } from 'base/browser/ui/countBadge/countBadge';
import { ISCMService, ISCMRepository, ISCMResourceGroup, ISCMResource, InputValidationType } from 'workbench/services/scm/common/scm';
...
import { MenuItemAction, IMenuService, MenuId } from 'platform/actions/common/actions';
import { IAction, Action, IActionItem, ActionRunner } from 'base/common/actions';
import { fillInContextMenuActions, ContextAwareMenuItemActionItem, fillInActionBarActions } from 'platform/actions/browser/menuItemActionItem';
import { SCMMenus } from './scmMenus';
import { ActionBar, IActionItemProvider, Separator, ActionItem } from 'base/browser/ui/actionbar/actionbar';
import { IThemeService, LIGHT } from 'platform/theme/common/themeService';
import { isSCMResource, getSCMResourceContextKey } from './scmUtil';
import { attachBadgeStyler, attachInputBoxStyler } from 'platform/theme/common/styler';
...
import { ISpliceable, ISequence, ISplice } from 'base/common/sequence';
...
import { IViewDescriptorRef, PersistentContributableViewsModel, IAddedViewDescriptorRef } from 'workbench/browser/parts/views/views';
import { IViewDescriptor, IViewsViewlet, IView } from 'workbench/common/views';
