...
import { IDisposable, dispose, Disposable, combinedDisposable } from 'base/common/lifecycle';
import { filterEvent, anyEvent as anyEvent } from 'base/common/event';
import { VIEWLET_ID } from 'workbench/parts/scm/common/scm';
import { ISCMService, ISCMRepository } from 'workbench/services/scm/common/scm';
import { IActivityService, NumberBadge } from 'workbench/services/activity/common/activity';
...
import { IStatusbarService, StatusbarAlignment as MainThreadStatusBarAlignment } from 'platform/statusbar/common/statusbar';
