...
import 'css!./media/dirtydiffDecorator';
import { ThrottledDelayer, always, first } from 'base/common/async';
import { IDisposable, dispose, toDisposable, Disposable, combinedDisposable } from 'base/common/lifecycle';
import { TPromise } from 'base/common/winjs.base';
import { Event, Emitter, anyEvent as anyEvent, filterEvent, once } from 'base/common/event';
import * as ext from 'workbench/common/contributions';
...
import { ISCMService, ISCMRepository } from 'workbench/services/scm/common/scm';
import { ModelDecorationOptions } from 'editor/common/model/textModel';
import { registerThemingParticipant, ITheme, ICssStyleCollector, themeColorFromId, IThemeService } from 'platform/theme/common/themeService';
...
import { registerEditorAction, registerEditorContribution, ServicesAccessor, EditorAction } from 'editor/browser/editorExtensions';
import { PeekViewWidget, getOuterEditor } from 'editor/contrib/referenceSearch/peekViewWidget';
...
import { peekViewBorder, peekViewTitleBackground, peekViewTitleForeground, peekViewTitleInfoForeground } from 'editor/contrib/referenceSearch/referencesWidget';
import { EmbeddedDiffEditorWidget } from 'editor/browser/widget/embeddedCodeEditorWidget';
...
import { IActionBarOptions, ActionsOrientation, IActionItem } from 'base/browser/ui/actionbar/actionbar';
import { IKeybindingService } from 'platform/keybinding/common/keybinding';
import { basename } from 'base/common/paths';
import { MenuId, IMenuService, IMenu, MenuItemAction } from 'platform/actions/common/actions';
import { MenuItemActionItem, fillInActionBarActions } from 'platform/actions/browser/menuItemActionItem';
import { IChange, IEditorModel, ScrollType, IEditorContribution } from 'editor/common/editorCommon';
import { OverviewRulerLane, ITextModel, IModelDecorationOptions } from 'editor/common/model';
import { sortedDiff, firstIndex } from 'base/common/arrays';
import { IMarginData } from 'editor/browser/controller/mouseTarget';
