...
import { SCMViewlet } from 'workbench/parts/scm/electron-browser/scmViewlet';
...
import { ContextKeyDefinedExpr, IContextKeyService } from 'platform/contextkey/common/contextkey';
import { ISCMRepository } from 'workbench/services/scm/common/scm';
