...
import { ITerminalInstance, IShellLaunchConfig, ITerminalTab, Direction, ITerminalService, ITerminalConfigHelper } from 'workbench/parts/terminal/common/terminal';
import { IContextKey } from 'platform/contextkey/common/contextkey';
import { Event, Emitter, anyEvent } from 'base/common/event';
...
import { IPartService, Position } from 'workbench/services/part/common/partService';
