...
import { IActionItem, Separator } from 'base/browser/ui/actionbar/actionbar';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { IContextMenuService } from 'platform/contextview/browser/contextView';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { ITelemetryService } from 'platform/telemetry/common/telemetry';
import { ITerminalService, TERMINAL_PANEL_ID } from 'workbench/parts/terminal/common/terminal';
import { IThemeService, ITheme, registerThemingParticipant, ICssStyleCollector } from 'platform/theme/common/themeService';
import { TerminalFindWidget } from 'workbench/parts/terminal/browser/terminalFindWidget';
import { editorHoverBackground, editorHoverBorder, editorForeground } from 'platform/theme/common/colorRegistry';
import { KillTerminalAction, SwitchTerminalAction, SwitchTerminalActionItem, CopyTerminalSelectionAction, TerminalPasteAction, ClearTerminalAction, SelectAllTerminalAction, CreateNewTerminalAction, SplitTerminalAction } from 'workbench/parts/terminal/electron-browser/terminalActions';
import { Panel } from 'workbench/browser/panel';
import { StandardMouseEvent } from 'base/browser/mouseEvent';
import { URI } from 'base/common/uri';
import { TERMINAL_BACKGROUND_COLOR, TERMINAL_BORDER_COLOR } from 'workbench/parts/terminal/common/terminalColorRegistry';
