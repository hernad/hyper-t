...
import { WindowsShellHelper } from 'workbench/parts/terminal/node/windowsShellHelper';
...
import { ITerminalInstance, KEYBINDING_CONTEXT_TERMINAL_TEXT_SELECTED, TERMINAL_PANEL_ID, IShellLaunchConfig, ITerminalProcessManager, ProcessState, NEVER_MEASURE_RENDER_TIME_STORAGE_KEY, ITerminalDimensions } from 'workbench/parts/terminal/common/terminal';
...
import { TerminalConfigHelper } from 'workbench/parts/terminal/electron-browser/terminalConfigHelper';
import { TerminalLinkHandler } from 'workbench/parts/terminal/electron-browser/terminalLinkHandler';
import { TerminalWidgetManager } from 'workbench/parts/terminal/browser/terminalWidgetManager';
import { registerThemingParticipant, ITheme, ICssStyleCollector, IThemeService } from 'platform/theme/common/themeService';
import { scrollbarSliderBackground, scrollbarSliderHoverBackground, scrollbarSliderActiveBackground, activeContrastBorder } from 'platform/theme/common/colorRegistry';
import { IClipboardService } from 'platform/clipboard/common/clipboardService';
import { ansiColorIdentifiers, TERMINAL_BACKGROUND_COLOR, TERMINAL_FOREGROUND_COLOR, TERMINAL_CURSOR_FOREGROUND_COLOR, TERMINAL_CURSOR_BACKGROUND_COLOR, TERMINAL_SELECTION_BACKGROUND_COLOR } from 'workbench/parts/terminal/common/terminalColorRegistry';
import { PANEL_BACKGROUND } from 'workbench/common/theme';
...
import { INotificationService, Severity, IPromptChoice } from 'platform/notification/common/notification';
import { ILogService } from 'platform/log/common/log';
import { TerminalCommandTracker } from 'workbench/parts/terminal/node/terminalCommandTracker';
