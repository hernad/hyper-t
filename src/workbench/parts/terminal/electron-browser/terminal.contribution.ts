...
import { TerminalService } from 'workbench/parts/terminal/electron-browser/terminalService';
import { ToggleTabFocusModeAction } from 'editor/contrib/toggleTabFocusMode/toggleTabFocusMode';
import { registerSingleton } from 'platform/instantiation/common/extensions';
import { KeybindingWeight } from 'platform/keybinding/common/keybindingsRegistry';
import { OpenNextRecentlyUsedEditorInGroupAction, OpenPreviousRecentlyUsedEditorInGroupAction, FocusActiveGroupAction, FocusFirstGroupAction, FocusLastGroupAction, OpenFirstEditorInGroup, OpenLastEditorInGroup } from 'workbench/browser/parts/editor/editorActions';
import { EDITOR_FONT_DEFAULTS } from 'editor/common/config/editorOptions';
import { registerColors } from 'workbench/parts/terminal/common/terminalColorRegistry';
import { NavigateUpAction, NavigateDownAction, NavigateLeftAction, NavigateRightAction } from 'workbench/electron-browser/actions';
import { QUICKOPEN_ACTION_ID, getQuickNavigateHandler, QUICKOPEN_FOCUS_SECONDARY_ACTION_ID } from 'workbench/browser/parts/quickopen/quickopen';
...
import { TogglePanelAction } from 'workbench/browser/parts/panel/panelActions';
import { TerminalPanel } from 'workbench/parts/terminal/electron-browser/terminalPanel';
import { TerminalPickerHandler } from 'workbench/parts/terminal/browser/terminalQuickOpen';
import { setupTerminalCommands, TERMINAL_COMMAND_ID } from 'workbench/parts/terminal/common/terminalCommands';
import { setupTerminalMenu } from 'workbench/parts/terminal/common/terminalMenu';
...
actionRegistry.registerWorkbenchAction(new SyncActionDescriptor(RunCtrlPTerminalAction, RunCtrlPTerminalAction.ID, RunCtrlPTerminalAction.LABEL), 'Terminal: Ctrl_P In Active Terminal', category);
