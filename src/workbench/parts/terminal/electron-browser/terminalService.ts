...
import { ITerminalInstance, ITerminalService, IShellLaunchConfig, ITerminalConfigHelper, NEVER_SUGGEST_SELECT_WINDOWS_SHELL_STORAGE_KEY, TERMINAL_PANEL_ID, ITerminalProcessExtHostProxy } from 'workbench/parts/terminal/common/terminal';
import { TerminalService as AbstractTerminalService } from 'workbench/parts/terminal/common/terminalService';
...
import { TerminalTab } from 'workbench/parts/terminal/browser/terminalTab';
import { IDialogService } from 'platform/dialogs/common/dialogs';
import { INotificationService } from 'platform/notification/common/notification';
import { ipcRenderer as ipc } from 'electron';
import { IOpenFileRequest } from 'platform/windows/common/windows';
import { TerminalInstance } from 'workbench/parts/terminal/electron-browser/terminalInstance';
import { IExtensionService } from 'workbench/services/extensions/common/extensions';
import { IQuickInputService, IQuickPickItem, IPickOptions } from 'platform/quickinput/common/quickInput';
