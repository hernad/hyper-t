...
import 'css!./media/keybindings';
import * as nls from 'base/nls';
import { OS } from 'base/common/platform';
import { Disposable, dispose, toDisposable, IDisposable } from 'base/common/lifecycle';
...
import { SearchWidget, SearchOptions } from 'workbench/parts/preferences/browser/preferencesWidgets';
