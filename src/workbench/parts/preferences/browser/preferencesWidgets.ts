...
import { ActionBar, ActionsOrientation, BaseActionItem } from 'base/browser/ui/actionbar/actionbar';
...
import { activeContrastBorder, badgeBackground, badgeForeground, contrastBorder, focusBorder } from 'platform/theme/common/colorRegistry';
...
import { PANEL_ACTIVE_TITLE_BORDER, PANEL_ACTIVE_TITLE_FOREGROUND, PANEL_INACTIVE_TITLE_FOREGROUND } from 'workbench/common/theme';
import { ISettingsGroup } from 'workbench/services/preferences/common/preferences';
