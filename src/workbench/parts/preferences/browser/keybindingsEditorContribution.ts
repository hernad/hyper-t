...
import { KeyCode, KeyMod, KeyChord, SimpleKeybinding } from 'base/common/keyCodes';
...
import { registerEditorContribution, ServicesAccessor, registerEditorCommand, EditorCommand } from 'editor/browser/editorExtensions';
...
import { SmartSnippetInserter } from 'workbench/parts/preferences/common/smartSnippetInserter';
import { DefineKeybindingOverlayWidget } from 'workbench/parts/preferences/browser/keybindingWidgets';
import { FloatingClickWidget } from 'workbench/browser/parts/editor/editorWidgets';
import { parseTree, Node } from 'base/common/json';
import { ScanCodeBinding } from 'base/common/scanCode';
import { EditorContextKeys } from 'editor/common/editorContextKeys';
import { WindowsNativeResolvedKeybinding } from 'workbench/services/keybinding/common/windowsKeyboardMapper';
...
import { IModelDeltaDecoration, ITextModel, TrackedRangeStickiness, OverviewRulerLane } from 'editor/common/model';
