...
import { IDataSource, IRenderer, ITree, ITreeConfiguration, ITreeOptions } from 'base/parts/tree/browser/tree';
...
import { SettingsAccessibilityProvider, SettingsTreeFilter } from 'workbench/parts/preferences/browser/settingsTree';
import { ISettingsEditorViewState, SearchResultModel, SettingsTreeElement, SettingsTreeGroupElement, SettingsTreeSettingElement } from 'workbench/parts/preferences/browser/settingsTreeModels';
import { settingsHeaderForeground } from 'workbench/parts/preferences/browser/settingsWidgets';
