...
import { EditorExtensionsRegistry, IEditorContributionCtor, registerEditorContribution } from 'editor/browser/editorExtensions';
...
import { Extensions as EditorExtensions, IEditorRegistry } from 'workbench/browser/editor';
import { BaseEditor } from 'workbench/browser/parts/editor/baseEditor';
import { BaseTextEditor } from 'workbench/browser/parts/editor/textEditor';
import { EditorInput, EditorOptions, IEditorControl } from 'workbench/common/editor';
import { ResourceEditorModel } from 'workbench/common/editor/resourceEditorModel';
import { PREFERENCES_EDITOR_ID } from 'workbench/parts/files/common/files';
import { DefaultSettingsRenderer, FolderSettingsRenderer, IPreferencesRenderer, UserSettingsRenderer, WorkspaceSettingsRenderer } from 'workbench/parts/preferences/browser/preferencesRenderers';
import { SearchWidget, SettingsTarget, SettingsTargetsWidget } from 'workbench/parts/preferences/browser/preferencesWidgets';
import { CONTEXT_SETTINGS_EDITOR, CONTEXT_SETTINGS_SEARCH_FOCUS, IPreferencesSearchService, ISearchProvider, CONTEXT_SETTINGS_JSON_EDITOR } from 'workbench/parts/preferences/common/preferences';
import { IEditorService } from 'workbench/services/editor/common/editorService';
import { IEditorGroup, IEditorGroupsService } from 'workbench/services/group/common/editorGroupsService';
import { IFilterResult, IPreferencesService, ISearchResult, ISetting, ISettingsEditorModel, ISettingsGroup, SettingsEditorOptions } from 'workbench/services/preferences/common/preferences';
import { DefaultPreferencesEditorInput, PreferencesEditorInput } from 'workbench/services/preferences/common/preferencesEditorInput';
import { DefaultSettingsEditorModel, SettingsEditorModel } from 'workbench/services/preferences/common/preferencesModels';
