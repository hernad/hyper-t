...
import 'css!../browser/media/preferences';
...
import { Extensions as WorkbenchExtensions, IWorkbenchContributionsRegistry } from 'workbench/common/contributions';
import { EditorInput, Extensions as EditorInputExtensions, IEditorInputFactory, IEditorInputFactoryRegistry } from 'workbench/common/editor';
import { KeybindingsEditor } from 'workbench/parts/preferences/browser/keybindingsEditor';
...
import { PreferencesEditor } from 'workbench/parts/preferences/browser/preferencesEditor';
...
import { PreferencesContribution } from 'workbench/parts/preferences/common/preferencesContribution';
import { PreferencesSearchService } from 'workbench/parts/preferences/electron-browser/preferencesSearch';
import { SettingsEditor2 } from 'workbench/parts/preferences/electron-browser/settingsEditor2';
...
import { DefaultPreferencesEditorInput, KeybindingsEditorInput, PreferencesEditorInput, SettingsEditor2Input } from 'workbench/services/preferences/common/preferencesEditorInput';
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		...
		iconLocation: {
			light: URI.parse(require.toUrl(`workbench/parts/preferences/electron-browser/media/edit-json.svg`)),
			dark: URI.parse(require.toUrl(`workbench/parts/preferences/electron-browser/media/edit-json-inverse.svg`))
		}
	},
	when: ContextKeyExpr.and(CONTEXT_KEYBINDINGS_EDITOR),
	group: 'navigation',
