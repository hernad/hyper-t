...
import 'css!./media/settingsEditor2';
import { localize } from 'base/nls';
import { ConfigurationTarget, ConfigurationTargetToString, IConfigurationOverrides, IConfigurationService } from 'platform/configuration/common/configuration';
...
import { BaseEditor } from 'workbench/browser/parts/editor/baseEditor';
import { IEditor, IEditorMemento } from 'workbench/common/editor';
import { attachSuggestEnabledInputBoxStyler, SuggestEnabledInput } from 'workbench/parts/codeEditor/electron-browser/suggestEnabledInput';
import { SettingsTarget, SettingsTargetsWidget } from 'workbench/parts/preferences/browser/preferencesWidgets';
import { commonlyUsedData, tocData } from 'workbench/parts/preferences/browser/settingsLayout';
import { ISettingLinkClickEvent, ISettingOverrideClickEvent, resolveExtensionsSettings, resolveSettingsTree, SettingsDataSource, SettingsRenderer, SettingsTree, SimplePagedDataSource } from 'workbench/parts/preferences/browser/settingsTree';
import { parseQuery, ISettingsEditorViewState, SearchResultIdx, SearchResultModel, SettingsTreeGroupElement, SettingsTreeModel, SettingsTreeSettingElement } from 'workbench/parts/preferences/browser/settingsTreeModels';
import { settingsTextInputBorder } from 'workbench/parts/preferences/browser/settingsWidgets';
import { TOCRenderer, TOCTree, TOCTreeModel } from 'workbench/parts/preferences/browser/tocTree';
import { CONTEXT_SETTINGS_EDITOR, CONTEXT_SETTINGS_SEARCH_FOCUS, CONTEXT_TOC_ROW_FOCUS, IPreferencesSearchService, ISearchProvider, MODIFIED_SETTING_TAG, SETTINGS_EDITOR_COMMAND_SHOW_CONTEXT_MENU } from 'workbench/parts/preferences/common/preferences';
import { IEditorGroupsService } from 'workbench/services/group/common/editorGroupsService';
import { IPreferencesService, ISearchResult, ISettingsEditorModel, ISettingsEditorOptions, SettingsEditorOptions, SettingValueType } from 'workbench/services/preferences/common/preferences';
import { SettingsEditor2Input } from 'workbench/services/preferences/common/preferencesEditorInput';
