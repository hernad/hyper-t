...
import { IActivityService, NumberBadge, IBadge, ProgressBadge } from 'workbench/services/activity/common/activity';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { IGlobalActivity } from 'workbench/common/activity';
...
import { IUpdateService, State as UpdateState, StateType, IUpdate } from 'platform/update/common/update';
import * as semver from 'semver';
import { IEnvironmentService } from 'platform/environment/common/environment';
import { INotificationService, INotificationHandle, Severity } from 'platform/notification/common/notification';
