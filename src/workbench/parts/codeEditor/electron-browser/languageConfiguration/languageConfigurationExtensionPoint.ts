...
import { ParseError, parse } from 'base/common/json';
...
import { CharacterPair, CommentRule, FoldingRules, IAutoClosingPair, IAutoClosingPairConditional, IndentationRule, LanguageConfiguration } from 'editor/common/modes/languageConfiguration';
