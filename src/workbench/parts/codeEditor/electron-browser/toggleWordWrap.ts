...
import { EDITOR_DEFAULTS, InternalEditorOptions } from 'editor/common/config/editorOptions';
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		...
		iconLocation: { dark: URI.parse(require.toUrl('workbench/parts/codeEditor/electron-browser/media/WordWrap_16x.svg')) }
	},
	group: 'navigation',
	order: 1,
