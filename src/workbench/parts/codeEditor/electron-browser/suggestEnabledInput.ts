...
import 'css!./media/suggestEnabledInput';
import { $, Dimension, addClass, append, removeClass } from 'base/browser/dom';
import { Widget } from 'base/browser/ui/widget';
import { Color } from 'base/common/color';
import { Emitter, Event, chain } from 'base/common/event';
...
import { ColorIdentifier, editorSelectionBackground, inputBackground, inputBorder, inputForeground, inputPlaceholderForeground, selectionBackground } from 'platform/theme/common/colorRegistry';
import { IStyleOverrides, IThemable, attachStyler } from 'platform/theme/common/styler';
...
import { getSimpleEditorOptions } from 'workbench/parts/codeEditor/browser/simpleEditorOptions';
