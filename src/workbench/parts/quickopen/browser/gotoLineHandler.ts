...
import { QuickOpenHandler, EditorQuickOpenEntry, QuickOpenAction } from 'workbench/browser/quickopen';
import { IEditor, IEditorViewState, IDiffEditorModel, ScrollType } from 'editor/common/editorCommon';
import { OverviewRulerLane, IModelDeltaDecoration, ITextModel } from 'editor/common/model';
import { ITextEditorOptions } from 'platform/editor/common/editor';
import { IEditorInput, GroupIdentifier } from 'workbench/common/editor';
...
import { IEditorOptions, RenderLineNumbersType } from 'editor/common/config/editorOptions';
