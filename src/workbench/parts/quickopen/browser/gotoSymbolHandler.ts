...
import 'css!editor/contrib/documentSymbols/media/symbol-icons';
import * as nls from 'base/nls';
import * as types from 'base/common/types';
import * as strings from 'base/common/strings';
import { IEntryRunContext, Mode, IAutoFocus } from 'base/parts/quickopen/common/quickOpen';
import { QuickOpenModel, IHighlight } from 'base/parts/quickopen/browser/quickOpenModel';
import { QuickOpenHandler, EditorQuickOpenEntryGroup, QuickOpenAction } from 'workbench/browser/quickopen';
import * as filters from 'base/common/filters';
import { IEditor, IDiffEditorModel, IEditorViewState, ScrollType } from 'editor/common/editorCommon';
import { IModelDecorationsChangeAccessor, OverviewRulerLane, IModelDeltaDecoration, ITextModel } from 'editor/common/model';
...
import { DocumentSymbolProviderRegistry, DocumentSymbol, symbolKindToCssClass, SymbolKind } from 'editor/common/modes';
...
import { GroupIdentifier, IEditorInput } from 'workbench/common/editor';
