...
import { LinkProviderRegistry, ILink } from 'editor/common/modes';
import { IWorkspaceContextService } from 'platform/workspace/common/workspace';
import { OUTPUT_MODE_ID, LOG_MODE_ID } from 'workbench/parts/output/common/output';
import { MonacoWebWorker, createWebWorker } from 'editor/common/services/webWorker';
import { ICreateData, OutputLinkComputer } from 'workbench/parts/output/common/outputLinkComputer';
	...
	private getOrCreateWorker(): MonacoWebWorker<OutputLinkComputer> {
		...
		if (!this.worker) {
			...
			this.worker = createWebWorker<OutputLinkComputer>(this.modelService, {
				moduleId: 'workbench/parts/output/common/outputLinkComputer',
				createData,
