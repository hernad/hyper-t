...
import { OutputService, LogContentProvider } from 'workbench/parts/output/electron-browser/outputServices';
import { ToggleOutputAction, ClearOutputAction, OpenLogOutputFile, ShowLogsOutputChannelAction, OpenOutputLogFileAction } from 'workbench/parts/output/browser/outputActions';
import { OUTPUT_MODE_ID, OUTPUT_MIME, OUTPUT_PANEL_ID, IOutputService, CONTEXT_IN_OUTPUT, LOG_SCHEME, LOG_MODE_ID, LOG_MIME, CONTEXT_ACTIVE_LOG_OUTPUT } from 'workbench/parts/output/common/output';
import { PanelRegistry, Extensions, PanelDescriptor } from 'workbench/browser/panel';
import { CommandsRegistry, ICommandHandler } from 'platform/commands/common/commands';
import { ContextKeyExpr } from 'platform/contextkey/common/contextkey';
import { OutputPanel } from 'workbench/parts/output/browser/outputPanel';
import { IEditorRegistry, Extensions as EditorExtensions, EditorDescriptor } from 'workbench/browser/editor';
import { LogViewer, LogViewerInput } from 'workbench/parts/output/browser/logViewer';
