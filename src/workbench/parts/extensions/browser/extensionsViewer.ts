...
import { IDataSource, ITree, IRenderer } from 'base/parts/tree/browser/tree';
...
import { WorkbenchTreeController, WorkbenchTree, IListService } from 'platform/list/browser/listService';
