...
import { ShowRecommendedExtensionsAction, InstallWorkspaceRecommendedExtensionsAction, InstallRecommendedExtensionAction } from 'workbench/parts/extensions/electron-browser/extensionsActions';
import Severity from 'base/common/severity';
import { IWorkspaceContextService, IWorkspaceFolder, IWorkspace, IWorkspaceFoldersChangeEvent, WorkbenchState } from 'platform/workspace/common/workspace';
import { IFileService } from 'platform/files/common/files';
import { IExtensionsConfiguration, ConfigurationKey, ShowRecommendationsOnlyOnDemandKey, IExtensionsViewlet, IExtensionsWorkbenchService } from 'workbench/parts/extensions/common/extensions';
...
import { flatten, distinct, shuffle, coalesce } from 'base/common/arrays';
import { IEnvironmentService } from 'platform/environment/common/environment';
import { guessMimeTypes, MIME_UNKNOWN } from 'base/common/mime';
import { IExtensionService } from 'workbench/services/extensions/common/extensions';
import { getHashedRemotesFromUri } from 'workbench/parts/stats/node/workspaceStats';
...
import { areSameExtensions, getGalleryExtensionIdFromLocal } from 'platform/extensionManagement/common/extensionManagementUtil';
import { IExperimentService, ExperimentActionType, ExperimentState } from 'workbench/parts/experiments/node/experimentService';
import { CancellationToken } from 'base/common/cancellation';
import { getKeywordsForExtension } from 'workbench/parts/extensions/electron-browser/extensionsUtils';
