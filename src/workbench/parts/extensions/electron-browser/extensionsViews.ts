...
import { SortBy, SortOrder, IQueryOptions, LocalExtensionType, IExtensionTipsService, IExtensionRecommendation } from 'platform/extensionManagement/common/extensionManagement';
...
import { append, $, toggleClass } from 'base/browser/dom';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { Delegate, Renderer, IExtensionWithFocus as IExtension } from 'workbench/parts/extensions/electron-browser/extensionsList';
...
import { InstallWorkspaceRecommendedExtensionsAction, ConfigureWorkspaceFolderRecommendedExtensionsAction, ManageExtensionAction } from 'workbench/parts/extensions/electron-browser/extensionsActions';
...
import { IExperimentService, IExperiment, ExperimentActionType } from 'workbench/parts/experiments/node/experimentService';
import { alert } from 'base/browser/ui/aria/aria';
import { IListContextMenuEvent, IListEvent } from 'base/browser/ui/list/list';
