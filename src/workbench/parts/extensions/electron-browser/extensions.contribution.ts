...
import { IExtensionTipsService, ExtensionsLabel, ExtensionsChannelId, PreferencesLabel } from 'platform/extensionManagement/common/extensionManagement';

import { IWorkbenchActionRegistry, Extensions as WorkbenchActionExtensions } from 'workbench/common/actions';
import { ExtensionTipsService } from 'workbench/parts/extensions/electron-browser/extensionTipsService';
import { IWorkbenchContributionsRegistry, Extensions as WorkbenchExtensions } from 'workbench/common/contributions';
import { IOutputChannelRegistry, Extensions as OutputExtensions } from 'workbench/parts/output/common/output';
import { SyncDescriptor } from 'platform/instantiation/common/descriptors';
import { VIEWLET_ID, IExtensionsWorkbenchService } from '../common/extensions';
import { ExtensionsWorkbenchService } from 'workbench/parts/extensions/node/extensionsWorkbenchService';
import {
...
} from 'workbench/parts/extensions/electron-browser/extensionsActions';
import { ExtensionsInput } from 'workbench/parts/extensions/common/extensionsInput';
import { ViewletRegistry, Extensions as ViewletExtensions, ViewletDescriptor } from 'workbench/browser/viewlet';
import { ExtensionEditor } from 'workbench/parts/extensions/electron-browser/extensionEditor';
import { StatusUpdater, ExtensionsViewlet, MaliciousExtensionChecker, ExtensionsViewletViewsContribution } from 'workbench/parts/extensions/electron-browser/extensionsViewlet';
import { IQuickOpenRegistry, Extensions, QuickOpenHandlerDescriptor } from 'workbench/browser/quickopen';
...
import { ExtensionsConfigurationSchema, ExtensionsConfigurationSchemaId } from 'workbench/parts/extensions/common/extensionsFileTemplate';
import { CommandsRegistry } from 'platform/commands/common/commands';
import { ServicesAccessor, IInstantiationService } from 'platform/instantiation/common/instantiation';
import { KeymapExtensions } from 'workbench/parts/extensions/electron-browser/extensionsUtils';
import { areSameExtensions } from 'platform/extensionManagement/common/extensionManagementUtil';
import { GalleryExtensionsHandler, ExtensionsHandler } from 'workbench/parts/extensions/browser/extensionsQuickOpen';
import { EditorDescriptor, IEditorRegistry, Extensions as EditorExtensions } from 'workbench/browser/editor';
import { LifecyclePhase } from 'platform/lifecycle/common/lifecycle';
import { RuntimeExtensionsEditor, ShowRuntimeExtensionsAction, IExtensionHostProfileService, /* DebugExtensionHostAction hernad out-debug*/ StartExtensionHostProfileAction, StopExtensionHostProfileAction, CONTEXT_PROFILE_SESSION_STATE, SaveExtensionHostProfileAction, CONTEXT_EXTENSION_HOST_PROFILE_RECORDED } from 'workbench/parts/extensions/electron-browser/runtimeExtensionsEditor';
import { EditorInput, IEditorInputFactory, IEditorInputFactoryRegistry, Extensions as EditorInputExtensions, ActiveEditorContext } from 'workbench/common/editor';
import { ExtensionHostProfileService } from 'workbench/parts/extensions/electron-browser/extensionProfileService';
import { RuntimeExtensionsInput } from 'workbench/services/extensions/electron-browser/runtimeExtensionsInput';
import { URI } from 'base/common/uri';
import { ContextKeyExpr } from 'platform/contextkey/common/contextkey';
import { ExtensionActivationProgress } from 'workbench/parts/extensions/electron-browser/extensionsActivationProgress';
import { ExtensionsAutoProfiler } from 'workbench/parts/extensions/electron-browser/extensionsAutoProfiler';
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		...
		iconLocation: {
			dark: URI.parse(require.toUrl(`workbench/parts/extensions/electron-browser/media/start-inverse.svg`)),
			light: URI.parse(require.toUrl(`workbench/parts/extensions/electron-browser/media/start.svg`)),
		}
	},
	group: 'navigation',
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		...
		iconLocation: {
			dark: URI.parse(require.toUrl(`workbench/parts/extensions/electron-browser/media/profile-start-inverse.svg`)),
			light: URI.parse(require.toUrl(`workbench/parts/extensions/electron-browser/media/profile-start.svg`)),
		}
	},
	group: 'navigation',
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		...
		iconLocation: {
			dark: URI.parse(require.toUrl(`workbench/parts/extensions/electron-browser/media/profile-stop-inverse.svg`)),
			light: URI.parse(require.toUrl(`workbench/parts/extensions/electron-browser/media/profile-stop.svg`)),
		}
	},
	group: 'navigation',
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		...
		iconLocation: {
			dark: URI.parse(require.toUrl(`workbench/parts/extensions/electron-browser/media/save-inverse.svg`)),
			light: URI.parse(require.toUrl(`workbench/parts/extensions/electron-browser/media/save.svg`)),
		},
