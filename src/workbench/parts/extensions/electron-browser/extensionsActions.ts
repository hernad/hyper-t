...
import 'css!./media/extensionActions';
...
import { ActionItem, Separator, IActionItemOptions } from 'base/browser/ui/actionbar/actionbar';
...
import { IExtension, ExtensionState, IExtensionsWorkbenchService, VIEWLET_ID, IExtensionsViewlet, AutoUpdateConfigurationKey } from 'workbench/parts/extensions/common/extensions';
import { ExtensionsConfigurationInitialContent } from 'workbench/parts/extensions/common/extensionsFileTemplate';
...
import { isUIExtension } from 'platform/extensions/common/extensions';
import { IInstantiationService, ServicesAccessor } from 'platform/instantiation/common/instantiation';
import { ShowViewletAction } from 'workbench/browser/viewlet';
...
import { IFileService, IContent } from 'platform/files/common/files';
...
import { IExtensionService, IExtensionDescription } from 'workbench/services/extensions/common/extensions';
import { URI } from 'base/common/uri';
import { CommandsRegistry, ICommandService } from 'platform/commands/common/commands';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { registerThemingParticipant, ITheme, ICssStyleCollector } from 'platform/theme/common/themeService';
import { buttonBackground, buttonForeground, buttonHoverBackground, contrastBorder, registerColor, foreground } from 'platform/theme/common/colorRegistry';
...
import { PagedModel } from 'base/common/paging';
...
import { PICK_WORKSPACE_FOLDER_COMMAND_ID } from 'workbench/browser/actions/workspaceCommands';
