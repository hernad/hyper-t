...
import 'css!./media/extensionEditor';
...
import { Event, Emitter, once, chain } from 'base/common/event';
import { Cache, CacheResult } from 'base/common/cache';
...
import { append, $, addClass, removeClass, finalHandler, join, toggleClass } from 'base/browser/dom';
...
import { IExtensionManifest, IKeyBinding, IView, IExtensionTipsService, LocalExtensionType, IViewContainer } from 'platform/extensionManagement/common/extensionManagement';
import { ResolvedKeybinding, KeyMod, KeyCode } from 'base/common/keyCodes';
import { ExtensionsInput } from 'workbench/parts/extensions/common/extensionsInput';
import { IExtensionsWorkbenchService, IExtensionsViewlet, VIEWLET_ID, IExtension, IExtensionDependencies } from 'workbench/parts/extensions/common/extensions';
import { RatingsWidget, InstallCountWidget } from 'workbench/parts/extensions/browser/extensionsWidgets';
import { EditorOptions } from 'workbench/common/editor';
import { ActionBar } from 'base/browser/ui/actionbar/actionbar';
import { CombinedInstallAction, UpdateAction, EnableAction, DisableAction, ReloadAction, MaliciousStatusLabelAction, DisabledStatusLabelAction, IgnoreExtensionRecommendationAction, UndoIgnoreExtensionRecommendationAction } from 'workbench/parts/extensions/electron-browser/extensionsActions';
import { WebviewElement } from 'workbench/parts/webview/electron-browser/webviewElement';
...
import { ExtensionsTree, IExtensionData } from 'workbench/parts/extensions/browser/extensionsViewer';
import { ShowCurrentReleaseNotesAction } from 'workbench/parts/update/electron-browser/update';
