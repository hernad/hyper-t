...
import { append, $, addClass, removeClass, toggleClass } from 'base/browser/dom';
...
import { once, Emitter, Event } from 'base/common/event';
import { domEvent } from 'base/browser/event';
import { IExtension, IExtensionsWorkbenchService } from 'workbench/parts/extensions/common/extensions';
import { InstallAction, UpdateAction, ManageExtensionAction, ReloadAction, extensionButtonProminentBackground, extensionButtonProminentForeground, MaliciousStatusLabelAction, ExtensionActionItem } from 'workbench/parts/extensions/electron-browser/extensionsActions';
import { areSameExtensions } from 'platform/extensionManagement/common/extensionManagementUtil';
import { Label, RatingsWidget, InstallCountWidget } from 'workbench/parts/extensions/browser/extensionsWidgets';
import { IExtensionService } from 'workbench/services/extensions/common/extensions';
import { IExtensionTipsService, IExtensionManagementServerService } from 'platform/extensionManagement/common/extensionManagement';
