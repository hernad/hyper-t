...
import { Event, chain, anyEvent, debounceEvent } from 'base/common/event';
import { onUnexpectedError } from 'base/common/errors';
import { IDisposable, dispose } from 'base/common/lifecycle';
import { ITelemetryService } from 'platform/telemetry/common/telemetry';
import { IExtensionManagementService, ILocalExtension, IExtensionEnablementService, IExtensionTipsService, IExtensionIdentifier, EnablementState, InstallOperation } from 'platform/extensionManagement/common/extensionManagement';
...
import { areSameExtensions, adoptToGalleryExtensionId, getGalleryExtensionIdFromLocal } from 'platform/extensionManagement/common/extensionManagementUtil';
