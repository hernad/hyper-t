...
import 'css!./media/extensionsViewlet';
import { localize } from 'base/nls';
import { ThrottledDelayer, always, timeout } from 'base/common/async';
...
import { Event as EventOf, Emitter } from 'base/common/event';
...
import { append, $, addClass, toggleClass, Dimension } from 'base/browser/dom';
...
import { LocalExtensionType, IExtensionManagementService, IExtensionManagementServerService, IExtensionManagementServer, EnablementState } from 'platform/extensionManagement/common/extensionManagement';
...
import { OpenGlobalSettingsAction } from 'workbench/parts/preferences/browser/preferencesActions';
...
import { IActivityService, ProgressBadge, NumberBadge } from 'workbench/services/activity/common/activity';
import { IThemeService } from 'platform/theme/common/themeService';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { ViewsRegistry, IViewDescriptor } from 'workbench/common/views';
import { ViewContainerViewlet, IViewletViewOptions } from 'workbench/browser/parts/views/viewsViewlet';
...
import { getGalleryExtensionIdFromLocal, getMaliciousExtensionsSet } from 'platform/extensionManagement/common/extensionManagementUtil';
...
import { IAddedViewDescriptorRef } from 'workbench/browser/parts/views/views';
import { ViewletPanel } from 'workbench/browser/parts/views/panelViewlet';
...
import { SingleServerExtensionManagementServerService } from 'workbench/services/extensions/node/extensionManagementServerService';
import { Query } from 'workbench/parts/extensions/common/extensionQuery';
import { SuggestEnabledInput, attachSuggestEnabledInputBoxStyler } from 'workbench/parts/codeEditor/electron-browser/suggestEnabledInput';
import { alert } from 'base/browser/ui/aria/aria';
import { createErrorWithActions } from 'base/common/errorsWithActions';
