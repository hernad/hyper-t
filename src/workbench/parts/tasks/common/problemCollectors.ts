...
import { ILineMatcher, createLineMatcher, ProblemMatcher, ProblemMatch, ApplyToKind, WatchingPattern, getResource } from 'workbench/parts/tasks/common/problemMatcher';
...
export class WatchingProblemCollector extends AbstractProblemCollector implements IProblemMatcher {
	...
	// workaround for https://github.com/hernad/hyper-t/issues/44018
