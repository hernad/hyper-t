...
import 'css!./media/task.contribution';

import * as nls from 'base/nls';
import * as semver from 'semver';

import { QuickOpenHandler } from 'workbench/parts/tasks/browser/taskQuickOpen';
...
import { IDisposable, dispose, toDisposable, Disposable } from 'base/common/lifecycle';
...
import { ValidationStatus, ValidationState } from 'base/common/parsers';
import * as UUID from 'base/common/uuid';
import * as Platform from 'base/common/platform';
import { LinkedMap, Touch } from 'base/common/map';
import { OcticonLabel } from 'base/browser/ui/octiconLabel/octiconLabel';
...
import { ProblemMatcherRegistry, NamedProblemMatcher } from 'workbench/parts/tasks/common/problemMatcher';
import { IStorageService, StorageScope } from 'platform/storage/common/storage';
import { IProgressService2, IProgressOptions, ProgressLocation } from 'platform/progress/common/progress';

import { IOpenerService } from 'platform/opener/common/opener';
import { IWindowService } from 'platform/windows/common/windows';
import { INotificationService } from 'platform/notification/common/notification';
import { IDialogService, IConfirmationResult } from 'platform/dialogs/common/dialogs';
...
import { IStatusbarItem, IStatusbarRegistry, Extensions as StatusbarExtensions, StatusbarItemDescriptor } from 'workbench/browser/parts/statusbar/statusbar';
import { StatusbarAlignment } from 'platform/statusbar/common/statusbar';
import { IQuickOpenRegistry, Extensions as QuickOpenExtensions, QuickOpenHandlerDescriptor } from 'workbench/browser/quickopen';

import { IPanelService } from 'workbench/services/panel/common/panelService';
import Constants from 'workbench/parts/markers/electron-browser/constants';
...
import { IOutputService, IOutputChannelRegistry, Extensions as OutputExt, IOutputChannel } from 'workbench/parts/output/common/output';
import { Scope, IActionBarRegistry, Extensions as ActionBarExtensions } from 'workbench/browser/actions';

import { ITerminalService } from 'workbench/parts/terminal/common/terminal';

import { ITaskSystem, ITaskResolver, ITaskSummary, TaskExecuteKind, TaskError, TaskErrors, TaskTerminateResponse, TaskSystemInfo } from 'workbench/parts/tasks/common/taskSystem';
import {
...
} from 'workbench/parts/tasks/common/tasks';
import { ITaskService, ITaskProvider, RunOptions, CustomizationProperties, TaskFilter } from 'workbench/parts/tasks/common/taskService';
import { getTemplates as getTaskTemplates } from 'workbench/parts/tasks/common/taskTemplates';

import { KeyedTaskIdentifier as NKeyedTaskIdentifier, TaskDefinition } from 'workbench/parts/tasks/node/tasks';

import * as TaskConfig from '../node/taskConfiguration';
import { ProcessTaskSystem } from 'workbench/parts/tasks/node/processTaskSystem';
import { TerminalTaskSystem } from './terminalTaskSystem';
import { ProcessRunnerDetector } from 'workbench/parts/tasks/node/processRunnerDetector';
import { QuickOpenActionContributor } from '../browser/quickOpen';

import { Themable, STATUS_BAR_FOREGROUND, STATUS_BAR_NO_FOLDER_FOREGROUND } from 'workbench/common/theme';
import { IThemeService } from 'platform/theme/common/themeService';
import { IQuickInputService, IQuickPickItem, QuickPickInput } from 'platform/quickinput/common/quickInput';

import { TaskDefinitionRegistry } from 'workbench/parts/tasks/common/taskDefinitionRegistry';
