...
import * as Quickopen from 'workbench/browser/quickopen';
import * as QuickOpen from 'base/parts/quickopen/common/quickOpen';
import * as Model from 'base/parts/quickopen/browser/quickOpenModel';
import { IQuickOpenService } from 'platform/quickOpen/common/quickOpen';

import { Task, CustomTask, ContributedTask } from 'workbench/parts/tasks/common/tasks';
import { ITaskService, RunOptions } from 'workbench/parts/tasks/common/taskService';
import { ActionBarContributor, ContributableActionProvider } from 'workbench/browser/actions';
