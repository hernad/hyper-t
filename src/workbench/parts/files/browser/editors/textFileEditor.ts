...
import { VIEWLET_ID, IExplorerViewlet, TEXT_FILE_EDITOR_ID } from 'workbench/parts/files/common/files';
import { ITextFileEditorModel, ITextFileService } from 'workbench/services/textfile/common/textfiles';
import { BaseTextEditor, IEditorConfiguration } from 'workbench/browser/parts/editor/textEditor';
import { EditorOptions, TextEditorOptions } from 'workbench/common/editor';
import { BinaryEditorModel } from 'workbench/common/editor/binaryEditorModel';
...
import { FileOperationError, FileOperationResult, FileChangesEvent, IFileService, FALLBACK_MAX_MEMORY_SIZE_MB, MIN_MAX_MEMORY_SIZE_MB } from 'platform/files/common/files';
