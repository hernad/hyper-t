...
import { toResource, SideBySideEditorInput, IWorkbenchEditorConfiguration } from 'workbench/common/editor';
import { ITextFileService, ITextFileEditorModel } from 'workbench/services/textfile/common/textfiles';
import { FileOperationEvent, FileOperation, IFileService, FileChangeType, FileChangesEvent } from 'platform/files/common/files';
