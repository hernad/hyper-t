...
import { ViewletRegistry, Extensions as ViewletExtensions, ViewletDescriptor, ShowViewletAction } from 'workbench/browser/viewlet';
...
import { IEditorInputFactory, EditorInput, IFileEditorInput, IEditorInputFactoryRegistry, Extensions as EditorInputExtensions } from 'workbench/common/editor';
import { AutoSaveConfiguration, HotExitConfiguration, SUPPORTED_ENCODINGS } from 'platform/files/common/files';
import { VIEWLET_ID, SortOrderConfiguration, FILE_EDITOR_INPUT_ID } from 'workbench/parts/files/common/files';
import { FileEditorTracker } from 'workbench/parts/files/browser/editors/fileEditorTracker';
import { SaveErrorHandler } from 'workbench/parts/files/electron-browser/saveErrorHandler';
import { FileEditorInput } from 'workbench/parts/files/common/editors/fileEditorInput';
import { TextFileEditor } from 'workbench/parts/files/browser/editors/textFileEditor';
import { BinaryFileEditor } from 'workbench/parts/files/browser/editors/binaryFileEditor';
...
import { DirtyFilesTracker } from 'workbench/parts/files/common/dirtyFilesTracker';
import { ExplorerViewlet, ExplorerViewletViewsContribution } from 'workbench/parts/files/electron-browser/explorerViewlet';
import { IEditorRegistry, EditorDescriptor, Extensions as EditorExtensions } from 'workbench/browser/editor';
import { DataUriEditorInput } from 'workbench/common/editor/dataUriEditorInput';
...
configurationRegistry.registerConfiguration({
	...
	'properties': {
		...
		'files.watcherExclude': {
			'type': 'object',
			'default': platform.isWindows /* https://github.com/hernad/hyper-t/issues/23954 */ ? { '**/.git/objects/**': true, '**/.git/subtree-cache/**': true, '**/node_modules/*/**': true } : { '**/.git/objects/**': true, '**/.git/subtree-cache/**': true, '**/node_modules/**': true },
