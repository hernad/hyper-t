...
import { toResource, IEditorCommandsContext } from 'workbench/common/editor';
...
import { ExplorerFocusCondition, FileOnDiskContentProvider, VIEWLET_ID } from 'workbench/parts/files/common/files';
...
import { ITextFileService, ISaveOptions } from 'workbench/services/textfile/common/textfiles';
...
import { IEditorViewState } from 'editor/common/editorCommon';
...
import { getResourceForCommand, getMultiSelectedResources } from 'workbench/parts/files/browser/files';
import { IWorkspaceEditingService } from 'workbench/services/workspace/common/workspaceEditing';
import { getMultiSelectedEditorContexts } from 'workbench/browser/parts/editor/editorCommands';
