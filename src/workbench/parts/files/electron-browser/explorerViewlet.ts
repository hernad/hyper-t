...
import 'css!./media/explorerviewlet';
import { localize } from 'base/nls';
import { IActionRunner } from 'base/common/actions';
import * as DOM from 'base/browser/dom';
import { VIEWLET_ID, ExplorerViewletVisibleContext, IFilesConfiguration, OpenEditorsVisibleContext, OpenEditorsVisibleCondition, IExplorerViewlet, VIEW_CONTAINER } from 'workbench/parts/files/common/files';
...
import { ActionRunner, FileViewletState } from 'workbench/parts/files/electron-browser/views/explorerViewer';
import { ExplorerView, IExplorerViewOptions } from 'workbench/parts/files/electron-browser/views/explorerView';
import { EmptyView } from 'workbench/parts/files/electron-browser/views/emptyView';
import { OpenEditorsView } from 'workbench/parts/files/electron-browser/views/openEditorsView';
...
import { DelegatingEditorService } from 'workbench/services/editor/browser/editorService';
