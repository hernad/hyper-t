...
import { IEditorGroupsService, IEditorGroup, GroupChangeKind, GroupsOrder } from 'workbench/services/group/common/editorGroupsService';
...
import { SaveAllAction, SaveAllInGroupAction, CloseGroupAction } from 'workbench/parts/files/electron-browser/fileActions';
import { OpenEditorsFocusedContext, ExplorerFocusedContext, IFilesConfiguration } from 'workbench/parts/files/common/files';
import { ITextFileService, AutoSaveMode } from 'workbench/services/textfile/common/textfiles';
import { OpenEditor } from 'workbench/parts/files/common/explorerModel';
import { IUntitledEditorService } from 'workbench/services/untitled/common/untitledEditorService';
import { CloseAllEditorsAction, CloseEditorAction } from 'workbench/browser/parts/editor/editorActions';
import { ToggleEditorLayoutAction } from 'workbench/browser/actions/toggleEditorLayout';
...
import { IListVirtualDelegate, IListRenderer, IListContextMenuEvent } from 'base/browser/ui/list/list';
import { EditorLabel } from 'workbench/browser/labels';
...
import { DirtyEditorContext, OpenEditorsGroupContext } from 'workbench/parts/files/electron-browser/fileCommands';
import { ResourceContextKey } from 'workbench/common/resources';
import { fillResourceDataTransfers, ResourcesDropHandler, LocalSelectionTransfer, CodeDataTransfers } from 'workbench/browser/dnd';
