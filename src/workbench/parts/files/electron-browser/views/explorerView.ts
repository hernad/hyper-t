...
import { IFilesConfiguration, ExplorerFolderContext, FilesExplorerFocusedContext, ExplorerFocusedContext, SortOrderConfiguration, SortOrder, IExplorerView, ExplorerRootContext, ExplorerResourceReadonlyContext } from 'workbench/parts/files/common/files';
import { FileOperation, FileOperationEvent, IResolveFileOptions, FileChangeType, FileChangesEvent, IFileService, FILES_EXCLUDE_CONFIG, IFileStat } from 'platform/files/common/files';
import { RefreshViewExplorerAction, NewFolderAction, NewFileAction } from 'workbench/parts/files/electron-browser/fileActions';
import { FileDragAndDrop, FileFilter, FileSorter, FileController, FileRenderer, FileDataSource, FileViewletState, FileAccessibilityProvider } from 'workbench/parts/files/electron-browser/views/explorerViewer';
...
import { TreeViewsViewletPanel, FileIconThemableWorkbenchTree, IViewletViewOptions } from 'workbench/browser/parts/views/viewsViewlet';
import { ExplorerItem, Model } from 'workbench/parts/files/common/explorerModel';
import { IPartService } from 'workbench/services/part/common/partService';
import { ExplorerDecorationsProvider } from 'workbench/parts/files/electron-browser/views/explorerDecorationsProvider';
...
import { ResourceGlobMatcher } from 'workbench/electron-browser/resources';
...
import { IViewletPanelOptions } from 'workbench/browser/parts/views/panelViewlet';
