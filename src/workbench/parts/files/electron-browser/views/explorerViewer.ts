...
import { IAction, ActionRunner as BaseActionRunner, IActionRunner } from 'base/common/actions';
...
import { FileLabel, IFileLabelOptions } from 'workbench/browser/labels';
import { IDisposable, dispose, Disposable } from 'base/common/lifecycle';
import { IFilesConfiguration, SortOrder } from 'workbench/parts/files/common/files';
import { ITextFileService } from 'workbench/services/textfile/common/textfiles';
import { FileOperationError, FileOperationResult, IFileService, FileKind } from 'platform/files/common/files';
import { DuplicateFileAction, AddFilesAction, IEditableData, IFileViewletState, FileCopiedContext } from 'workbench/parts/files/electron-browser/fileActions';
import { IDataSource, ITree, IAccessibilityProvider, IRenderer, ContextMenuEvent, ISorter, IFilter, IDragAndDropData, IDragOverReaction, DRAG_OVER_ACCEPT_BUBBLE_DOWN, DRAG_OVER_ACCEPT_BUBBLE_DOWN_COPY, DRAG_OVER_ACCEPT_BUBBLE_UP, DRAG_OVER_ACCEPT_BUBBLE_UP_COPY, DRAG_OVER_REJECT } from 'base/parts/tree/browser/tree';
...
import { ExplorerItem, NewStatPlaceholder, Model } from 'workbench/parts/files/common/explorerModel';
import { DragMouseEvent, IMouseEvent } from 'base/browser/mouseEvent';
...
import { IMenuService, IMenu, MenuId } from 'platform/actions/common/actions';
...
import { extractResources, SimpleFileResourceDragAndDrop, CodeDataTransfers, fillResourceDataTransfers } from 'workbench/browser/dnd';
