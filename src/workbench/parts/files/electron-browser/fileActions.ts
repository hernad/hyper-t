...
import { sequence, ITask, always } from 'base/common/async';
...
import { MessageType, IInputValidator } from 'base/browser/ui/inputbox/inputBox';
import { ITree, IHighlightEvent } from 'base/parts/tree/browser/tree';
import { dispose, IDisposable } from 'base/common/lifecycle';
import { VIEWLET_ID } from 'workbench/parts/files/common/files';
import { ITextFileService, ITextFileOperationResult } from 'workbench/services/textfile/common/textfiles';
import { IFileService, IFileStat, AutoSaveConfiguration } from 'platform/files/common/files';
import { toResource, IUntitledResourceInput } from 'workbench/common/editor';
import { ExplorerItem, Model, NewStatPlaceholder } from 'workbench/parts/files/common/explorerModel';
import { ExplorerView } from 'workbench/parts/files/electron-browser/views/explorerView';
import { ExplorerViewlet } from 'workbench/parts/files/electron-browser/explorerViewlet';
import { IUntitledEditorService } from 'workbench/services/untitled/common/untitledEditorService';
import { CollapseAction } from 'workbench/browser/viewlet';
...
import { IInstantiationService, ServicesAccessor, IConstructorSignature2 } from 'platform/instantiation/common/instantiation';
import { ITextModel } from 'editor/common/model';
import { IWindowService } from 'platform/windows/common/windows';
import { REVEAL_IN_EXPLORER_COMMAND_ID, SAVE_ALL_COMMAND_ID, SAVE_ALL_LABEL, SAVE_ALL_IN_GROUP_COMMAND_ID } from 'workbench/parts/files/electron-browser/fileCommands';
...
import { IListService, ListWidget } from 'platform/list/browser/listService';
import { RawContextKey, IContextKeyService } from 'platform/contextkey/common/contextkey';
import { Schemas } from 'base/common/network';
import { IDialogService, IConfirmationResult, IConfirmation, getConfirmMessage } from 'platform/dialogs/common/dialogs';
...
import { Constants } from 'editor/common/core/uint';
import { CLOSE_EDITORS_AND_GROUP_COMMAND_ID } from 'workbench/browser/parts/editor/editorCommands';
