...
import { ITextFileService, ISaveErrorHandler, ITextFileEditorModel } from 'workbench/services/textfile/common/textfiles';
...
import { FileOnDiskContentProvider } from 'workbench/parts/files/common/files';
...
import { SAVE_FILE_COMMAND_ID, REVERT_FILE_COMMAND_ID, SAVE_FILE_AS_COMMAND_ID, SAVE_FILE_AS_LABEL } from 'workbench/parts/files/electron-browser/fileCommands';
