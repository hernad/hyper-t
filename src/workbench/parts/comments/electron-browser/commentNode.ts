...
import { inputValidationErrorBorder } from 'platform/theme/common/colorRegistry';
...
import { SimpleCommentEditor } from 'workbench/parts/comments/electron-browser/simpleCommentEditor';
