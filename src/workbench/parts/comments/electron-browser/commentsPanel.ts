...
import 'css!./media/panel';
import * as dom from 'base/browser/dom';
import { IAction } from 'base/common/actions';
import { debounceEvent } from 'base/common/event';
import { CollapseAllAction, DefaultAccessibilityProvider, DefaultController, DefaultDragAndDrop } from 'base/parts/tree/browser/treeDefaults';
...
import { CommentNode, CommentsModel, ResourceWithCommentThreads, ICommentThreadChangedEvent } from 'workbench/parts/comments/common/commentModel';
import { ReviewController } from 'workbench/parts/comments/electron-browser/commentsEditorContribution';
import { CommentsDataFilter, CommentsDataSource, CommentsModelRenderer } from 'workbench/parts/comments/electron-browser/commentsTreeViewer';
import { ICommentService, IWorkspaceCommentThreadsEvent } from 'workbench/parts/comments/electron-browser/commentService';
import { IEditorService, ACTIVE_GROUP, SIDE_GROUP } from 'workbench/services/editor/common/editorService';
import { ICommandService } from 'platform/commands/common/commands';
import { textLinkForeground, textLinkActiveForeground, focusBorder } from 'platform/theme/common/colorRegistry';
