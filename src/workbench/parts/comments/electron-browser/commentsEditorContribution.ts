...
import { ICodeEditor, IEditorMouseEvent, IViewZone, MouseTargetType } from 'editor/browser/editorBrowser';
import { registerEditorContribution, EditorAction, registerEditorAction } from 'editor/browser/editorExtensions';
import { ICodeEditorService } from 'editor/browser/services/codeEditorService';
import { EmbeddedCodeEditorWidget } from 'editor/browser/widget/embeddedCodeEditorWidget';
import { IEditorContribution, IModelChangedEvent } from 'editor/common/editorCommon';
import { IRange } from 'editor/common/core/range';
import * as modes from 'editor/common/modes';
import { peekViewResultsBackground, peekViewResultsSelectionBackground, peekViewTitleBackground } from 'editor/contrib/referenceSearch/referencesWidget';
...
import { editorForeground, registerColor } from 'platform/theme/common/colorRegistry';
import { IThemeService, registerThemingParticipant } from 'platform/theme/common/themeService';
import { CommentThreadCollapsibleState } from 'workbench/api/node/extHostTypes';
import { ReviewZoneWidget, COMMENTEDITOR_DECORATION_KEY } from 'workbench/parts/comments/electron-browser/commentThreadWidget';
import { ICommentService, ICommentInfo } from 'workbench/parts/comments/electron-browser/commentService';
...
import { IModelDecorationOptions } from 'editor/common/model';
