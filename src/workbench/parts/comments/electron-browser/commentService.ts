...
import { CommentThread, DocumentCommentProvider, CommentThreadChangedEvent, CommentInfo, Comment } from 'editor/common/modes';
...
import { ExtensionCommentProviderHandler } from 'workbench/api/electron-browser/mainThreadComments';
import { assign } from 'base/common/objects';
import { ICommentThreadChangedEvent } from 'workbench/parts/comments/common/commentModel';
