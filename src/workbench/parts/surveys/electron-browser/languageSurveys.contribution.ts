...
import { IWorkbenchContributionsRegistry, IWorkbenchContribution, Extensions as WorkbenchExtensions } from 'workbench/common/contributions';
...
import product, { ISurveyData } from 'platform/node/product';
