...
import { WelcomePageContribution, WelcomePageAction, WelcomeInputFactory } from 'workbench/parts/welcome/page/electron-browser/welcomePage';
...
import { IEditorInputFactoryRegistry, Extensions as EditorExtensions } from 'workbench/common/editor';
