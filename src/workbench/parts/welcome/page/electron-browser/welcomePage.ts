...
import 'css!./welcomePage';
import { URI } from 'base/common/uri';
import * as path from 'path';
import { readdir } from 'base/node/extfs';
...
import { onUnexpectedError, isPromiseCanceledError } from 'base/common/errors';
...
import { getInstalledExtensions, IExtensionStatus, onExtensionChanged, isKeymapExtension } from 'workbench/parts/extensions/electron-browser/extensionsUtils';
import { IExtensionEnablementService, IExtensionManagementService, IExtensionGalleryService, IExtensionTipsService, EnablementState, LocalExtensionType } from 'platform/extensionManagement/common/extensionManagement';
import { used } from 'workbench/parts/welcome/page/electron-browser/vs_code_welcome_page';
import { ILifecycleService, StartupKind } from 'platform/lifecycle/common/lifecycle';
import { IDisposable, dispose } from 'base/common/lifecycle';
import { tildify, getBaseLabel } from 'base/common/labels';
import { registerThemingParticipant } from 'platform/theme/common/themeService';
import { registerColor, focusBorder, textLinkForeground, textLinkActiveForeground, foreground, descriptionForeground, contrastBorder, activeContrastBorder } from 'platform/theme/common/colorRegistry';
import { getExtraColor } from 'workbench/parts/welcome/walkThrough/node/walkThroughUtils';
import { IExtensionsWorkbenchService } from 'workbench/parts/extensions/common/extensions';
import { IWorkspaceIdentifier, ISingleFolderWorkspaceIdentifier, isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier } from 'platform/workspaces/common/workspaces';
import { IEditorInputFactory, EditorInput } from 'workbench/common/editor';
import { getIdAndVersionFromLocalExtensionId } from 'platform/extensionManagement/node/extensionManagementUtil';
	...
	constructor(
		...
		const resource = URI.parse(require.toUrl('./vs_code_welcome_page'))
			.with({
				...
				query: JSON.stringify({ moduleId: 'workbench/parts/welcome/page/electron-browser/vs_code_welcome_page' })
			});
