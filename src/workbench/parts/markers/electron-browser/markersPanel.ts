...
import 'css!./media/markers';

import { URI } from 'base/common/uri';
import * as dom from 'base/browser/dom';
import { IAction, IActionItem, Action } from 'base/common/actions';
import { ITelemetryService } from 'platform/telemetry/common/telemetry';
import { Panel } from 'workbench/browser/panel';
import { IEditorService, SIDE_GROUP, ACTIVE_GROUP } from 'workbench/services/editor/common/editorService';
import Constants from 'workbench/parts/markers/electron-browser/constants';
import { Marker, ResourceMarkers, RelatedInformation, MarkersModel } from 'workbench/parts/markers/electron-browser/markersModel';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { MarkersFilterActionItem, MarkersFilterAction, QuickFixAction, QuickFixActionItem, IMarkersFilterActionChangeEvent, IMarkerFilterController } from 'workbench/parts/markers/electron-browser/markersPanelActions';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import Messages from 'workbench/parts/markers/electron-browser/messages';
import { RangeHighlightDecorations } from 'workbench/browser/parts/editor/rangeDecorations';
import { IThemeService } from 'platform/theme/common/themeService';
import { ICodeEditor } from 'editor/browser/editorBrowser';
import { IMarkersWorkbenchService } from 'workbench/parts/markers/electron-browser/markers';
...
import { ITreeElement, ITreeNode } from 'base/browser/ui/tree/tree';
import { debounceEvent, Relay, Event, Emitter } from 'base/common/event';
import { WorkbenchObjectTree, ObjectTreeResourceNavigator } from 'platform/list/browser/listService';
import { FilterOptions } from 'workbench/parts/markers/electron-browser/markersFilterOptions';
import { IExpression, getEmptyExpression } from 'base/common/glob';
...
import { isAbsolute, join } from 'base/common/paths';
import { ITreeContextMenuEvent } from 'base/browser/ui/tree/abstractTree';
import { FilterData, FileResourceMarkersRenderer, Filter, VirtualDelegate, ResourceMarkersRenderer, MarkerRenderer, RelatedInformationRenderer, TreeElement, MarkersTreeAccessibilityProvider } from 'workbench/parts/markers/electron-browser/markersTreeViewer';
import { IContextMenuService } from 'platform/contextview/browser/contextView';
import { Separator, ActionItem } from 'base/browser/ui/actionbar/actionbar';
