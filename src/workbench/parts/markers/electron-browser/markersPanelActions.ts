...
import { Action, IAction, IActionChangeEvent } from 'base/common/actions';
...
import { TogglePanelAction } from 'workbench/browser/panel';
...
import { attachInputBoxStyler, attachStylerCallback, attachCheckboxStyler } from 'platform/theme/common/styler';
...
import { BaseActionItem, ActionItem } from 'base/browser/ui/actionbar/actionbar';
import { badgeBackground, contrastBorder } from 'platform/theme/common/colorRegistry';
...
import { Marker } from 'workbench/parts/markers/electron-browser/markersModel';
...
import { IEditorService, ACTIVE_GROUP } from 'workbench/services/editor/common/editorService';
...
import { CodeAction } from 'editor/common/modes';
