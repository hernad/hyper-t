...
import { ILifecycleService, LifecyclePhase, StartupKind } from 'platform/lifecycle/common/lifecycle';
...
import { Extensions, IWorkbenchContribution, IWorkbenchContributionsRegistry } from 'workbench/common/contributions';
import * as files from 'workbench/parts/files/common/files';
...
import { ITimerService, didUseCachedData } from 'workbench/services/timer/electron-browser/timerService';
...
import { timeout, nfcall } from 'base/common/async';
