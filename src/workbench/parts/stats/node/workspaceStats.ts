...
import { IFileService, IFileStat, IResolveFileResult } from 'platform/files/common/files';
...
import { IWindowConfiguration, IWindowService } from 'platform/windows/common/windows';
