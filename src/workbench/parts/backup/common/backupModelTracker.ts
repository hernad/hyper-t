...
import { ITextFileService, TextFileModelChangeEvent, StateChange } from 'workbench/services/textfile/common/textfiles';
...
import { IFilesConfiguration, AutoSaveConfiguration, CONTENT_CHANGE_EVENT_BUFFER_DELAY } from 'platform/files/common/files';
