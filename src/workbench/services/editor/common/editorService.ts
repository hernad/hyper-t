...
import { createDecorator, ServiceIdentifier, ServicesAccessor } from 'platform/instantiation/common/instantiation';
import { IResourceInput, IEditorOptions, ITextEditorOptions } from 'platform/editor/common/editor';
import { IEditorInput, IEditor, GroupIdentifier, IEditorInputWithOptions, IUntitledResourceInput, IResourceDiffInput, IResourceSideBySideInput, ITextEditor, ITextDiffEditor, ITextSideBySideEditor } from 'workbench/common/editor';
import { Event } from 'base/common/event';
import { IEditor as ICodeEditor } from 'editor/common/editorCommon';
import { IEditorGroup, IEditorReplacement } from 'workbench/services/group/common/editorGroupsService';
