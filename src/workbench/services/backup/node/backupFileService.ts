...
import { IBackupFileService, BACKUP_FILE_UPDATE_OPTIONS, BACKUP_FILE_RESOLVE_OPTIONS } from 'workbench/services/backup/common/backup';
import { IFileService, ITextSnapshot } from 'platform/files/common/files';
import { TPromise } from 'base/common/winjs.base';
import { readToMatchingString } from 'base/node/stream';
import { ITextBufferFactory } from 'editor/common/model';
import { createTextBufferFactoryFromStream, createTextBufferFactoryFromSnapshot } from 'editor/common/model/textModel';
