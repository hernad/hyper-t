...
import { realpathSync } from 'base/node/extfs';
import { IExtensionDescription, IExtensionHostProfile, IExtensionService, ProfileSegmentId, ProfileSession } from 'workbench/services/extensions/common/extensions';
