...
import { Emitter, Event, anyEvent, debounceEvent, fromNodeEventEmitter, mapEvent } from 'base/common/event';
...
import { IRemoteConsoleLog, log, parse } from 'base/node/console';
import { findFreePort, randomPort } from 'base/node/ports';
import { IMessagePassingProtocol } from 'base/parts/ipc/node/ipc';
import { Protocol, generateRandomPipeName } from 'base/parts/ipc/node/ipc.net';
import { IBroadcast, IBroadcastService } from 'platform/broadcast/electron-browser/broadcastService';
import { getScopes } from 'platform/configuration/common/configurationRegistry';
import { IEnvironmentService } from 'platform/environment/common/environment';
import { EXTENSION_ATTACH_BROADCAST_CHANNEL, EXTENSION_CLOSE_EXTHOST_BROADCAST_CHANNEL, EXTENSION_LOG_BROADCAST_CHANNEL, EXTENSION_RELOAD_BROADCAST_CHANNEL, EXTENSION_TERMINATE_BROADCAST_CHANNEL } from 'platform/extensions/common/extensionHost';
import { ILabelService } from 'platform/label/common/label';
import { ILifecycleService, WillShutdownEvent } from 'platform/lifecycle/common/lifecycle';
...
import { IConfigurationInitData, IInitData } from 'workbench/api/node/extHost.protocol';
import { MessageType, createMessageOfType, isMessageOfType } from 'workbench/common/extensionHostProtocol';
import { IWorkspaceConfigurationService } from 'workbench/services/configuration/common/configuration';
import { ICrashReporterService } from 'workbench/services/crashReporter/electron-browser/crashReporterService';
...
export class ExtensionHostProcessWorker implements IExtensionHostStarter {
	...
	constructor(
		...
		this._toDispose.push(toDisposable(() => {
			// hernad izgleda ovo ne treba vise
