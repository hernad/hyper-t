...
import { getPathFromAmdModule } from 'base/common/amd';
import { isNonEmptyArray } from 'base/common/arrays';
import { Barrier, runWhenIdle } from 'base/common/async';
...
import { fsPath, isEqualOrParent } from 'base/common/resources';
import * as strings from 'base/common/strings';
import { URI } from 'base/common/uri';
import * as pfs from 'base/node/pfs';
import { IMessagePassingProtocol } from 'base/parts/ipc/node/ipc';
import { IEnvironmentService } from 'platform/environment/common/environment';
import { EnablementState, IExtensionEnablementService, IExtensionIdentifier, IExtensionManagementService, LocalExtensionType } from 'platform/extensionManagement/common/extensionManagement';
import { BetterMergeDisabledNowKey, BetterMergeId, areSameExtensions, getGalleryExtensionIdFromLocal } from 'platform/extensionManagement/common/extensionManagementUtil';
import { BUILTIN_MANIFEST_CACHE_FILE, MANIFEST_CACHE_FOLDER, USER_MANIFEST_CACHE_FILE } from 'platform/extensions/common/extensions';
...
import { ExtHostCustomersRegistry } from 'workbench/api/electron-browser/extHostCustomers';
import { ExtHostContext, ExtHostExtensionServiceShape, IExtHostContext, MainContext } from 'workbench/api/node/extHost.protocol';
import { ActivationTimes, ExtensionPointContribution, IExtensionDescription, IExtensionService, IExtensionsStatus, IMessage, ProfileSession, IWillActivateEvent, IResponsiveStateChangeEvent } from 'workbench/services/extensions/common/extensions';
import { ExtensionMessageCollector, ExtensionPoint, ExtensionsRegistry, IExtensionPoint, IExtensionPointUser, schema } from 'workbench/services/extensions/common/extensionsRegistry';
import { ExtensionHostProcessWorker, IExtensionHostStarter } from 'workbench/services/extensions/electron-browser/extensionHost';
import { ExtensionHostProfiler } from 'workbench/services/extensions/electron-browser/extensionHostProfiler';
import { ExtensionDescriptionRegistry } from 'workbench/services/extensions/node/extensionDescriptionRegistry';
import { ExtensionScanner, ExtensionScannerInput, IExtensionReference, IExtensionResolver, ILog, IRelaxedExtensionDescription, Translations } from 'workbench/services/extensions/node/extensionPoints';
import { ProxyIdentifier } from 'workbench/services/extensions/node/proxyIdentifier';
import { IRPCProtocolLogger, RPCProtocol, RequestInitiator, ResponsiveState } from 'workbench/services/extensions/node/rpcProtocol';
