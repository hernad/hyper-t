...
import { ITextEditorOptions, IResourceInput, ITextEditorSelection } from 'platform/editor/common/editor';
import { IEditorInput, IEditor as IBaseEditor, Extensions as EditorExtensions, EditorInput, IEditorCloseEvent, IEditorInputFactoryRegistry, toResource, Extensions as EditorInputExtensions, IFileInputFactory, IEditorIdentifier } from 'workbench/common/editor';
...
import { FileChangesEvent, IFileService, FileChangeType, FILES_EXCLUDE_CONFIG } from 'platform/files/common/files';
...
import { getExcludes, ISearchConfiguration } from 'platform/search/common/search';
