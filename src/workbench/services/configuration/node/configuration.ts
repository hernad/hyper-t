...
import { RunOnceScheduler, Delayer } from 'base/common/async';
import { FileChangeType, FileChangesEvent, IContent, IFileService } from 'platform/files/common/files';
import { isLinux } from 'base/common/platform';
import { ConfigWatcher } from 'base/node/config';
import { ConfigurationModel } from 'platform/configuration/common/configurationModels';
import { WorkspaceConfigurationModelParser, FolderSettingsModelParser, StandaloneConfigurationModelParser } from 'workbench/services/configuration/common/configurationModels';
import { FOLDER_SETTINGS_PATH, TASKS_CONFIGURATION_KEY, FOLDER_SETTINGS_NAME, LAUNCH_CONFIGURATION_KEY } from 'workbench/services/configuration/common/configuration';
import { IStoredWorkspace, IStoredWorkspaceFolder } from 'platform/workspaces/common/workspaces';
...
import { WorkbenchState, IWorkspaceFolder } from 'platform/workspace/common/workspace';
...
import { IConfigurationModel } from 'platform/configuration/common/configuration';
