...
import { writeFile } from 'base/node/pfs';
import { IJSONContributionRegistry, Extensions as JSONExtensions } from 'platform/jsonschemas/common/jsonContributionRegistry';
import { IWorkspaceContextService, Workspace, WorkbenchState, IWorkspaceFolder, toWorkspaceFolders, IWorkspaceFoldersChangeEvent, WorkspaceFolder } from 'platform/workspace/common/workspace';
...
import { ConfigurationChangeEvent, ConfigurationModel, DefaultConfigurationModel } from 'platform/configuration/common/configurationModels';
import { IConfigurationChangeEvent, ConfigurationTarget, IConfigurationOverrides, keyFromOverrideIdentifier, isConfigurationOverrides, IConfigurationData } from 'platform/configuration/common/configuration';
import { Configuration, WorkspaceConfigurationChangeEvent, AllKeysConfigurationChangeEvent } from 'workbench/services/configuration/common/configurationModels';
import { IWorkspaceConfigurationService, FOLDER_CONFIG_FOLDER_NAME, defaultSettingsSchemaId, userSettingsSchemaId, workspaceSettingsSchemaId, folderSettingsSchemaId } from 'workbench/services/configuration/common/configuration';
import { Registry } from 'platform/registry/common/platform';
import { IConfigurationNode, IConfigurationRegistry, Extensions, IConfigurationPropertySchema, allSettings, windowSettings, resourceSettings, applicationSettings } from 'platform/configuration/common/configurationRegistry';
import { IWorkspaceIdentifier, isWorkspaceIdentifier, IStoredWorkspaceFolder, isStoredWorkspaceFolder, IWorkspaceFolderCreationData, ISingleFolderWorkspaceIdentifier, isSingleFolderWorkspaceIdentifier } from 'platform/workspaces/common/workspaces';
...
import { ConfigurationEditingService } from 'workbench/services/configuration/node/configurationEditingService';
import { WorkspaceConfiguration, FolderConfiguration } from 'workbench/services/configuration/node/configuration';
import { JSONEditingService } from 'workbench/services/configuration/node/jsonEditingService';
import { Schemas } from 'base/common/network';
import { massageFolderPathForWorkspace } from 'platform/workspaces/node/workspaces';
