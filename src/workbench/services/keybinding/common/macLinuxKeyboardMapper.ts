...
import { KeyCode, KeyCodeUtils, Keybinding, KeybindingType, ResolvedKeybinding, ResolvedKeybindingPart, SimpleKeybinding } from 'base/common/keyCodes';
...
import { IMMUTABLE_CODE_TO_KEY_CODE, IMMUTABLE_KEY_CODE_TO_CODE, ScanCode, ScanCodeBinding, ScanCodeUtils } from 'base/common/scanCode';
import { IKeyboardEvent } from 'platform/keybinding/common/keybinding';
import { IKeyboardMapper } from 'workbench/services/keybinding/common/keyboardMapper';
...
export class MacLinuxKeyboardMapper implements IKeyboardMapper {
	...
	public resolveKeyboardEvent(keyboardEvent: IKeyboardEvent): NativeResolvedKeybinding {
		...
		if (
			...
			// where the scan codes appear to be incorrect (see https://github.com/hernad/hyper-t/issues/24107)
