...
import { IPatternInfo, ITextSearchPreviewOptions } from 'platform/search/common/search';
import { SearchWorker } from './searchWorker';
import { Event } from 'base/common/event';
import { ISerializedFileMatch } from 'workbench/services/search/node/search';
