...
import { bomLength, decode, detectEncodingFromBuffer, encodingExists, UTF16be, UTF16le, UTF8, UTF8_with_bom } from 'base/node/encoding';
import { Range } from 'editor/common/core/range';
import { ITextSearchPreviewOptions, TextSearchMatch } from 'platform/search/common/search';
import { ISearchWorker, ISearchWorkerSearchArgs, ISearchWorkerSearchResult } from './searchWorkerIpc';
import { FileMatch } from 'workbench/services/search/node/search';
