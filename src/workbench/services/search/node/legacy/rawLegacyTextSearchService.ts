...
import { ITextQuery, QueryType } from 'platform/search/common/search';
import { FileWalker } from 'workbench/services/search/node/fileSearch';
import { Engine } from 'workbench/services/search/node/legacy/textSearch';
import { TextSearchWorkerProvider } from 'workbench/services/search/node/legacy/textSearchWorkerProvider';
import { BatchedCollector } from 'workbench/services/search/node/textSearchManager';
