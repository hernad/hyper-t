...
import * as normalization from 'base/common/normalization';
...
import { IFileQuery, IFolderQuery, IProgress, ISearchEngineStats } from 'platform/search/common/search';
import { IRawFileMatch, ISearchEngine, ISearchEngineSuccess } from 'workbench/services/search/node/search';
