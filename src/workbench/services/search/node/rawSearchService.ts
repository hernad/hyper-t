...
import { compareItemsByScore, IItemAccessor, prepareQuery, ScorerCache } from 'base/parts/quickopen/common/quickOpenScorer';
import { MAX_FILE_SIZE } from 'platform/files/node/files';
import { ICachedSearchStats, IFileQuery, IFileSearchStats, IFolderQuery, IProgress, IRawFileQuery, IRawQuery, IRawTextQuery, ITextQuery } from 'platform/search/common/search';
import { Engine as FileSearchEngine } from 'workbench/services/search/node/fileSearch';
import { LegacyTextSearchService } from 'workbench/services/search/node/legacy/rawLegacyTextSearchService';
import { TextSearchEngineAdapter } from 'workbench/services/search/node/textSearchAdapter';
