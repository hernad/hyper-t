...
import { ITokenColorizationRule, IColorMap } from 'workbench/services/themes/common/workbenchThemeService';
import { Color } from 'base/common/color';
import * as colorRegistry from 'platform/theme/common/colorRegistry';

import * as editorColorRegistry from 'editor/common/view/editorColorRegistry';
import * as wordHighlighter from 'editor/contrib/wordHighlighter/wordHighlighter';
import { peekViewEditorMatchHighlight, peekViewResultsMatchHighlight } from 'editor/contrib/referenceSearch/referencesWidget';
