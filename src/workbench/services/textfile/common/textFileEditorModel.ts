...
import { TPromise, TValueCallback, ErrorCallback } from 'base/common/winjs.base';
...
import { ITextFileService, IAutoSaveConfiguration, ModelState, ITextFileEditorModel, ISaveOptions, ISaveErrorHandler, ISaveParticipant, StateChange, SaveReason, IRawTextContent, ILoadOptions, LoadReason } from 'workbench/services/textfile/common/textfiles';
import { EncodingMode } from 'workbench/common/editor';
...
import { IFileService, IFileStat, FileOperationError, FileOperationResult, CONTENT_CHANGE_EVENT_BUFFER_DELAY, FileChangesEvent, FileChangeType } from 'platform/files/common/files';
