...
import { IResult, ITextFileOperationResult, ITextFileService, IRawTextContent, IAutoSaveConfiguration, AutoSaveMode, SaveReason, ITextFileEditorModelManager, ITextFileEditorModel, ModelState, ISaveOptions, AutoSaveContext, IWillMoveEvent } from 'workbench/services/textfile/common/textfiles';
import { ConfirmResult, IRevertOptions } from 'workbench/common/editor';
import { ILifecycleService, ShutdownReason } from 'platform/lifecycle/common/lifecycle';
import { IWorkspaceContextService, WorkbenchState } from 'platform/workspace/common/workspace';
import { IFileService, IResolveContentOptions, IFilesConfiguration, FileOperationError, FileOperationResult, AutoSaveConfiguration, HotExitConfiguration } from 'platform/files/common/files';
...
import { UntitledEditorModel } from 'workbench/common/editor/untitledEditorModel';
import { TextFileEditorModelManager } from 'workbench/services/textfile/common/textFileEditorModelManager';
...
import { isEqualOrParent, isEqual, joinPath, dirname } from 'base/common/resources';
