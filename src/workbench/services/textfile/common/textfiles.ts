...
import { IEncodingSupport, ConfirmResult, IRevertOptions } from 'workbench/common/editor';
import { IBaseStat, IResolveContentOptions, ITextSnapshot } from 'platform/files/common/files';
