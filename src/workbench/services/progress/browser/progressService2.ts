...
import 'css!./media/progressService2';

import { localize } from 'base/nls';
import { IDisposable, dispose } from 'base/common/lifecycle';
import { IProgressService2, IProgressOptions, IProgressStep, ProgressLocation, IProgress, emptyProgress, Progress } from 'platform/progress/common/progress';
import { IViewletService } from 'workbench/services/viewlet/browser/viewlet';
import { StatusbarAlignment, IStatusbarService } from 'platform/statusbar/common/statusbar';
import { TPromise } from 'base/common/winjs.base';
import { always, timeout } from 'base/common/async';
import { ProgressBadge, IActivityService } from 'workbench/services/activity/common/activity';
import { INotificationService, Severity, INotificationHandle, INotificationActions } from 'platform/notification/common/notification';
