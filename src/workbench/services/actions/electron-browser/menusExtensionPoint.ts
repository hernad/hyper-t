...
import { IExtensionPointUser, ExtensionMessageCollector, ExtensionsRegistry } from 'workbench/services/extensions/common/extensionsRegistry';
import { ContextKeyExpr } from 'platform/contextkey/common/contextkey';
import { MenuId, MenuRegistry, ILocalizedString, IMenuItem } from 'platform/actions/common/actions';
...
namespace schema {
	...
	export function parseMenuId(value: string): MenuId | undefined {
		switch (value) {
			...
			// case 'debug/callstack/context': return MenuId.DebugCallStackContext; hernad out-debug
