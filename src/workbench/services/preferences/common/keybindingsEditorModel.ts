...
import { OperatingSystem, language, LANGUAGE_DEFAULT } from 'base/common/platform';
...
import { MenuRegistry, ILocalizedString, ICommandAction } from 'platform/actions/common/actions';
