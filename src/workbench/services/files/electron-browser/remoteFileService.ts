...
import { flatten, isNonEmptyArray } from 'base/common/arrays';
...
import { IDecodeStreamOptions, toDecodeStream, encodeStream } from 'base/node/encoding';
...
import { FileChangesEvent, FileOperation, FileOperationError, FileOperationEvent, FileOperationResult, FileWriteOptions, FileSystemProviderCapabilities, IContent, ICreateFileOptions, IFileStat, IFileSystemProvider, IFilesConfiguration, IResolveContentOptions, IResolveFileOptions, IResolveFileResult, IStat, IStreamContent, ITextSnapshot, IUpdateContentOptions, StringSnapshot, IWatchOptions, FileType } from 'platform/files/common/files';
...
import { FileService } from 'workbench/services/files/electron-browser/fileService';
import { createReadableOfProvider, createReadableOfSnapshot, createWritableOfProvider } from 'workbench/services/files/electron-browser/streams';
