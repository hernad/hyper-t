...
import { UTF8 } from 'base/node/encoding';
import { URI } from 'base/common/uri';
import { IFileSystemProvider, ITextSnapshot, FileSystemProviderCapabilities, FileWriteOptions } from 'platform/files/common/files';
