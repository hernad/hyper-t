...
import { nfcall, ThrottledDelayer, timeout } from 'base/common/async';
...
import { IDisposable, toDisposable, Disposable } from 'base/common/lifecycle';
...
import * as flow from 'base/node/flow';
import { FileWatcher as UnixWatcherService } from 'workbench/services/files/node/watcher/unix/watcherService';
import { FileWatcher as WindowsWatcherService } from 'workbench/services/files/node/watcher/win32/watcherService';
import { toFileChangesEvent, normalize, IRawFileChange } from 'workbench/services/files/node/watcher/common';
import { Event, Emitter } from 'base/common/event';
import { FileWatcher as NsfwWatcherService } from 'workbench/services/files/node/watcher/nsfw/watcherService';
...
import { IEncodingOverride, ResourceEncodings } from 'workbench/services/files/electron-browser/encoding';
import { createReadableOfSnapshot } from 'workbench/services/files/electron-browser/streams';
