...
import { getNextTickChannel } from 'base/parts/ipc/node/ipc';
import { Client } from 'base/parts/ipc/node/ipc.cp';
import { toFileChangesEvent, IRawFileChange } from 'workbench/services/files/node/watcher/common';
import { WatcherChannelClient } from 'workbench/services/files/node/watcher/nsfw/watcherIpc';
import { FileChangesEvent, IFilesConfiguration } from 'platform/files/common/files';
import { IWorkspaceContextService } from 'platform/workspace/common/workspace';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { IDisposable, dispose } from 'base/common/lifecycle';
import { Schemas } from 'base/common/network';
import { filterEvent } from 'base/common/event';
import { IWatchError } from 'workbench/services/files/node/watcher/nsfw/watcher';
	...
	public startWatching(): () => void {
		const client = new Client(
			getPathFromAmdModule(require, 'bootstrap-fork'),
			{
				...
				env: {
					AMD_ENTRYPOINT: 'workbench/services/files/node/watcher/nsfw/watcherApp',
					PIPE_LOGGING: 'true',
