...
import { WatcherChannelClient } from 'workbench/services/files/node/watcher/unix/watcherIpc';
...
import { IWatchError } from 'workbench/services/files/node/watcher/unix/watcher';
	...
	public startWatching(): () => void {
		...
		const client = new Client(
			getPathFromAmdModule(require, 'bootstrap-fork'),
			{
				...
				args,
				env: {
					AMD_ENTRYPOINT: 'workbench/services/files/node/watcher/unix/watcherApp',
					PIPE_LOGGING: 'true',
