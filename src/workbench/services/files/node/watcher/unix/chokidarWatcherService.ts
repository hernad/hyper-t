...
import { realcaseSync } from 'base/node/extfs';
import { isMacintosh } from 'base/common/platform';
import * as watcherCommon from 'workbench/services/files/node/watcher/common';
import { IWatcherRequest, IWatcherService, IWatcherOptions, IWatchError } from 'workbench/services/files/node/watcher/unix/watcher';
