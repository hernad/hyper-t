...
import { IRawFileChange, toFileChangesEvent } from 'workbench/services/files/node/watcher/common';
import { OutOfProcessWin32FolderWatcher } from 'workbench/services/files/node/watcher/win32/csharpWatcherService';
import { FileChangesEvent } from 'platform/files/common/files';
import { IWorkspaceContextService } from 'platform/workspace/common/workspace';
import { normalize } from 'path';
import { rtrim, endsWith } from 'base/common/strings';
import { sep } from 'base/common/paths';
