...
import * as decoder from 'base/node/decoder';
import * as glob from 'base/common/glob';

import { IRawFileChange } from 'workbench/services/files/node/watcher/common';
...
export class OutOfProcessWin32FolderWatcher {
	...
	private startWatcher(): void {
		...
		this.handle = cp.spawn(getPathFromAmdModule(require, 'workbench/services/files/node/watcher/win32/CodeHelper.exe'), args);
