...
import { INotification, INotificationHandle, INotificationActions, INotificationProgress, NoOpNotification, Severity, NotificationMessage, IPromptChoice } from 'platform/notification/common/notification';
...
import { isErrorWithActions } from 'base/common/errorsWithActions';
