...
import { Extensions, IEditorInputFactoryRegistry, EditorInput, toResource, IEditorIdentifier, IEditorCloseEvent, GroupIdentifier, SideBySideEditorInput, CloseDirection } from 'workbench/common/editor';
...
import { dispose, IDisposable, Disposable } from 'base/common/lifecycle';
