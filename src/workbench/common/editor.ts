...
import { IEditor as ICodeEditor, IEditorViewState, ScrollType, IDiffEditor } from 'editor/common/editorCommon';
import { IEditorModel, IEditorOptions, ITextEditorOptions, IBaseResourceInput } from 'platform/editor/common/editor';
import { IInstantiationService, IConstructorSignature0 } from 'platform/instantiation/common/instantiation';
...
import { ICompositeControl } from 'workbench/common/composite';
