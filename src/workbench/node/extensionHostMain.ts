...
import { URI, setUriThrowOnMissingScheme } from 'base/common/uri';
...
import { IEnvironment, IInitData, IWorkspaceData, MainContext, MainThreadWorkspaceShape } from 'workbench/api/node/extHost.protocol';
import { ExtHostConfiguration } from 'workbench/api/node/extHostConfiguration';
import { ExtensionActivatedByEvent } from 'workbench/api/node/extHostExtensionActivator';
...
import { RPCProtocol } from 'workbench/services/extensions/node/rpcProtocol';
