...
import { Event, filterEvent } from 'base/common/event';
import { IMessagePassingProtocol } from 'base/parts/ipc/node/ipc';
import { Protocol } from 'base/parts/ipc/node/ipc.net';
import product from 'platform/node/product';
import { IInitData } from 'workbench/api/node/extHost.protocol';
import { MessageType, createMessageOfType, isMessageOfType } from 'workbench/common/extensionHostProtocol';
import { ExtensionHostMain, exit } from 'workbench/node/extensionHostMain';
