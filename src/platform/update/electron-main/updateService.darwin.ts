...
import { Event, fromNodeEventEmitter } from 'base/common/event';
...
import { State, IUpdate, StateType, UpdateType } from 'platform/update/common/update';
import { ITelemetryService } from 'platform/telemetry/common/telemetry';
import { IEnvironmentService } from 'platform/environment/common/environment';
import { ILogService } from 'platform/log/common/log';
import { AbstractUpdateService, createUpdateURL } from 'platform/update/electron-main/abstractUpdateService';
...
export class DarwinUpdateService extends AbstractUpdateService {
	...
	protected doQuitAndInstall(): void {
		...
		// see also https://github.com/hernad/hyper-t/issues/172
