...
import { State, IUpdate, StateType, AvailableForDownload, UpdateType } from 'platform/update/common/update';
import { ITelemetryService } from 'platform/telemetry/common/telemetry';
import { IEnvironmentService } from 'platform/environment/common/environment';
import { ILogService } from 'platform/log/common/log';
import { createUpdateURL, AbstractUpdateService } from 'platform/update/electron-main/abstractUpdateService';
import { download, asJson } from 'base/node/request';
