...
import { IWorkspacesMainService, IWorkspaceIdentifier, WORKSPACE_EXTENSION, IWorkspaceSavedEvent, UNTITLED_WORKSPACE_NAME, IResolvedWorkspace, IStoredWorkspaceFolder, isRawFileWorkspaceFolder, isStoredWorkspaceFolder, IWorkspaceFolderCreationData } from 'platform/workspaces/common/workspaces';
import { TPromise } from 'base/common/winjs.base';
import { isParent } from 'platform/files/common/files';
...
import { mkdirp, writeFile, readFile } from 'base/node/pfs';
import { readFileSync, existsSync, mkdirSync, writeFileSync } from 'fs';
import { isLinux, isMacintosh } from 'base/common/platform';
import { delSync, readdirSync, writeFileAndFlushSync } from 'base/node/extfs';
import { Event, Emitter } from 'base/common/event';
import { ILogService } from 'platform/log/common/log';
import { isEqual } from 'base/common/paths';
...
import { toWorkspaceFolders } from 'platform/workspace/common/workspace';
