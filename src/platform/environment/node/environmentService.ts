...
import { IEnvironmentService, ParsedArgs, IDebugParams, IExtensionHostDebugParams } from 'platform/environment/common/environment';
import * as crypto from 'crypto';
import * as paths from 'base/node/paths';
