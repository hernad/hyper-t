...
import { IWorkspaceStorageChangeEvent, IStorageService, StorageScope } from 'platform/storage/common/storage';
import { Storage, IStorageLoggingOptions, NullStorage, IStorage } from 'base/node/storage';
import { IStorageLegacyService, StorageLegacyScope } from 'platform/storage/common/storageLegacyService';
...
import { mark, getDuration } from 'base/common/performance';
