...
import { isWindows, isMacintosh, isLinux } from 'base/common/platform';
import { IWorkspaceIdentifier, IWorkspacesMainService, IWorkspaceSavedEvent, ISingleFolderWorkspaceIdentifier, isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier } from 'platform/workspaces/common/workspaces';
...
import { getComparisonKey, isEqual as areResourcesEqual, dirname } from 'base/common/resources';
