...
import { Event, EventMultiplexer } from 'base/common/event';
import {
...
import { IRemoteAuthorityResolverService, IRemoteAuthorityResolver } from 'platform/remote/common/remoteAuthorityResolver';
