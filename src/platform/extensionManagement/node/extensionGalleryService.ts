...
import { getErrorMessage, isPromiseCanceledError, canceled } from 'base/common/errors';
import { StatisticType, IGalleryExtension, IExtensionGalleryService, IGalleryExtensionAsset, IQueryOptions, SortBy, SortOrder, IExtensionManifest, IExtensionIdentifier, IReportedExtension, InstallOperation, ITranslation } from 'platform/extensionManagement/common/extensionManagement';
import { getGalleryExtensionId, getGalleryExtensionTelemetryData, adoptToGalleryExtensionId } from 'platform/extensionManagement/common/extensionManagementUtil';
import { assign, getOrDefault } from 'base/common/objects';
import { IRequestService } from 'platform/request/node/request';
import { ITelemetryService } from 'platform/telemetry/common/telemetry';
import { IPager } from 'base/common/paging';
import { IRequestOptions, IRequestContext, download, asJson, asText } from 'base/node/request';
import pkg from 'platform/node/package';
import product from 'platform/node/product';
import { isEngineValid } from 'platform/extensions/node/extensionValidator';
import { IEnvironmentService } from 'platform/environment/common/environment';
import { readFile } from 'base/node/pfs';
import { writeFileAndFlushSync } from 'base/node/extfs';
