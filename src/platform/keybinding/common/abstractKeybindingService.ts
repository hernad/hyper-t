...
import { KeyCode, Keybinding, ResolvedKeybinding } from 'base/common/keyCodes';
import { Disposable, IDisposable } from 'base/common/lifecycle';
import { ICommandService } from 'platform/commands/common/commands';
import { IContextKeyService, IContextKeyServiceTarget } from 'platform/contextkey/common/contextkey';
import { IKeybindingEvent, IKeybindingService, IKeyboardEvent } from 'platform/keybinding/common/keybinding';
import { IResolveResult, KeybindingResolver } from 'platform/keybinding/common/keybindingResolver';
