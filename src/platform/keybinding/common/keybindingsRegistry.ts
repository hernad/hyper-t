...
import { KeyCode, Keybinding, KeybindingType, SimpleKeybinding, createKeybinding } from 'base/common/keyCodes';
import { OS, OperatingSystem } from 'base/common/platform';
import { CommandsRegistry, ICommandHandler, ICommandHandlerDescription } from 'platform/commands/common/commands';
