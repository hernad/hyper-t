...
import { Event, filterEvent, mapEvent, anyEvent } from 'base/common/event';
import { TPromise } from 'base/common/winjs.base';
import { IWindowService, IWindowsService, INativeOpenDialogOptions, IEnterWorkspaceResult, IMessageBoxResult, IWindowConfiguration, IDevToolsOptions } from 'platform/windows/common/windows';
