...
import { IWindowsService, OpenContext, INativeOpenDialogOptions, IEnterWorkspaceResult, IMessageBoxResult, IDevToolsOptions, INewWindowOptions } from 'platform/windows/common/windows';
...
import { Event, fromNodeEventEmitter, mapEvent, filterEvent, anyEvent, latch } from 'base/common/event';
...
import { IWindowsMainService, ISharedProcess } from 'platform/windows/electron-main/windows';
import { IHistoryMainService, IRecentlyOpened } from 'platform/history/common/history';
import { IWorkspaceIdentifier, IWorkspaceFolderCreationData, ISingleFolderWorkspaceIdentifier } from 'platform/workspaces/common/workspaces';
