...
import { IBackupMainService, IBackupWorkspacesFormat, IEmptyWindowBackupInfo } from 'platform/backup/common/backup';
import { IEnvironmentService } from 'platform/environment/common/environment';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { IFilesConfiguration, HotExitConfiguration } from 'platform/files/common/files';
import { ILogService } from 'platform/log/common/log';

import { IWorkspaceIdentifier, isWorkspaceIdentifier } from 'platform/workspaces/common/workspaces';
import { URI } from 'base/common/uri';
import { isEqual as areResourcesEquals, getComparisonKey, hasToIgnoreCase } from 'base/common/resources';
