...
import { OpenContext, IRunActionInWindowRequest } from 'platform/windows/common/windows';
...
import { mnemonicMenuLabel as baseMnemonicLabel, unmnemonicLabel } from 'base/common/labels';
import { IWindowsMainService, IWindowsCountChangedEvent } from 'platform/windows/electron-main/windows';
...
import { IMenubarData, IMenubarKeybinding, MenubarMenuItem, isMenubarMenuItemSeparator, isMenubarMenuItemSubmenu, isMenubarMenuItemAction, IMenubarMenu } from 'platform/menubar/common/menubar';
