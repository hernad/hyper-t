...
import { ParsedArgs, IEnvironmentService } from 'platform/environment/common/environment';
import { createDecorator } from 'platform/instantiation/common/instantiation';
import { OpenContext, IWindowSettings } from 'platform/windows/common/windows';
