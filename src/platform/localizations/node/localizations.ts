...
import { IExtensionManagementService, ILocalExtension, IExtensionIdentifier } from 'platform/extensionManagement/common/extensionManagement';
import { Disposable } from 'base/common/lifecycle';
import { IEnvironmentService } from 'platform/environment/common/environment';
import { Queue } from 'base/common/async';
import { areSameExtensions, getGalleryExtensionIdFromLocal, getIdFromLocalExtensionId } from 'platform/extensionManagement/common/extensionManagementUtil';
import { ILogService } from 'platform/log/common/log';
import { isValidLocalization, ILocalizationsService, LanguageType } from 'platform/localizations/common/localizations';
