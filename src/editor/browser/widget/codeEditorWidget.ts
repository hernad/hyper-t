...
import 'css!./media/editor';
import 'css!./media/tokens';
...
import { Configuration } from 'editor/browser/config/configuration';
import { CoreEditorCommand } from 'editor/browser/controller/coreCommands';
import * as editorBrowser from 'editor/browser/editorBrowser';
import { EditorExtensionsRegistry, IEditorContributionCtor } from 'editor/browser/editorExtensions';
import { ICodeEditorService } from 'editor/browser/services/codeEditorService';
import { ICommandDelegate } from 'editor/browser/view/viewController';
import { IContentWidgetData, IOverlayWidgetData, View } from 'editor/browser/view/viewImpl';
import { ViewOutgoingEvents } from 'editor/browser/view/viewOutgoingEvents';
import * as editorOptions from 'editor/common/config/editorOptions';
import { Cursor, CursorStateChangedEvent } from 'editor/common/controller/cursor';
import { CursorColumns, ICursors } from 'editor/common/controller/cursorCommon';
import { ICursorPositionChangedEvent, ICursorSelectionChangedEvent } from 'editor/common/controller/cursorEvents';
...
import { InternalEditorAction } from 'editor/common/editorAction';
import * as editorCommon from 'editor/common/editorCommon';
import { EditorContextKeys } from 'editor/common/editorContextKeys';
import { EndOfLinePreference, IIdentifiedSingleEditOperation, IModelDecoration, IModelDecorationOptions, IModelDecorationsChangeAccessor, IModelDeltaDecoration, ITextModel } from 'editor/common/model';
import { ClassName } from 'editor/common/model/intervalTree';
import { ModelDecorationOptions } from 'editor/common/model/textModel';
import { IModelContentChangedEvent, IModelDecorationsChangedEvent, IModelLanguageChangedEvent, IModelLanguageConfigurationChangedEvent, IModelOptionsChangedEvent } from 'editor/common/model/textModelEvents';
import * as modes from 'editor/common/modes';
import { editorErrorBorder, editorErrorForeground, editorHintBorder, editorHintForeground, editorInfoBorder, editorInfoForeground, editorUnnecessaryCodeBorder, editorUnnecessaryCodeOpacity, editorWarningBorder, editorWarningForeground } from 'editor/common/view/editorColorRegistry';
import { VerticalRevealType } from 'editor/common/view/viewEvents';
import { IEditorWhitespace } from 'editor/common/viewLayout/whitespaceComputer';
import { ViewModel } from 'editor/common/viewModel/viewModelImpl';
...
registerThemingParticipant((theme, collector) => {
	...
	if (unnecessaryForeground) {
		collector.addRule(`.${SHOW_UNUSED_ENABLED_CLASS} .monaco-editor .${ClassName.EditorUnnecessaryInlineDecoration} { opacity: ${unnecessaryForeground.rgba.a}; will-change: opacity; }`); // TODO@Ben: 'will-change: opacity' is a workaround for https://github.com/hernad/hyper-t/issues/52196
	}
