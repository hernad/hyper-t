...
import { ILineChange, ScrollType } from 'editor/common/editorCommon';
import { ITextModel, TextModelResolvedOptions } from 'editor/common/model';
import { ColorId, FontStyle, MetadataConsts } from 'editor/common/modes';
import { editorLineNumbers } from 'editor/common/view/editorColorRegistry';
import { RenderLineInput, renderViewLine2 as renderViewLine } from 'editor/common/viewLayout/viewLineRenderer';
import { ViewLineRenderingData } from 'editor/common/viewModel/viewModel';
