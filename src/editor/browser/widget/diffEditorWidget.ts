...
import { StableEditorScrollState } from 'editor/browser/core/editorState';
...
import { DiffReview } from 'editor/browser/widget/diffReview';
...
import { IStringBuilder, createStringBuilder } from 'editor/common/core/stringBuilder';
import * as editorCommon from 'editor/common/editorCommon';
import { IModelDecorationsChangeAccessor, IModelDeltaDecoration, ITextModel } from 'editor/common/model';
import { ModelDecorationOptions } from 'editor/common/model/textModel';
import { IDiffComputationResult, IEditorWorkerService } from 'editor/common/services/editorWorkerService';
import { OverviewRulerZone } from 'editor/common/view/overviewZoneManager';
import { LineDecoration } from 'editor/common/viewLayout/lineDecorations';
import { RenderLineInput, renderViewLine } from 'editor/common/viewLayout/viewLineRenderer';
import { IEditorWhitespace } from 'editor/common/viewLayout/whitespaceComputer';
import { InlineDecoration, InlineDecorationType, ViewLineRenderingData } from 'editor/common/viewModel/viewModel';
...
import { ITheme, IThemeService, getThemeTypeSelector, registerThemingParticipant } from 'platform/theme/common/themeService';
