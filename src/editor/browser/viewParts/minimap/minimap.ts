...
import { ILine, RenderedLinesCollection } from 'editor/browser/view/viewLayer';
import { PartFingerprint, PartFingerprints, ViewPart } from 'editor/browser/view/viewPart';
import { RenderMinimap } from 'editor/common/config/editorOptions';
import { Range } from 'editor/common/core/range';
import { RGBA8 } from 'editor/common/core/rgba';
import { IConfiguration, ScrollType } from 'editor/common/editorCommon';
import { ColorId } from 'editor/common/modes';
import { Constants, MinimapCharRenderer, MinimapTokensColorTracker } from 'editor/common/view/minimapCharRenderer';
import { RenderingContext, RestrictedRenderingContext } from 'editor/common/view/renderingContext';
import { getOrCreateMinimapCharRenderer } from 'editor/common/view/runtimeMinimapCharRenderer';
import { ViewContext } from 'editor/common/view/viewContext';
import * as viewEvents from 'editor/common/view/viewEvents';
import { ViewLineData } from 'editor/common/viewModel/viewModel';
