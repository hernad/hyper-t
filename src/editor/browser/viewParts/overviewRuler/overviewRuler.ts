...
import { IOverviewRuler } from 'editor/browser/editorBrowser';
import { OverviewRulerPosition } from 'editor/common/config/editorOptions';
import { ColorZone, OverviewRulerZone, OverviewZoneManager } from 'editor/common/view/overviewZoneManager';
