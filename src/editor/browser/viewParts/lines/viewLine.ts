...
import { IVisibleLine } from 'editor/browser/view/viewLayer';
import { RangeUtil } from 'editor/browser/viewParts/lines/rangeUtil';
import { IStringBuilder } from 'editor/common/core/stringBuilder';
...
import { CharacterMapping, ForeignElementType, RenderLineInput, renderViewLine } from 'editor/common/viewLayout/viewLineRenderer';
import { ViewportData } from 'editor/common/viewLayout/viewLinesViewportData';
import { InlineDecorationType } from 'editor/common/viewModel/viewModel';
import { HIGH_CONTRAST, ThemeType } from 'platform/theme/common/themeService';
