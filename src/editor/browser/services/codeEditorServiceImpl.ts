...
import { IContentDecorationRenderOptions, IDecorationRenderOptions, IThemeDecorationRenderOptions, isThemeColor } from 'editor/common/editorCommon';
import { IModelDecorationOptions, IModelDecorationOverviewRulerOptions, OverviewRulerLane, TrackedRangeStickiness } from 'editor/common/model';
import { IResourceInput } from 'platform/editor/common/editor';
import { ITheme, IThemeService, ThemeColor } from 'platform/theme/common/themeService';
...
const _CSS_MAP: { [prop: string]: string; } = {
	...
	opacity: 'opacity:{0}; will-change: opacity;', // TODO@Ben: 'will-change: opacity' is a workaround for https://github.com/hernad/hyper-t/issues/52196
