...
import { DynamicViewOverlay } from 'editor/browser/view/dynamicViewOverlay';
import { IVisibleLine, IVisibleLinesHost, VisibleLinesCollection } from 'editor/browser/view/viewLayer';
import { ViewPart } from 'editor/browser/view/viewPart';
