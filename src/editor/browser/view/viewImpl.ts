...
import { IPointerHandlerHelper } from 'editor/browser/controller/mouseHandler';
import { PointerHandler } from 'editor/browser/controller/pointerHandler';
import { ITextAreaHandlerHelper, TextAreaHandler } from 'editor/browser/controller/textAreaHandler';
import * as editorBrowser from 'editor/browser/editorBrowser';
import { ICommandDelegate, ViewController } from 'editor/browser/view/viewController';
import { ViewOutgoingEvents } from 'editor/browser/view/viewOutgoingEvents';
import { ContentViewOverlays, MarginViewOverlays } from 'editor/browser/view/viewOverlays';
import { PartFingerprint, PartFingerprints, ViewPart } from 'editor/browser/view/viewPart';
import { ViewContentWidgets } from 'editor/browser/viewParts/contentWidgets/contentWidgets';
import { CurrentLineHighlightOverlay } from 'editor/browser/viewParts/currentLineHighlight/currentLineHighlight';
import { CurrentLineMarginHighlightOverlay } from 'editor/browser/viewParts/currentLineMarginHighlight/currentLineMarginHighlight';
import { DecorationsOverlay } from 'editor/browser/viewParts/decorations/decorations';
import { EditorScrollbar } from 'editor/browser/viewParts/editorScrollbar/editorScrollbar';
import { GlyphMarginOverlay } from 'editor/browser/viewParts/glyphMargin/glyphMargin';
import { IndentGuidesOverlay } from 'editor/browser/viewParts/indentGuides/indentGuides';
import { LineNumbersOverlay } from 'editor/browser/viewParts/lineNumbers/lineNumbers';
import { ViewLines } from 'editor/browser/viewParts/lines/viewLines';
import { LinesDecorationsOverlay } from 'editor/browser/viewParts/linesDecorations/linesDecorations';
import { Margin } from 'editor/browser/viewParts/margin/margin';
import { MarginViewLineDecorationsOverlay } from 'editor/browser/viewParts/marginDecorations/marginDecorations';

//import { Minimap } from 'editor/browser/viewParts/minimap/minimap';

import { ViewOverlayWidgets } from 'editor/browser/viewParts/overlayWidgets/overlayWidgets';
import { DecorationsOverviewRuler } from 'editor/browser/viewParts/overviewRuler/decorationsOverviewRuler';
import { OverviewRuler } from 'editor/browser/viewParts/overviewRuler/overviewRuler';
import { Rulers } from 'editor/browser/viewParts/rulers/rulers';
import { ScrollDecorationViewPart } from 'editor/browser/viewParts/scrollDecoration/scrollDecoration';
import { SelectionsOverlay } from 'editor/browser/viewParts/selections/selections';
import { ViewCursors } from 'editor/browser/viewParts/viewCursors/viewCursors';
import { ViewZones } from 'editor/browser/viewParts/viewZones/viewZones';
import { Cursor } from 'editor/common/controller/cursor';
...
import { ViewContext } from 'editor/common/view/viewContext';
import { ViewEventDispatcher } from 'editor/common/view/viewEventDispatcher';
import * as viewEvents from 'editor/common/view/viewEvents';
import { ViewportData } from 'editor/common/viewLayout/viewLinesViewportData';
import { ViewEventHandler } from 'editor/common/viewModel/viewEventHandler';
import { IViewModel } from 'editor/common/viewModel/viewModel';
...
export class View extends ViewEventHandler {
	...
	private createViewParts(): void {
		...
		// this.overflowGuardContainer.appendChild(minimap.getDomNode()); hernad minimap-out
