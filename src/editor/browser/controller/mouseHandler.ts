...
import { HitTestContext, IViewZoneData, MouseTarget, MouseTargetFactory } from 'editor/browser/controller/mouseTarget';
import * as editorBrowser from 'editor/browser/editorBrowser';
import { ClientCoordinates, EditorMouseEvent, EditorMouseEventFactory, GlobalEditorMouseMoveMonitor, createEditorPagePosition } from 'editor/browser/editorDom';
...
import { EditorZoom } from 'editor/common/config/editorZoom';
