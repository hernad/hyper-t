...
import { IPointerHandlerHelper, MouseHandler } from 'editor/browser/controller/mouseHandler';
import { IMouseTarget } from 'editor/browser/editorBrowser';
import { EditorMouseEvent } from 'editor/browser/editorDom';
