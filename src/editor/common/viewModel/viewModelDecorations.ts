...
import { IModelDecoration, ITextModel } from 'editor/common/model';
import { IViewModelLinesCollection } from 'editor/common/viewModel/splitLinesCollection';
import { ICoordinatesConverter, InlineDecoration, InlineDecorationType, ViewModelDecoration } from 'editor/common/viewModel/viewModel';
