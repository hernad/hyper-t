...
import { IViewLineTokens } from 'editor/common/core/lineTokens';
import { IPosition, Position } from 'editor/common/core/position';
import { IRange, Range } from 'editor/common/core/range';
import { INewScrollPosition } from 'editor/common/editorCommon';
import { EndOfLinePreference, IActiveIndentGuideInfo, IModelDecorationOptions } from 'editor/common/model';
import { IViewEventListener } from 'editor/common/view/viewEvents';
