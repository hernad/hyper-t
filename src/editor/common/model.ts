...
import { IModelContentChange, IModelContentChangedEvent, IModelDecorationsChangedEvent, IModelLanguageChangedEvent, IModelLanguageConfigurationChangedEvent, IModelOptionsChangedEvent, IModelTokensChangedEvent, ModelRawContentChangedEvent } from 'editor/common/model/textModelEvents';
import { SearchData } from 'editor/common/model/textModelSearch';
import { LanguageId, LanguageIdentifier } from 'editor/common/modes';
import { ITextSnapshot } from 'platform/files/common/files';
