...
import { ApplyEditsResult, EndOfLinePreference, FindMatch, IIdentifiedSingleEditOperation, IInternalModelContentChange, ISingleEditOperationIdentifier, ITextBuffer } from 'editor/common/model';
import { PieceTreeBase, StringBuffer } from 'editor/common/model/pieceTreeTextBuffer/pieceTreeBase';
