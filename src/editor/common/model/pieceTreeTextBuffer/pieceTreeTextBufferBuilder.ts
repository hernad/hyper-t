...
import { DefaultEndOfLine, ITextBuffer, ITextBufferBuilder, ITextBufferFactory } from 'editor/common/model';
import { StringBuffer, createLineStarts, createLineStartsFast } from 'editor/common/model/pieceTreeTextBuffer/pieceTreeBase';
