...
import { TokenizationResult2 } from 'editor/common/core/token';
import { ITextBuffer } from 'editor/common/model';
import { IModelTokensChangedEvent } from 'editor/common/model/textModelEvents';
import { ColorId, FontStyle, IState, ITokenizationSupport, LanguageId, LanguageIdentifier, MetadataConsts, StandardTokenType } from 'editor/common/modes';
import { nullTokenize2 } from 'editor/common/modes/nullMode';
