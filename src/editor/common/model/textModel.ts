...
import { EDITOR_MODEL_DEFAULTS } from 'editor/common/config/editorOptions';
import { LineTokens } from 'editor/common/core/lineTokens';
...
import { EditStack } from 'editor/common/model/editStack';
import { guessIndentation } from 'editor/common/model/indentationGuesser';
import { IntervalNode, IntervalTree, getNodeIsInOverviewRuler, recomputeMaxEnd } from 'editor/common/model/intervalTree';
import { PieceTreeTextBufferBuilder } from 'editor/common/model/pieceTreeTextBuffer/pieceTreeTextBufferBuilder';
import { IModelContentChangedEvent, IModelDecorationsChangedEvent, IModelLanguageChangedEvent, IModelLanguageConfigurationChangedEvent, IModelOptionsChangedEvent, IModelTokensChangedEvent, InternalModelContentChangeEvent, ModelRawChange, ModelRawContentChangedEvent, ModelRawEOLChanged, ModelRawFlush, ModelRawLineChanged, ModelRawLinesDeleted, ModelRawLinesInserted } from 'editor/common/model/textModelEvents';
import { SearchData, SearchParams, TextModelSearch } from 'editor/common/model/textModelSearch';
import { ModelLinesTokens, ModelTokensChangedEventBuilder } from 'editor/common/model/textModelTokens';
import { getWordAtText } from 'editor/common/model/wordHelper';
import { IState, LanguageId, LanguageIdentifier, TokenizationRegistry } from 'editor/common/modes';
import { LanguageConfigurationRegistry } from 'editor/common/modes/languageConfigurationRegistry';
import { NULL_LANGUAGE_IDENTIFIER } from 'editor/common/modes/nullMode';
import { ignoreBracketsInToken } from 'editor/common/modes/supports';
import { BracketsUtils, RichEditBracket, RichEditBrackets } from 'editor/common/modes/supports/richEditBrackets';
import { IStringStream, ITextSnapshot } from 'platform/files/common/files';
import { ITheme, ThemeColor } from 'platform/theme/common/themeService';
