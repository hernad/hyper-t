...
import { TokenizationResult, TokenizationResult2 } from 'editor/common/core/token';
import * as model from 'editor/common/model';
import { LanguageFeatureRegistry } from 'editor/common/modes/languageFeatureRegistry';
import { TokenizationRegistryImpl } from 'editor/common/modes/tokenizationRegistry';
