...
import { ReplaceCommand, ReplaceCommandWithOffsetCursorState, ReplaceCommandWithoutChangingPosition } from 'editor/common/commands/replaceCommand';
import { ShiftCommand } from 'editor/common/commands/shiftCommand';
import { SurroundSelectionCommand } from 'editor/common/commands/surroundSelectionCommand';
import { CursorColumns, CursorConfiguration, EditOperationResult, EditOperationType, ICursorSimpleModel, isQuote } from 'editor/common/controller/cursorCommon';
...
import { EnterAction, IndentAction } from 'editor/common/modes/languageConfiguration';
import { LanguageConfigurationRegistry } from 'editor/common/modes/languageConfigurationRegistry';
import { IElectricAction } from 'editor/common/modes/supports/electricCharacter';
