...
import { DEFAULT_WORD_REGEXP, ensureValidWordDefinition } from 'editor/common/model/wordHelper';
import { LanguageId, LanguageIdentifier } from 'editor/common/modes';
import { EnterAction, FoldingRules, IAutoClosingPair, IAutoClosingPairConditional, IndentAction, IndentationRule, LanguageConfiguration } from 'editor/common/modes/languageConfiguration';
import { createScopedLineTokens } from 'editor/common/modes/supports';
import { CharacterPairSupport } from 'editor/common/modes/supports/characterPair';
import { BracketElectricCharacterSupport, IElectricAction } from 'editor/common/modes/supports/electricCharacter';
import { IndentConsts, IndentRulesSupport } from 'editor/common/modes/supports/indentRules';
import { IOnEnterSupportOptions, OnEnterSupport } from 'editor/common/modes/supports/onEnter';
import { RichEditBrackets } from 'editor/common/modes/supports/richEditBrackets';
