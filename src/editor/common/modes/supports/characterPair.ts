...
import { CharacterPair, IAutoClosingPair, IAutoClosingPairConditional, StandardAutoClosingPairConditional } from 'editor/common/modes/languageConfiguration';
import { ScopedLineTokens } from 'editor/common/modes/supports';
