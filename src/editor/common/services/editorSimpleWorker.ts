...
import { FIN, Iterator, IteratorResult } from 'base/common/iterator';
...
import { DiffComputer } from 'editor/common/diff/diffComputer';
import * as editorCommon from 'editor/common/editorCommon';
import { EndOfLineSequence, IWordAtPosition } from 'editor/common/model';
import { IModelChangedEvent, MirrorTextModel as BaseMirrorModel } from 'editor/common/model/mirrorTextModel';
import { ensureValidWordDefinition, getWordAtText } from 'editor/common/model/wordHelper';
import { CompletionItem, CompletionItemKind, CompletionList, IInplaceReplaceSupportResult, ILink, TextEdit } from 'editor/common/modes';
import { ILinkComputerTarget, computeLinks } from 'editor/common/modes/linkComputer';
import { BasicInplaceReplace } from 'editor/common/modes/supports/inplaceReplaceSupport';
import { IDiffComputationResult } from 'editor/common/services/editorWorkerService';
import { createMonacoBaseAPI } from 'editor/common/standalone/standaloneBase';
