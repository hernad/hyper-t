...
import { DefaultEndOfLine, EndOfLinePreference, EndOfLineSequence, IIdentifiedSingleEditOperation, IModelDecorationOptions, IModelDeltaDecoration, ITextBuffer, ITextBufferFactory, ITextModel, ITextModelCreationOptions, OverviewRulerLane, TrackedRangeStickiness } from 'editor/common/model';
import { ClassName } from 'editor/common/model/intervalTree';
import { TextModel, createTextBuffer } from 'editor/common/model/textModel';
import { IModelLanguageChangedEvent } from 'editor/common/model/textModelEvents';
import { LanguageIdentifier } from 'editor/common/modes';
import { PLAINTEXT_LANGUAGE_IDENTIFIER } from 'editor/common/modes/modesRegistry';
...
import { overviewRulerError, overviewRulerInfo, overviewRulerWarning } from 'editor/common/view/editorColorRegistry';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { IMarker, IMarkerService, MarkerSeverity, MarkerTag } from 'platform/markers/common/markers';
import { ThemeColor, themeColorFromId } from 'platform/theme/common/themeService';
