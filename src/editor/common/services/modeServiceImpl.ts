...
import { IMode, LanguageId, LanguageIdentifier } from 'editor/common/modes';
import { FrankensteinMode } from 'editor/common/modes/abstractMode';
import { NULL_LANGUAGE_IDENTIFIER } from 'editor/common/modes/nullMode';
import { LanguagesRegistry } from 'editor/common/services/languagesRegistry';
import { ILanguageSelection, IModeService } from 'editor/common/services/modeService';
