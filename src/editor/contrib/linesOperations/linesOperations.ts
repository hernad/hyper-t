...
import { CoreEditingCommands } from 'editor/browser/controller/coreCommands';
import { ICodeEditor } from 'editor/browser/editorBrowser';
import { EditorAction, IActionOptions, ServicesAccessor, registerEditorAction } from 'editor/browser/editorExtensions';
import { ReplaceCommand, ReplaceCommandThatPreservesSelection } from 'editor/common/commands/replaceCommand';
import { TrimTrailingWhitespaceCommand } from 'editor/common/commands/trimTrailingWhitespaceCommand';
import { TypeOperations } from 'editor/common/controller/cursorTypeOperations';
...
import { CopyLinesCommand } from 'editor/contrib/linesOperations/copyLinesCommand';
import { DeleteLinesCommand } from 'editor/contrib/linesOperations/deleteLinesCommand';
import { MoveLinesCommand } from 'editor/contrib/linesOperations/moveLinesCommand';
import { SortLinesCommand } from 'editor/contrib/linesOperations/sortLinesCommand';
...
export class TrimTrailingWhitespaceAction extends EditorAction {
	...
	public run(_accessor: ServicesAccessor, editor: ICodeEditor, args: any): void {
		...
		if (args.reason === 'auto-save') {
			// See https://github.com/editorconfig/editorconfig-hypert/issues/47
