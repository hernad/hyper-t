...
import { ICodeEditor, IEditorMouseEvent, IMouseTarget, MouseTargetType } from 'editor/browser/editorBrowser';
...
import { DragAndDropCommand } from 'editor/contrib/dnd/dragAndDropCommand';
