...
import { EditorCommand, registerEditorCommand, registerEditorContribution } from 'editor/browser/editorExtensions';
...
import { CompletionItem, CompletionItemKind } from 'editor/common/modes';
import { Choice } from 'editor/contrib/snippet/snippetParser';
