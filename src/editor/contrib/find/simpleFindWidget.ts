...
import { SimpleButton } from 'editor/contrib/find/findWidget';
...
import { ITheme, registerThemingParticipant } from 'platform/theme/common/themeService';
import { ContextScopedFindInput } from 'platform/widget/browser/contextScopedHistoryWidget';
