...
import { HistoryInputBox, IMessage as InputBoxMessage } from 'base/browser/ui/inputbox/inputBox';
import { IHorizontalSashLayoutProvider, ISashEvent, Orientation, Sash } from 'base/browser/ui/sash/sash';
...
import { ICodeEditor, IOverlayWidget, IOverlayWidgetPosition, IViewZone, OverlayWidgetPositionPreference } from 'editor/browser/editorBrowser';
import { IConfigurationChangedEvent } from 'editor/common/config/editorOptions';
import { Range } from 'editor/common/core/range';
import { CONTEXT_FIND_INPUT_FOCUSED, CONTEXT_REPLACE_INPUT_FOCUSED, FIND_IDS, MATCHES_LIMIT } from 'editor/contrib/find/findModel';
import { FindReplaceState, FindReplaceStateChangedEvent } from 'editor/contrib/find/findState';
...
import { ITheme, IThemeService, registerThemingParticipant } from 'platform/theme/common/themeService';
