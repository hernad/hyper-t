...
import { CursorChangeReason, ICursorPositionChangedEvent } from 'editor/common/controller/cursorEvents';
...
import { EndOfLinePreference, FindMatch, ITextModel } from 'editor/common/model';
import { SearchParams } from 'editor/common/model/textModelSearch';
import { FindDecorations } from 'editor/contrib/find/findDecorations';
import { FindReplaceState, FindReplaceStateChangedEvent } from 'editor/contrib/find/findState';
import { ReplaceAllCommand } from 'editor/contrib/find/replaceAllCommand';
import { ReplacePattern, parseReplaceString } from 'editor/contrib/find/replacePattern';
