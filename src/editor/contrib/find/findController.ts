...
import { EditorAction, EditorCommand, ServicesAccessor, registerEditorAction, registerEditorCommand, registerEditorContribution } from 'editor/browser/editorExtensions';
import * as editorCommon from 'editor/common/editorCommon';
import { EditorContextKeys } from 'editor/common/editorContextKeys';
import { CONTEXT_FIND_INPUT_FOCUSED, CONTEXT_FIND_WIDGET_VISIBLE, FIND_IDS, FindModelBoundToEditorModel, ToggleCaseSensitiveKeybinding, ToggleRegexKeybinding, ToggleSearchScopeKeybinding, ToggleWholeWordKeybinding } from 'editor/contrib/find/findModel';
import { FindOptionsWidget } from 'editor/contrib/find/findOptionsWidget';
import { FindReplaceState, FindReplaceStateChangedEvent, INewFindReplaceState } from 'editor/contrib/find/findState';
import { FindWidget, IFindController } from 'editor/contrib/find/findWidget';
