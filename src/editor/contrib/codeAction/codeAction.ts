...
import { flatten, mergeSort, isNonEmptyArray } from 'base/common/arrays';
...
import { CodeAction, CodeActionContext, CodeActionProviderRegistry, CodeActionTrigger as CodeActionTriggerKind } from 'editor/common/modes';
