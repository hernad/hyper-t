...
import { CancelablePromise, TimeoutTimer, createCancelablePromise } from 'base/common/async';
...
import { ColorProviderRegistry } from 'editor/common/modes';
import { IColorData, getColors } from 'editor/contrib/colorPicker/color';
