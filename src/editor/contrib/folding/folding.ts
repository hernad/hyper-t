...
import { ScrollType, IEditorContribution } from 'editor/common/editorCommon';
import { ITextModel } from 'editor/common/model';
import { registerEditorAction, registerEditorContribution, ServicesAccessor, EditorAction, registerInstantiatedEditorAction } from 'editor/browser/editorExtensions';
import { ICodeEditor, IEditorMouseEvent, MouseTargetType } from 'editor/browser/editorBrowser';
import { FoldingModel, setCollapseStateAtLevel, CollapseMemento, setCollapseStateLevelsDown, setCollapseStateLevelsUp, setCollapseStateForMatchingLines, setCollapseStateForType } from 'editor/contrib/folding/foldingModel';
...
import { IMarginData, IEmptyContentData } from 'editor/browser/controller/mouseTarget';
import { HiddenRangeModel } from 'editor/contrib/folding/hiddenRangeModel';
...
import { IndentRangeProvider } from 'editor/contrib/folding/indentRangeProvider';
import { IPosition } from 'editor/common/core/position';
import { FoldingRangeProviderRegistry, FoldingRangeKind } from 'editor/common/modes';
import { SyntaxRangeProvider, ID_SYNTAX_PROVIDER } from './syntaxRangeProvider';
import { CancellationToken } from 'base/common/cancellation';
import { InitializingRangeProvider, ID_INIT_PROVIDER } from 'editor/contrib/folding/intializingRangeProvider';
