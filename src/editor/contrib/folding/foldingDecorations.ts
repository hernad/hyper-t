...
import { TrackedRangeStickiness, IModelDeltaDecoration, IModelDecorationsChangeAccessor } from 'editor/common/model';
import { ModelDecorationOptions } from 'editor/common/model/textModel';
import { IDecorationProvider } from 'editor/contrib/folding/foldingModel';
