...
import { binarySearch, coalesceInPlace } from 'base/common/arrays';
...
import { DocumentSymbol, DocumentSymbolProvider, DocumentSymbolProviderRegistry } from 'editor/common/modes';
