...
import { CompletionItemProvider, StandardTokenType, CompletionContext, CompletionProviderRegistry, CompletionTriggerKind } from 'editor/common/modes';
...
import { WordDistance } from 'editor/contrib/suggest/wordDistance';
...
export class SuggestModel implements IDisposable {
	...
	trigger(context: SuggestTriggerContext, retrigger: boolean = false, onlyFrom?: CompletionItemProvider[], existingItems?: ISuggestionItem[]): void {
		...
		// TODO: Remove this workaround - https://github.com/hernad/hyper-t/issues/61917
