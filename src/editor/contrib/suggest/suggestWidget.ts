...
import { IListVirtualDelegate, IListEvent, IListRenderer } from 'base/browser/ui/list/list';
...
import { CompletionItemKind, completionKindToCssClass } from 'editor/common/modes';
