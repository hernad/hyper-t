...
import { Command, ICodeLensSymbol } from 'editor/common/modes';
import { editorCodeLensForeground } from 'editor/common/view/editorColorRegistry';
import { ICodeLensData } from 'editor/contrib/codelens/codelens';
