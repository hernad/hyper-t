...
import { EditorAction, IActionOptions, ServicesAccessor, registerEditorAction, registerEditorContribution } from 'editor/browser/editorExtensions';
...
import { ICommand, ICursorStateComputerData, IEditOperationBuilder, IEditorContribution } from 'editor/common/editorCommon';
import { EditorContextKeys } from 'editor/common/editorContextKeys';
import { IIdentifiedSingleEditOperation, ITextModel, EndOfLineSequence } from 'editor/common/model';
import { TextModel } from 'editor/common/model/textModel';
import { StandardTokenType, TextEdit } from 'editor/common/modes';
import { LanguageConfigurationRegistry } from 'editor/common/modes/languageConfigurationRegistry';
import { IndentConsts } from 'editor/common/modes/supports/indentRules';
import { IModelService } from 'editor/common/services/modelService';
import * as indentUtils from 'editor/contrib/indentation/indentUtils';
