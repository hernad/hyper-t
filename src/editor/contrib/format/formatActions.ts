...
import { registerEditorAction, ServicesAccessor, EditorAction, registerEditorContribution, IActionOptions } from 'editor/browser/editorExtensions';
import { OnTypeFormattingEditProviderRegistry, DocumentRangeFormattingEditProviderRegistry } from 'editor/common/modes';
import { getOnTypeFormattingEdits, getDocumentFormattingEdits, getDocumentRangeFormattingEdits, NoProviderError } from 'editor/contrib/format/format';
...
import { CharacterSet } from 'editor/common/core/characterClassifier';
import { Range } from 'editor/common/core/range';
import { alert } from 'base/browser/ui/aria/aria';
import { EditorState, CodeEditorStateFlag } from 'editor/browser/core/editorState';
