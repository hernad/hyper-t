...
import { BlockCommentCommand } from 'editor/contrib/comment/blockCommentCommand';
import { LineCommentCommand, Type } from 'editor/contrib/comment/lineCommentCommand';
