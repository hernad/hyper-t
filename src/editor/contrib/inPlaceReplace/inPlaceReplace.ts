...
import { registerEditorAction, ServicesAccessor, EditorAction, registerEditorContribution } from 'editor/browser/editorExtensions';
import { IInplaceReplaceSupportResult } from 'editor/common/modes';
...
import { editorBracketMatchBorder } from 'editor/common/view/editorColorRegistry';
