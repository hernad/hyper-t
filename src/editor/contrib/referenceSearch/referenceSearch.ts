...
import { Position, IPosition } from 'editor/common/core/position';
import * as editorCommon from 'editor/common/editorCommon';
import { registerEditorAction, ServicesAccessor, EditorAction, registerEditorContribution, registerDefaultLanguageCommand } from 'editor/browser/editorExtensions';
import { Location, ReferenceProviderRegistry } from 'editor/common/modes';
...
import { ctxReferenceWidgetSearchTreeFocused } from 'editor/contrib/referenceSearch/referencesWidget';
