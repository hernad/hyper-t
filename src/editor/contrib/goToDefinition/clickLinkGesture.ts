...
import { ICodeEditor, IEditorMouseEvent, IMouseTarget } from 'editor/browser/editorBrowser';
...
export class ClickLinkGesture extends Disposable {
	...
	private onDidChangeCursorSelection(e: ICursorSelectionChangedEvent): void {
		if (e.selection && e.selection.startColumn !== e.selection.endColumn) {
			this.resetHandler(); // immediately stop this feature if the user starts to select (https://github.com/hernad/hyper-t/issues/7827)
		}
	}
