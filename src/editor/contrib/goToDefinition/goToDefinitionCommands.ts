...
import { EditorAction, IActionOptions, registerEditorAction, ServicesAccessor } from 'editor/browser/editorExtensions';
import { ICodeEditorService } from 'editor/browser/services/codeEditorService';
import * as corePosition from 'editor/common/core/position';
import { Range } from 'editor/common/core/range';
import { EditorContextKeys } from 'editor/common/editorContextKeys';
import { ITextModel, IWordAtPosition } from 'editor/common/model';
import { DefinitionLink, Location } from 'editor/common/modes';
import { MessageController } from 'editor/contrib/message/messageController';
import { PeekContext } from 'editor/contrib/referenceSearch/peekViewWidget';
import { ReferencesController } from 'editor/contrib/referenceSearch/referencesController';
import { ReferencesModel } from 'editor/contrib/referenceSearch/referencesModel';
