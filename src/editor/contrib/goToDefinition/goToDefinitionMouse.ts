...
import 'css!./goToDefinitionMouse';
...
import { DefinitionProviderRegistry, DefinitionLink } from 'editor/common/modes';
import { ICodeEditor, IMouseTarget, MouseTargetType } from 'editor/browser/editorBrowser';
...
import { ClickLinkGesture, ClickLinkMouseEvent, ClickLinkKeyboardEvent } from 'editor/contrib/goToDefinition/clickLinkGesture';
import { IWordAtPosition, IModelDeltaDecoration, ITextModel, IFoundBracket } from 'editor/common/model';
