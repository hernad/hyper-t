...
import { IEmptyContentData } from 'editor/browser/controller/mouseTarget';
...
import { IEditorContribution, IScrollEvent } from 'editor/common/editorCommon';
import { EditorContextKeys } from 'editor/common/editorContextKeys';
import { IModeService } from 'editor/common/services/modeService';
import { HoverStartMode } from 'editor/contrib/hover/hoverOperation';
import { ModesContentHoverWidget } from 'editor/contrib/hover/modesContentHover';
import { ModesGlyphHoverWidget } from 'editor/contrib/hover/modesGlyphHover';
import { MarkdownRenderer } from 'editor/contrib/markdown/markdownRenderer';
import { KeybindingWeight } from 'platform/keybinding/common/keybindingsRegistry';
import { IOpenerService } from 'platform/opener/common/opener';
import { editorHoverBackground, editorHoverBorder, editorHoverHighlight, textCodeBlockBackground, textLinkForeground } from 'platform/theme/common/colorRegistry';
