...
import { Disposable, IDisposable, combinedDisposable } from 'base/common/lifecycle';
...
import { DocumentColorProvider, Hover, HoverProviderRegistry, IColor } from 'editor/common/modes';
import { getColorPresentations } from 'editor/contrib/colorPicker/color';
import { ColorDetector } from 'editor/contrib/colorPicker/colorDetector';
import { ColorPickerModel } from 'editor/contrib/colorPicker/colorPickerModel';
import { ColorPickerWidget } from 'editor/contrib/colorPicker/colorPickerWidget';
import { getHover } from 'editor/contrib/hover/getHover';
import { HoverOperation, HoverStartMode, IHoverComputer } from 'editor/contrib/hover/hoverOperation';
import { ContentHoverWidget } from 'editor/contrib/hover/hoverWidgets';
