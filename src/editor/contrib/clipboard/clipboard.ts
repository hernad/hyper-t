...
import 'css!./clipboard';
import * as nls from 'base/nls';
import * as browser from 'base/browser/browser';
import { KeyCode, KeyMod } from 'base/common/keyCodes';
import * as platform from 'base/common/platform';
import { CopyOptions } from 'editor/browser/controller/textAreaInput';
import { ICodeEditor } from 'editor/browser/editorBrowser';
import { EditorAction, IActionOptions, ICommandKeybindingsOptions, registerEditorAction } from 'editor/browser/editorExtensions';
