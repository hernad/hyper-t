...
import { EditorCommand, ICommandOptions, ServicesAccessor, registerEditorCommand } from 'editor/browser/editorExtensions';
...
import { WordNavigationType, WordOperations } from 'editor/common/controller/cursorWordOperations';
import { WordCharacterClassifier, getMapForWordSeparators } from 'editor/common/controller/wordCharacterClassifier';
