...
import { ICodeEditor, MouseTargetType } from 'editor/browser/editorBrowser';
...
import { IModelDecorationsChangeAccessor, IModelDeltaDecoration, TrackedRangeStickiness } from 'editor/common/model';
import { ModelDecorationOptions } from 'editor/common/model/textModel';
import { LinkProviderRegistry } from 'editor/common/modes';
import { ClickLinkGesture, ClickLinkKeyboardEvent, ClickLinkMouseEvent } from 'editor/contrib/goToDefinition/clickLinkGesture';
import { Link, getLinks } from 'editor/contrib/links/getLinks';
