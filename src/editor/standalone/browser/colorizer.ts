...
import { IViewLineTokens, LineTokens } from 'editor/common/core/lineTokens';
import { ITextModel } from 'editor/common/model';
import { ColorId, FontStyle, ITokenizationSupport, MetadataConsts, TokenizationRegistry } from 'editor/common/modes';
