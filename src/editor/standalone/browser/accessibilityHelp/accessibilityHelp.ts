...
import { EditorAction, EditorCommand, registerEditorAction, registerEditorCommand, registerEditorContribution } from 'editor/browser/editorExtensions';
...
import { IEditorConstructionOptions } from 'editor/standalone/browser/standaloneCodeEditor';
...
import { contrastBorder, editorWidgetBackground, widgetShadow } from 'platform/theme/common/colorRegistry';
