...
import { EditorAction, IActionOptions, registerEditorContribution } from 'editor/browser/editorExtensions';
...
import { QuickOpenEditorWidget } from 'editor/standalone/browser/quickOpen/quickOpenEditorWidget';
