...
import { ServicesAccessor, registerEditorAction } from 'editor/browser/editorExtensions';
...
import { DocumentSymbol, DocumentSymbolProviderRegistry, symbolKindToCssClass } from 'editor/common/modes';
import { getDocumentSymbols } from 'editor/contrib/quickOpen/quickOpen';
import { BaseEditorQuickOpenAction, IDecorator } from 'editor/standalone/browser/quickOpen/editorQuickOpen';
