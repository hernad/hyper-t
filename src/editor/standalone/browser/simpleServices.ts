...
import { Keybinding, ResolvedKeybinding, SimpleKeybinding, createKeybinding } from 'base/common/keyCodes';
...
import { ICodeEditor, IDiffEditor, isCodeEditor } from 'editor/browser/editorBrowser';
import { IBulkEditOptions, IBulkEditResult, IBulkEditService } from 'editor/browser/services/bulkEditService';
import { isDiffEditorConfigurationKey, isEditorConfigurationKey } from 'editor/common/config/commonEditorConfig';
import { EditOperation } from 'editor/common/core/editOperation';
import { IPosition, Position as Pos } from 'editor/common/core/position';
import { Range } from 'editor/common/core/range';
import * as editorCommon from 'editor/common/editorCommon';
import { ITextModel } from 'editor/common/model';
import { TextEdit, WorkspaceEdit, isResourceTextEdit } from 'editor/common/modes';
import { IModelService } from 'editor/common/services/modelService';
import { ITextEditorModel, ITextModelContentProvider, ITextModelService } from 'editor/common/services/resolverService';
...
import { CommandsRegistry, ICommand, ICommandEvent, ICommandHandler, ICommandService } from 'platform/commands/common/commands';
import { IConfigurationChangeEvent, IConfigurationData, IConfigurationOverrides, IConfigurationService } from 'platform/configuration/common/configuration';
...
import { IConfirmation, IConfirmationResult, IDialogOptions, IDialogService } from 'platform/dialogs/common/dialogs';
import { IInstantiationService } from 'platform/instantiation/common/instantiation';
import { AbstractKeybindingService } from 'platform/keybinding/common/abstractKeybindingService';
import { IKeybindingEvent, IKeyboardEvent, KeybindingSource } from 'platform/keybinding/common/keybinding';
...
import { ILabelService, LabelRules, RegisterFormatterEvent } from 'platform/label/common/label';
import { INotification, INotificationHandle, INotificationService, IPromptChoice, IPromptOptions, NoOpNotification } from 'platform/notification/common/notification';
import { IProgressRunner, IProgressService } from 'platform/progress/common/progress';
import { ITelemetryInfo, ITelemetryService } from 'platform/telemetry/common/telemetry';
import { IWorkspace, IWorkspaceContextService, IWorkspaceFolder, IWorkspaceFoldersChangeEvent, WorkbenchState, WorkspaceFolder } from 'platform/workspace/common/workspace';
