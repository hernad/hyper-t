...
import { Event, Emitter, once, mapEvent, fromNodeEventEmitter } from 'base/common/event';
import { IMessagePassingProtocol, ClientConnectionEvent, IPCServer, IPCClient } from 'base/parts/ipc/node/ipc';
