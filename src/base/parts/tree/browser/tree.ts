...
import * as WinJS from 'base/common/winjs.base';
...
import { IAction, IActionItem } from 'base/common/actions';
import { Color } from 'base/common/color';
import { IItemCollapseEvent, IItemExpandEvent } from 'base/parts/tree/browser/treeModel';
