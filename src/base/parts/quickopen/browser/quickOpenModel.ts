...
import { ITree, IActionProvider } from 'base/parts/tree/browser/tree';
import { IconLabel, IIconLabelValueOptions } from 'base/browser/ui/iconLabel/iconLabel';
import { IQuickNavigateConfiguration, IModel, IDataSource, IFilter, IAccessiblityProvider, IRenderer, IRunner, Mode } from 'base/parts/quickopen/common/quickOpen';
import { Action, IAction, IActionRunner } from 'base/common/actions';
import { compareAnything } from 'base/common/comparers';
import { ActionBar, IActionItem } from 'base/browser/ui/actionbar/actionbar';
import { HighlightedLabel } from 'base/browser/ui/highlightedlabel/highlightedLabel';
import * as DOM from 'base/browser/dom';
import { IQuickOpenStyles } from 'base/parts/quickopen/browser/quickOpenWidget';
...
import { IItemAccessor } from 'base/parts/quickopen/common/quickOpenScorer';
