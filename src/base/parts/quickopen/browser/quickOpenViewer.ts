...
import { ITree, IRenderer, IFilter, IDataSource, IAccessibilityProvider } from 'base/parts/tree/browser/tree';
import { IModel } from 'base/parts/quickopen/common/quickOpen';
