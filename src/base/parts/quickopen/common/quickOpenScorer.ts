...
import { matchesPrefix, IMatch, createMatches, matchesCamelCase, isUpper } from 'base/common/filters';
import { nativeSep } from 'base/common/paths';
import { isWindows, isLinux } from 'base/common/platform';
import { stripWildcards, equalsIgnoreCase } from 'base/common/strings';
