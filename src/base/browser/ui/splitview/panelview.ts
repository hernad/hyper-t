...
import 'css!./panelview';
import { IDisposable, dispose, combinedDisposable, Disposable } from 'base/common/lifecycle';
import { Event, Emitter, chain, filterEvent } from 'base/common/event';
