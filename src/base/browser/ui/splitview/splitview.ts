...
import 'css!./splitview';
import { IDisposable, combinedDisposable, toDisposable, Disposable } from 'base/common/lifecycle';
import { Event, mapEvent, Emitter } from 'base/common/event';
...
import { Sash, Orientation, ISashEvent as IBaseSashEvent, SashState } from 'base/browser/ui/sash/sash';
