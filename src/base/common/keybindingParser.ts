...
import { ChordKeybinding, KeyCodeUtils, Keybinding, SimpleKeybinding } from 'base/common/keyCodes';
import { OperatingSystem } from 'base/common/platform';
import { ScanCodeBinding, ScanCodeUtils } from 'base/common/scanCode';
