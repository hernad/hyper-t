...
import { assign, mixin, equals } from 'base/common/objects';
import { IBackupMainService, IEmptyWindowBackupInfo } from 'platform/backup/common/backup';
...
import { CodeWindow, defaultWindowState } from 'code/electron-main/window';
import { hasArgs, asArray } from 'platform/environment/node/argv';
import { ipcMain as ipc, screen, BrowserWindow, dialog, systemPreferences, app } from 'electron';
import { IPathWithLineAndColumn, parseLineAndColumnAware } from 'code/node/paths';
import { ILifecycleService, UnloadReason, IWindowUnloadEvent } from 'platform/lifecycle/electron-main/lifecycleMain';
import { IConfigurationService } from 'platform/configuration/common/configuration';
import { ILogService } from 'platform/log/common/log';
import { IWindowSettings, OpenContext, IPath, IWindowConfiguration, INativeOpenDialogOptions, ReadyState, IPathsToWaitFor, IEnterWorkspaceResult, IMessageBoxResult, INewWindowOptions } from 'platform/windows/common/windows';
import { getLastActiveWindow, findBestWindowOrFolderForFile, findWindowOnWorkspace, findWindowOnExtensionDevelopmentPath, findWindowOnWorkspaceOrFolderUri } from 'code/node/windowsFinder';
import { Event as CommonEvent, Emitter } from 'base/common/event';
import product from 'platform/node/product';
import { ITelemetryService } from 'platform/telemetry/common/telemetry';
import { IWindowsMainService, IOpenConfiguration, IWindowsCountChangedEvent, ICodeWindow, IWindowState as ISingleWindowState, WindowMode } from 'platform/windows/electron-main/windows';
...
import { IWorkspacesMainService, IWorkspaceIdentifier, WORKSPACE_FILTER, IWorkspaceFolderCreationData, ISingleFolderWorkspaceIdentifier, isSingleFolderWorkspaceIdentifier } from 'platform/workspaces/common/workspaces';
...
import { Queue, timeout } from 'base/common/async';
import { exists } from 'base/node/pfs';
import { getComparisonKey, isEqual, normalizePath } from 'base/common/resources';
