...
import { LaunchService, LaunchChannel, ILaunchService } from 'platform/launch/electron-main/launchService';
...
import { IssueChannel } from 'platform/issue/node/issueIpc';
import { IssueService } from 'platform/issue/electron-main/issueService';
...
import { ILabelService, RegisterFormatterEvent } from 'platform/label/common/label';
...
import { THEME_STORAGE_KEY, THEME_BG_STORAGE_KEY } from 'code/electron-main/theme';
import { nativeSep, join } from 'base/common/paths';
...
export class CodeApplication {
	...
	startup(): TPromise<void> {
		this.logService.debug('Starting Application');
