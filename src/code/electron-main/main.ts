...
import { LifecycleService, ILifecycleService } from 'platform/lifecycle/electron-main/lifecycleMain';
import { Server, serve, connect } from 'base/parts/ipc/node/ipc.net';
...
import { ILogService, ConsoleLogMainService, MultiplexLogService, getLogLevel } from 'platform/log/common/log';
