...
import { parseCLIProcessArgv, buildHelpMessage } from 'platform/environment/node/argv';
...
import { resolveTerminalEncoding } from 'base/node/encoding';
...
export async function main(argv: string[]): Promise<any> {
	...
	// Extensions Management
		...
		const cli = await new Promise<IMainCli>((c, e) => require(['code/node/cliProcessMain'], c, e));
		await cli.main(args);
		return;
	}
