...
bootstrapWindow.load([
	...
	'base/nls!workbench/workbench.main',
	'css!workbench/workbench.main'
],
	function (workbench, configuration) {
		...
		return process['lazyEnv'].then(function () {
			...
			// @ts-ignore
			return require('workbench/electron-browser/main').startup(configuration);
		});
	}, {
...
function showPartsSplash(configuration) {
	...
	try {
		...
		let raw = window.localStorage.getItem('storage://global/paverrts-splash-data');
