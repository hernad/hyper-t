...
import 'css!./media/issueReporter';
...
import { getDelayedChannel } from 'base/parts/ipc/node/ipc';
...
import { NullTelemetryService, combinedAppender, LogAppender } from 'platform/telemetry/common/telemetryUtils';
...
import { IssueReporterModel } from 'code/electron-browser/issue/issueReporterModel';
import { IssueReporterData, IssueReporterStyles, IssueType, ISettingsSearchIssueReporterData, IssueReporterFeatures, IssueReporterExtensionData } from 'platform/issue/common/issue';
import BaseHtml from 'code/electron-browser/issue/issueReporterPage';
...
import { ILogService, getLogLevel } from 'platform/log/common/log';
import { OcticonLabel } from 'base/browser/ui/octiconLabel/octiconLabel';
import { normalizeGitHubUrl } from 'code/electron-browser/issue/issueReporterUtil';
