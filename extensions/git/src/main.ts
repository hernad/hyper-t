...
import { ExtensionContext, workspace, window, Disposable, commands, Uri, OutputChannel, WorkspaceFolder } from 'hypert';
...
async function warnAboutMissingGit(): Promise<void> {
	...
	if (choice === download) {
		commands.executeCommand('hypert.open', Uri.parse('https://git-scm.com/'));
