...
import { workspace, WorkspaceFoldersChangeEvent, Uri, window, Event, EventEmitter, QuickPickItem, Disposable, SourceControl, SourceControlResourceGroup, TextEditor, Memento, OutputChannel } from 'hypert';
...
export class Model {
	...
	async openRepository(path: string): Promise<void> {
		...
		try {
			...
			// https://github.com/hernad/hyper-t/issues/33498
