...
suite('XLF Parser Tests', () => {
    ...
    test('JSON file source path to Transifex resource match', () => {
        ...
        const platform = { name: 'platform', project: editorProject }, editorContrib = { name: 'editor/contrib', project: editorProject }, editor = { name: 'editor', project: editorProject }, base = { name: 'base', project: editorProject }, code = { name: 'code', project: workbenchProject }, workbenchParts = { name: 'workbench/parts/html', project: workbenchProject }, workbenchServices = { name: 'workbench/services/files', project: workbenchProject }, workbench = { name: 'workbench', project: workbenchProject };
