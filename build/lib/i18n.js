...
function getResource(sourceFile) {
    ...
    if (/^vs\/platform/.test(sourceFile)) {
        return { name: 'platform', project: editorProject };
    }
    else if (/^vs\/editor\/contrib/.test(sourceFile)) {
        return { name: 'editor/contrib', project: editorProject };
    }
    else if (/^vs\/editor/.test(sourceFile)) {
        return { name: 'editor', project: editorProject };
    }
    else if (/^vs\/base/.test(sourceFile)) {
        return { name: 'base', project: editorProject };
    }
    else if (/^vs\/code/.test(sourceFile)) {
        return { name: 'code', project: workbenchProject };
    }
        ...
        return { name: 'workbench', project: workbenchProject };
    }
