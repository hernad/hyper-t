...
function compileTask(src, out, build) {
    return function () {
        ...
        const srcPipe = es.merge(gulp.src(`${src}/**/*.@(html|png|css|svg|scss|less|eot|woff|ttf)`, { base: `${src}` }), gulp.src(typesDts));
...
class MonacoGenerator {
    ...
    execute() {
        ...
        fs.writeFileSync(path.join(REPO_SRC_FOLDER, 'editor/common/standalone/standaloneEnums.ts'), result.enums);
