...
const vscodeEntryPoints = _.flatten([
	buildfile.entrypoint('workbench/workbench.main'),
	buildfile.base,
	buildfile.workbench,
	buildfile.code
]);
...
const vscodeResources = [
	...
	'out-build/paths.js',
	'out-build/**/*.{svg,png,cur,html}',
	'out-build/base/common/performance.js',
	'out-build/base/node/{stdForkStart.js,terminateProcess.sh,cpuUsage.sh}',
	'out-build/base/browser/ui/octiconLabel/octicons/**',
	'out-build/workbench/browser/media/*-theme.css',
	'out-build/workbench/parts/debug/**/*.json',
	'out-build/workbench/parts/execution/**/*.scpt',
	'out-build/workbench/parts/webview/electron-browser/webview-pre.js',
	'out-build/**/markdown.css',
	'out-build/workbench/parts/tasks/**/*.json',
	'out-build/workbench/parts/welcome/walkThrough/**/*.md',
	'out-build/workbench/services/files/**/*.exe',
	'out-build/workbench/services/files/**/*.md',
	'out-build/code/electron-browser/workbench/**',
	'out-build/code/electron-browser/sharedProcess/sharedProcess.js',
	'out-build/code/electron-browser/issue/issueReporter.js',
	'out-build/code/electron-browser/processExplorer/processExplorer.js',
	'!**/test/**'
];
...
gulp.task('optimize-index-js', ['optimize-vscode'], () => {
	const fullpath = path.join(process.cwd(), 'out-vscode/code/electron-browser/workbench/workbench.js');
...
function packageTask(platform, arch, opts) {
	...
	return () => {
		...
		const checksums = computeChecksums(out, [
			'workbench/workbench.main.js',
			'workbench/workbench.main.css',
